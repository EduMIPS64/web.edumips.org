...
` + e.stack) : e;
	...
	(function(e) {
		...
		e.from = a;
		function* l(N) {
			for (let T = N.length - 1; T >= 0; T--) yield N[T];
		}
		e.reverse = l;
		function o(N) {
		...
		function h(N, T) {
			let I = 0;
			for (const D of N) if (T(D, I++)) return !0;
			return !1;
		}
		e.some = h;
		function f(N, T) {
			let I = 0;
			for (const D of N) if (!T(D, I++)) return !1;
			return !0;
		}
		e.every = f;
		function g(N, T) {
			for (const I of N) if (T(I)) return I;
		}
		e.find = g;
		function* m(N, T) {
			for (const I of N) T(I) && (yield I);
		}
		e.filter = m;
		function* d(N, T) {
			let I = 0;
			for (const D of N) yield T(D, I++);
		}
		e.map = d;
		function* p(N, T) {
			let I = 0;
		...
		e.flatMap = p;
		function* v(...N) {
			for (const T of N) co(T) ? yield* T : yield T;
		}
		e.concat = v;
		function L(N, T, I) {
			let D = I;
			for (const M of N) D = T(D, M);
			return D;
		}
		e.reduce = L;
		function w(N) {
		...
		e.length = w;
		function* b(N, T, I = N.length) {
			for (T < -N.length && (T = 0), T < 0 && (T += N.length), I < 0 ? I += N.length : I > N.length && (I = N.length); T < I; T++) yield N[T];
		}
		e.slice = b;
		function _(N, T = Number.POSITIVE_INFINITY) {
			const I = [];
			if (T === 0) return [I, N];
			const D = N[Symbol.iterator]();
			for (let M = 0; M < T; M++) {
				const S = D.next();
				if (S.done) return [I, e.empty()];
				I.push(S.value);
			}
		...
		async function A(N) {
			let T = [];
			for await (const I of N) T = T.concat(I);
			return T;
		}
	...
	(function(e) {
		e.None = () => kt.None;
		function t(S, R) {
			return g(S, () => {}, 0, void 0, !0, void 0, R);
		}
		e.defer = t;
		function n(S) {
			return (R, P = null, C) => {
		...
		e.onceIf = r;
		function i(S, R, P) {
			return h((C, F = null, V) => S((j) => C.call(F, R(j)), null, V), P);
		}
		e.map = i;
		function s(S, R, P) {
			return h((C, F = null, V) => S((j) => {
				R(j), C.call(F, j);
			}, null, V), P);
		}
		e.forEach = s;
		function a(S, R, P) {
			return h((C, F = null, V) => S((j) => R(j) && C.call(F, j), null, V), P);
		}
		e.filter = a;
		function l(S) {
			return S;
		...
		e.signal = l;
		function o(...S) {
			return (R, P = null, C) => f(fo(...S.map((F) => F((V) => R.call(P, V)))), C);
		}
		e.any = o;
		function u(S, R, P, C) {
			let F = P;
			return i(S, (V) => (F = R(F, V), F), C);
		}
		e.reduce = u;
		function h(S, R) {
			let P;
		...
		function g(S, R, P = 100, C = !1, F = !1, V, j) {
			let G, W, we, An = 0, qt;
			const kn = new Re({
		...
		e.debounce = g;
		function m(S, R = 0, P) {
			return e.debounce(S, (C, F) => C ? (C.push(F), C) : [F], R, void 0, !0, void 0, P);
		}
		e.accumulate = m;
		function d(S, R = (C, F) => C === F, P) {
			let C = !0, F;
			return a(S, (V) => {
				const j = C || !R(V, F);
				return C = !1, F = V, j;
		...
		e.latch = d;
		function p(S, R, P) {
			return [e.filter(S, R, P), e.filter(S, (C) => !R(C), P)];
		}
		e.split = p;
		function v(S, R = !1, P = [], C) {
			let F = P.slice(), V = S((W) => {
				F ? F.push(W) : G.fire(W);
			});
			C && C.add(V);
		...
		class b {
			...
			filter(R) {
				return this.steps.push((P) => R(P) ? P : w), this;
			}
			reduce(R, P) {
				let C = P;
			...
			latch(R = (P, C) => P === C) {
				...
				return this.steps.push((F) => {
					const V = P || !R(F, C);
					return P = !1, C = F, V ? F : w;
				}), this;
			}
			evaluate(R) {
				for (const P of this.steps) if (R = P(R), R === w) break;
				return R;
			}
		}
		function _(S, R, P = (C) => C) {
			const C = (...G) => j.fire(P(...G)), F = () => S.on(R, C), V = () => S.removeListener(R, C), j = new Re({
		...
		function y(S, R, P = (C) => C) {
			const C = (...G) => j.fire(P(...G)), F = () => S.addEventListener(R, C), V = () => S.removeEventListener(R, C), j = new Re({
				onWillAddFirstListener: F,
				onDidRemoveLastListener: V
			});
			return j.event;
		...
		function D(S, R) {
			return new I(S, R).emitter.event;
		}
		e.fromObservable = D;
		function M(S) {
			return (R, P, C) => {
				...
				const j = {
					...
					endUpdate() {
						F--, F === 0 && (S.reportChanges(), V && (V = !1, R.call(P)));
					},
...
`));
		...
		static {
			this.cache = new Vo({ getCacheKey: JSON.stringify }, (t) => {
				...
				function i(u, h) {
					...
					for (const [g, m] of u) h.has(g) && f.set(g, m);
					return f;
				}
				const s = this.ambiguousCharacterData.value;
				let a = t.filter((u) => !u.startsWith("_") && Object.hasOwn(s, u));
	...
	new Un(() => /* @__PURE__ */ new Uint8Array(256));
	let zn;
	var nl = class Ga {
		static wrap(t) {
	...
	var it = class {
		...
		WALKTRACE(t, n, r, i, s, a, l, o, u, h, f, g, m, d, p, v, L, w) {
			let b = null, _ = null, y = new pi(), A = n, N = r, T = m[0] - v[0] - i, I = -1073741824, D = this.m_forwardHistory.length - 1;
			do {
				const M = T + t;
				M === A || M < N && u[M - 1] < u[M + 1] ? (f = u[M + 1], d = f - T - i, f < I && y.MarkNextChange(), I = f, y.AddModifiedElement(f + 1, d), T = M + 1 - t) : (f = u[M - 1] + 1, d = f - T - i, f < I && y.MarkNextChange(), I = f - 1, y.AddOriginalElement(f, d + 1), T = M - 1 - t), D >= 0 && (u = this.m_forwardHistory[D], t = u[0], A = 1, N = u.length - 1);
			} while (--D >= -1);
			if (b = y.getReverseChanges(), w[0]) {
				let M = m[0] + 1, S = v[0] + 1;
				if (b !== null && b.length > 0) {
					const R = b[b.length - 1];
					M = Math.max(M, R.getOriginalEnd()), S = Math.max(S, R.getModifiedEnd());
				}
				_ = [new Ue(M, g - M + 1, S, p - S + 1)];
			} else {
				y = new pi(), A = a, N = l, T = m[0] - v[0] - o, I = 1073741824, D = L ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const M = T + s;
					M === A || M < N && h[M - 1] >= h[M + 1] ? (f = h[M + 1] - 1, d = f - T - o, f > I && y.MarkNextChange(), I = f + 1, y.AddOriginalElement(f + 1, d + 1), T = M + 1 - s) : (f = h[M - 1], d = f - T - o, f > I && y.MarkNextChange(), I = f, y.AddModifiedElement(f + 1, d + 1), T = M - 1 - s), D >= 0 && (h = this.m_reverseHistory[D], s = h[0], A = 1, N = h.length - 1);
				} while (--D >= -1);
				_ = y.getChanges();
			}
		...
		ComputeRecursionPoint(t, n, r, i, s, a, l) {
			...
			const d = n - t + (i - r), p = d + 1, v = new Int32Array(p), L = new Int32Array(p), w = i - r, b = n - t, _ = t - r, y = n - i, A = (b - w) % 2 === 0;
			v[w] = t, L[b] = n, l[0] = !1;
			for (let N = 1; N <= d / 2 + 1; N++) {
				let T = 0, I = 0;
				h = this.ClipDiagonalBound(w - N, N, w, p), f = this.ClipDiagonalBound(w + N, N, w, p);
				for (let M = h; M <= f; M += 2) {
					M === h || M < f && v[M - 1] < v[M + 1] ? o = v[M + 1] : o = v[M - 1] + 1, u = o - (M - w) - _;
					const S = o;
					for (; o < n && u < i && this.ElementsAreEqual(o + 1, u + 1);) o++, u++;
					if (v[M] = o, o + u > T + I && (T = o, I = u), !A && Math.abs(M - b) <= N - 1 && o >= L[M]) return s[0] = o, a[0] = u, S <= L[M] && N <= 1448 ? this.WALKTRACE(w, h, f, _, b, g, m, y, v, L, o, n, s, u, i, a, A, l) : null;
				}
				const D = (T - t + (I - r) - N) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(T, D)) return l[0] = !0, s[0] = T, a[0] = I, D > 0 && N <= 1448 ? this.WALKTRACE(w, h, f, _, b, g, m, y, v, L, o, n, s, u, i, a, A, l) : (t++, r++, [new Ue(t, n - t + 1, r, i - r + 1)]);
				g = this.ClipDiagonalBound(b - N, N, b, p), m = this.ClipDiagonalBound(b + N, N, b, p);
				for (let M = g; M <= m; M += 2) {
					M === g || M < m && L[M - 1] >= L[M + 1] ? o = L[M + 1] - 1 : o = L[M - 1], u = o - (M - b) - y;
					const S = o;
					for (; o > t && u > r && this.ElementsAreEqual(o, u);) o--, u--;
					if (L[M] = o, A && Math.abs(M - w) <= N && o <= v[M]) return s[0] = o, a[0] = u, S >= v[M] && N <= 1448 ? this.WALKTRACE(w, h, f, _, b, g, m, y, v, L, o, n, s, u, i, a, A, l) : null;
				}
				if (N <= 1447) {
					let M = new Int32Array(f - h + 2);
					M[0] = w - h + 1, st.Copy2(v, h, M, 1, f - h + 1), this.m_forwardHistory.push(M), M = new Int32Array(m - g + 2), M[0] = b - g + 1, st.Copy2(L, g, M, 1, m - g + 1), this.m_reverseHistory.push(M);
				}
			}
			return this.WALKTRACE(w, h, f, _, b, g, m, y, v, L, o, n, s, u, i, a, A, l);
		}
		PrettifyChanges(t) {
				...
				for (; u < o;) {
					...
					if (g === 13) {
						...
						switch (w) {
							...
							case 34:
							case 96:
								f === w ? b = 1 : f === 39 || f === 34 || f === 96 ? b = 0 : b = 1;
								break;
							case 42:
								b = f === 42 ? 1 : 0;
								break;
						...
						b === 1 && (i.push(Gr._createLink(r, l, s, h, u)), L = !0);
					} else if (g === 12) {
						let b;
						w === 91 ? (d = !0, b = 0) : b = r.get(w), b === 1 ? L = !0 : g = 13;
					} else g = n.nextState(g, w), g === 0 && (L = !0);
					L && (g = 1, m = !1, d = !1, v = !1, h = u + 1, f = w), u++;
				}
	...
	const ce = {
		...
		relative(e, t) {
			...
			if (n.length !== e.length || r.length !== t.length) {
				...
				const v = d.length, L = p.length, w = v < L ? v : L;
				let b;
				for (b = 0; b < w && d[b].toLowerCase() === p[b].toLowerCase(); b++);
				return b === 0 ? r : b === w ? L > w ? p.slice(b).join("\\") : v > w ? "..\\".repeat(v - 1 - b) + ".." : "" : "..\\".repeat(v - b) + p.slice(b).join("\\");
			}
			let i = 0;
	...
	var su = class {
		static computeUnicodeHighlights(e, t, n) {
			...
			e: for (let p = r, v = i; p <= v; p++) {
				const L = e.getLineContent(p), w = L.length;
				o.reset(0);
				do
					if (f = o.next(L), f) {
						let b = f.index, _ = f.index + f[0].length;
						b > 0 && en(L.charCodeAt(b - 1)) && b--, _ + 1 < w && en(L.charCodeAt(_ - 1)) && _++;
						const y = L.substring(b, _);
						let A = or(b + 1, Us, L, 0);
						A && A.endColumn <= b + 1 && (A = null);
						const N = s.shouldHighlightNonBasicASCII(y, A ? A.word : null);
						if (N !== 0) {
							if (N === 3 ? g++ : N === 2 ? m++ : N === 1 ? d++ : oo(), u.length >= 1e3) {
								h = !0;
								break e;
							}
							u.push(new B(p, b + 1, p, _ + 1));
						}
					}
				while (f);
			}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = jn.getLocales().filter((a) => !jn.getInstance(/* @__PURE__ */ new Set([...t.allowedLocales, a])).isAmbiguous(r));
					return {
						kind: 0,
...
`, `
`), i = qo(n, r), s = cr.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i), l = B.fromPositions(s, this.range.getEndPosition());
			return new rt(l, a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = jo(n, r), s = cr.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i), l = B.fromPositions(this.range.getStartPosition(), s);
			return new rt(l, a);
		}
		toString() {
		...
		static createFromDiffResult(t, n, r, i, s, a, l) {
			...
			if (n.originalLength === 0 ? (o = r.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = r.getStartLineNumber(n.originalStart), u = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = i.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = i.getStartLineNumber(n.modifiedStart), f = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
				...
				if (m.getElements().length > 0 && d.getElements().length > 0) {
					...
					l && (p = Su(p)), g = [];
					for (let v = 0, L = p.length; v < L; v++) g.push(hn.createFromDiffChange(p[v], m, d));
				}
			}
...
`);
		...
		compute(e, t, n = gr.instance, r) {
			...
			for (let m = 0; m < e.length; m++) for (let d = 0; d < t.length; d++) {
				...
				let L;
				e.getElement(m) === t.getElement(d) ? (m === 0 || d === 0 ? L = 0 : L = i.get(m - 1, d - 1), m > 0 && d > 0 && s.get(m - 1, d - 1) === 3 && (L += a.get(m - 1, d - 1)), L += r ? r(m, d) : 1) : L = -1;
				const w = Math.max(p, v, L);
				if (w === L) {
					const b = m > 0 && d > 0 ? a.get(m - 1, d - 1) : 0;
					a.set(m, d, b + 1), s.set(m, d, 3);
				} else w === p ? (a.set(m, d, 0), s.set(m, d, 1)) : w === v && (a.set(m, d, 0), s.set(m, d, 2));
				i.set(m, d, w);
			}
			const l = [];
		...
		compute(e, t, n = gr.instance) {
			...
			e: for (;;) {
				...
				for (u = d; u <= p; u += 2) {
					const v = u === p ? -1 : l.get(u + 1), L = u === d ? -1 : l.get(u - 1) + 1, w = Math.min(Math.max(v, L), r.length), b = w - u;
					if (w > r.length || b > i.length) continue;
					const _ = s(w, b);
					l.set(u, _);
					const y = w === v ? o.get(u + 1) : o.get(u - 1);
					if (o.set(u, _ !== w ? new e1(y, w, b, _ - w) : y), l.get(u) === r.length && l.get(u) - u === i.length) break e;
				}
			}
			let h = o.get(u);
			const f = [];
...
`).length >= 15 && Pu(h, (f) => f.length >= 2) >= 2;
	...
	function Iu(e, t, n, r, i, s) {
		...
		for (const g of e) {
			...
			for (let d = g.modified.startLineNumber; d < g.modified.endLineNumberExclusive - 2; d++) {
				const p = `${n[d - 1]}:${n[d + 1 - 1]}:${n[d + 2 - 1]}`, v = new z(d, d + 3), L = [];
				l.forEach(p, ({ range: w }) => {
					for (const _ of m) if (_.originalLineRange.endLineNumberExclusive + 1 === w.endLineNumberExclusive && _.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
						_.originalLineRange = new z(_.originalLineRange.startLineNumber, w.endLineNumberExclusive), _.modifiedLineRange = new z(_.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), L.push(_);
						return;
					}
					const b = {
						modifiedLineRange: v,
		...
		for (const g of o) {
			...
			for (const L of v.ranges) {
				...
				const w = L, b = L.delta(-m);
				a.push(new ft(b, w)), u.addRange(w), h.addRange(b);
			}
		}
		a.sort(Et((g) => g.original.startLineNumber, Tt));
		const f = new zs(e);
		for (let g = 0; g < a.length; g++) {
			const m = a[g], d = f.findLastMonotonous((A) => A.original.startLineNumber <= m.original.startLineNumber), p = ut(e, (A) => A.modified.startLineNumber <= m.modified.startLineNumber), v = Math.max(m.original.startLineNumber - d.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), L = f.findLastMonotonous((A) => A.original.startLineNumber < m.original.endLineNumberExclusive), w = ut(e, (A) => A.modified.startLineNumber < m.modified.endLineNumberExclusive), b = Math.max(L.original.endLineNumberExclusive - m.original.endLineNumberExclusive, w.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
			let _;
			for (_ = 0; _ < v; _++) {
				const A = m.original.startLineNumber - _ - 1, N = m.modified.startLineNumber - _ - 1;
				if (A > r.length || N > i.length || u.contains(N) || h.contains(A) || !i1(r[A - 1], i[N - 1], s)) break;
			}
			_ > 0 && (h.addRange(new z(m.original.startLineNumber - _, m.original.startLineNumber)), u.addRange(new z(m.modified.startLineNumber - _, m.modified.startLineNumber)));
			let y;
			for (y = 0; y < b; y++) {
				const A = m.original.endLineNumberExclusive + y, N = m.modified.endLineNumberExclusive + y;
				if (A > r.length || N > i.length || u.contains(N) || h.contains(A) || !i1(r[A - 1], i[N - 1], s)) break;
			}
			y > 0 && (h.addRange(new z(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + y)), u.addRange(new z(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + y))), (_ > 0 || y > 0) && (a[g] = new ft(new z(m.original.startLineNumber - _, m.original.endLineNumberExclusive + y), new z(m.modified.startLineNumber - _, m.modified.endLineNumberExclusive + y)));
		}
		return a;
	}
	function i1(e, t, n) {
	...
	function l1(e, t, n, r, i = !1) {
		...
		function o(u, h) {
			...
			for (; s.length > 0;) {
				const L = s[0];
				if (!(L.seq1Range.intersects(m.seq1Range) || L.seq2Range.intersects(m.seq2Range))) break;
				const w = new ge(r(e, L.seq1Range.start), r(t, L.seq2Range.start)), b = w.intersect(L);
				if (p += b.seq1Range.length, v += b.seq2Range.length, m = m.join(w), m.seq1Range.endExclusive >= L.seq1Range.endExclusive) s.shift();
				else break;
			}
	...
	function Uu(e, t, n) {
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let g = function(m, d) {
					...
					const L = e.countLinesIn(m.seq1Range), w = m.seq1Range.length, b = t.countLinesIn(m.seq2Range), _ = m.seq2Range.length, y = e.countLinesIn(d.seq1Range), A = d.seq1Range.length, N = t.countLinesIn(d.seq2Range), T = d.seq2Range.length, I = 130;
					function D(M) {
						return Math.min(M, I);
					}
					return Math.pow(Math.pow(D(L * 40 + w), 1.5) + Math.pow(D(b * 40 + _), 1.5), 1.5) + Math.pow(Math.pow(D(y * 40 + A), 1.5) + Math.pow(D(N * 40 + T), 1.5), 1.5) > (I ** 1.5) ** 1.5 * 1.3;
				};
		...
		return fu(r, (o, u, h) => {
			...
			const v = ge.fromOffsetPairs(o ? o.getEndExclusives() : Qe.zero, h ? h.getStarts() : Qe.max), L = f.intersect(v);
...
`);
	...
	var qu = class {
		...
		computeDiff(e, t, n) {
			if (e.length <= 1 && lu(e, t, (_, y) => _ === y)) return new ln([], [], !1);
			...
			function a(_) {
				let y = s.get(_);
				return y === void 0 && (y = s.size, s.set(_, y)), y;
			}
			const l = e.map((_) => a(_.trim())), o = t.map((_) => a(_.trim())), u = new u1(l, e), h = new u1(o, t), f = u.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(u, h, r, (_, y) => e[_] === t[y] ? t[y].length === 0 ? .1 : 1 + Math.log(1 + t[y].length) : .99) : this.myersDiffingAlgorithm.compute(u, h, r);
			let g = f.diffs, m = f.hitTimeout;
			g = s1(u, h, g), g = Bu(u, h, g);
			const d = [], p = (_) => {
				if (i) for (let y = 0; y < _; y++) {
					const A = v + y, N = L + y;
					if (e[A] !== t[N]) {
						const T = this.refineDiff(e, t, new ge(new X(A, A + 1), new X(N, N + 1)), r, i, n);
			...
			let v = 0, L = 0;
			for (const _ of g) {
				Jt(() => _.seq1Range.start - v === _.seq2Range.start - L), p(_.seq1Range.start - v), v = _.seq1Range.endExclusive, L = _.seq2Range.endExclusive;
				const y = this.refineDiff(e, t, _, r, i, n);
				y.hitTimeout && (m = !0);
				for (const A of y.mappings) d.push(A);
			}
			p(e.length - v);
			const w = Js(d, new fn(e), new fn(t));
			let b = [];
			return n.computeMoves && (b = this.computeMoves(w, e, t, l, o, r, i, n)), Jt(() => {
				function _(A, N) {
					if (A.lineNumber < 1 || A.lineNumber > N.length) return !1;
					const T = N[A.lineNumber - 1];
					return !(A.column < 1 || A.column > T.length + 1);
				}
				function y(A, N) {
					return !(A.startLineNumber < 1 || A.startLineNumber > N.length + 1 || A.endLineNumberExclusive < 1 || A.endLineNumberExclusive > N.length + 1);
				}
				for (const A of w) {
					if (!A.innerChanges) return !1;
					for (const N of A.innerChanges) if (!(_(N.modifiedRange.getStartPosition(), t) && _(N.modifiedRange.getEndPosition(), t) && _(N.originalRange.getStartPosition(), e) && _(N.originalRange.getEndPosition(), e))) return !1;
		...
		(function(t) {
			(function(n) {
				...
				function m(p) {
					...
					if (v === 4) {
						const L = d(p.charCodeAt(1)), w = d(p.charCodeAt(2)), b = d(p.charCodeAt(3));
						return new e(new k(16 * L + L, 16 * w + w, 16 * b + b));
					}
					if (v === 5) {
						const L = d(p.charCodeAt(1)), w = d(p.charCodeAt(2)), b = d(p.charCodeAt(3)), _ = d(p.charCodeAt(4));
						return new e(new k(16 * L + L, 16 * w + w, 16 * b + b, (16 * _ + _) / 255));
					}
					return null;
				}
				n.parseHex = m;
...
`), p = d.length, v = m + p - 1, L = f.lastIndexOf(`
`) + 1, w = h.index - L + 1, b = d[d.length - 1], _ = {
					range: {
						startLineNumber: m,
						startColumn: w,
						endLineNumber: v,
						endColumn: p === 1 ? w + h[0].length : b.length + 1
					},
					text: (h.groups ?? {}).label ?? "",
					hasSeparatorLine: ((h.groups ?? {}).separator ?? "") !== "",
					shouldBeInComments: !0
				};
				(_.text || _.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < _.range.startLineNumber) && n.push(_), s.lastIndex = h.index + h[0].length;
			}
		}
		return n;
	}
	...
	var nc = class {
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			for (let { range: o, text: u, eol: h } of n) {
				...
				for (const d of g) {
					const p = i.positionAt(m + d.originalStart), v = i.positionAt(m + d.originalStart + d.originalLength), L = {
	...
	function vr(e, t = !1) {
		...
		function g(b, _) {
			...
			for (; y < b;) {
				...
				if (N >= 48 && N <= 57) A = A * 16 + N - 48;
				else if (N >= 65 && N <= 70) A = A * 16 + N - 65 + 10;
				else if (N >= 97 && N <= 102) A = A * 16 + N - 97 + 10;
				else break;
				r++, y++;
			}
			return y < b && (A = -1), A;
				...
				case 47:
					...
					if (e.charCodeAt(r + 1) === 42) {
						...
						for (; r < y;) {
							...
							r++, Ft(N) && (N === 13 && e.charCodeAt(r) === 10 && r++, l++, u = r);
						}
						return A || (r++, f = 1), i = e.substring(_, r), a = 13;
					}
...
`
	...
	function mc(e, t, n) {
		...
		const w = [];
		function b(y, A, N) {
			!p && (!t || A < l && N > a) && e.substring(A, N) !== y && w.push({
				offset: A,
				length: N - A,
				content: y
			});
		...
		let _ = L();
		if (n.keepLines && h > 0 && b(bt(o, h), 0, 0), _ !== 17) {
			let y = d.getTokenOffset() + s;
			b(g.length * r < 20 && n.insertSpaces ? ve[g.length * r] : bt(g, r), s, y);
		}
		for (; _ !== 17;) {
			let y = d.getTokenOffset() + d.getTokenLength() + s, A = L(), N = "", T = !1;
			for (; h === 0 && (A === 12 || A === 13);) {
				let D = d.getTokenOffset() + s;
				b(ve[1], y, D), y = d.getTokenOffset() + d.getTokenLength() + s, T = A === 12, N = T ? v() : "", A = L();
			}
			if (A === 2) _ !== 1 && f--, n.keepLines && h > 0 || !n.keepLines && _ !== 1 ? N = v() : n.keepLines && (N = ve[1]);
			else if (A === 4) _ !== 3 && f--, n.keepLines && h > 0 || !n.keepLines && _ !== 3 ? N = v() : n.keepLines && (N = ve[1]);
			else {
				switch (_) {
					case 3:
					case 1:
						f++, n.keepLines && h > 0 || !n.keepLines ? N = v() : N = ve[1];
						break;
					case 5:
						n.keepLines && h > 0 || !n.keepLines ? N = v() : N = ve[1];
						break;
					case 12:
						N = v();
						break;
					case 13:
						...
						break;
					case 6:
						n.keepLines && h > 0 ? N = v() : T || (N = ve[1]);
						break;
					case 10:
						n.keepLines && h > 0 ? N = v() : A === 6 && !T && (N = "");
						break;
					case 7:
					case 8:
					case 9:
					...
					case 2:
					case 4:
						n.keepLines && h > 0 ? N = v() : (A === 12 || A === 13) && !T ? N = ve[1] : A !== 5 && A !== 17 && (p = !0);
						break;
					case 16:
						p = !0;
						break;
			...
			A === 17 && (n.keepLines && h > 0 ? N = v() : N = n.insertFinalNewline ? o : "");
...
`.indexOf(e.charAt(t)) !== -1;
	...
	function yc(e, t, n = pn.DEFAULT) {
		const r = vr(e, !1), i = [];
		function s(S) {
			return S ? () => S(r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter()) : () => !0;
		}
		function a(S) {
			return S ? () => S(r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () => i.slice()) : () => !0;
		}
		function l(S) {
			return S ? (R) => S(R, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter()) : () => !0;
		}
		function o(S) {
			return S ? (R) => S(R, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () => i.slice()) : () => !0;
		}
		const u = a(t.onObjectBegin), h = o(t.onObjectProperty), f = s(t.onObjectEnd), g = a(t.onArrayBegin), m = s(t.onArrayEnd), d = o(t.onLiteralValue), p = l(t.onSeparator), v = s(t.onComment), L = l(t.onError), w = n && n.disallowComments, b = n && n.allowTrailingComma;
		function _() {
			for (;;) {
				const S = r.scan();
		...
		function T() {
			return r.getToken() !== 10 ? (y(3, [], [2, 5]), !1) : (A(!1), r.getToken() === 6 ? (p(":"), _(), M() || y(4, [], [2, 5])) : y(5, [], [2, 5]), i.pop(), !0);
		}
		function I() {
			u(), _();
			let S = !1;
			for (; r.getToken() !== 2 && r.getToken() !== 17;) {
				if (r.getToken() === 5) {
					if (S || y(4, [], []), p(","), _(), r.getToken() === 2 && b) break;
				} else S && y(6, [], []);
				T() || y(4, [], [2, 5]), S = !0;
			}
			return f(), r.getToken() !== 2 ? y(7, [2], []) : _(), !0;
		}
		function D() {
			g(), _();
			let S = !0, R = !1;
			for (; r.getToken() !== 4 && r.getToken() !== 17;) {
				if (r.getToken() === 5) {
					if (R || y(4, [], []), p(","), _(), r.getToken() === 4 && b) break;
				} else R && y(6, [], []);
				S ? (i.push(0), S = !1) : i[i.length - 1]++, M() || y(4, [], [4, 5]), R = !0;
			}
			return m(), S || i.pop(), r.getToken() !== 4 ? y(8, [4], []) : _(), !0;
		}
		function M() {
			switch (r.getToken()) {
				case 3: return D();
		...
		return _(), r.getToken() === 17 ? n.allowEmptyContent ? !0 : (y(4, [], []), !1) : M() ? (r.getToken() !== 17 && y(9, [], []), !0) : (y(4, [], []), !1);
	}
	const Ye = vr;
	var L1;
	(function(e) {
...
` && r++;
	...
	var Ra = class {
		...
		getMatchingSchemas(e, t = -1, n) {
			if (this.root && e) {
				const r = new Vc(t, n), s = new ka(Ma(e));
	...
	function ae(e, t, n, r, i) {
		...
		function a() {
			...
			})), Array.isArray(t.allOf)) for (const w of t.allOf) {
				const b = new le(), _ = r.newSub();
				ae(s, be(w), b, _, i), n.merge(b), r.merge(_);
			}
			const g = be(t.not);
			if (g) {
				const w = new le(), b = r.newSub();
				ae(s, g, w, b, i), w.hasProblems() || n.problems.push({
					location: {
						offset: s.offset,
						length: s.length
					},
			...
			const m = (w, b) => {
				...
				let y;
				for (const A of w) {
					const N = be(A), T = new le(), I = r.newSub();
					if (ae(s, N, T, I, i), T.hasProblems() || _.push(N), !y) y = {
						schema: N,
						validationResult: T,
						matchingSchemas: I
					};
				...
				return _.length > 1 && b && n.problems.push({
					location: {
						offset: s.offset,
						length: 1
					},
					message: E("Matches multiple schemas when only one must validate.")
				}), y && (n.merge(y.validationResult), r.merge(y.matchingSchemas)), _.length;
			};
			...
			const d = (w) => {
				...
				const y = be(w), A = new le(), N = r.newSub();
				ae(s, y, A, N, i), r.merge(N), n.mergeProcessedProperties(A), A.hasProblems() ? _ && d(_) : b && d(b);
			}, v = be(t.if);
			if (v && p(v, be(t.then), be(t.else)), Array.isArray(t.enum)) {
				const w = tt(s);
				let b = !1;
				for (const _ of t.enum) if (yt(w, _)) {
					b = !0;
					break;
				}
				n.enumValues = t.enum, n.enumValueMatch = b, b || n.problems.push({
					...
					message: t.errorMessage || E("Value is not accepted. Valid values: {0}.", t.enum.map((_) => JSON.stringify(_)).join(", "))
				});
			}
		...
		function l(f) {
			const g = f.value;
			function m(_) {
				const y = /^(-?\d+)(?:\.(\d+))?(?:e([-+]\d+))?$/.exec(_.toString());
				return y && {
			...
			if (oe(t.multipleOf)) {
				let _ = -1;
				if (Number.isInteger(t.multipleOf)) _ = g % t.multipleOf;
				else {
					let y = m(t.multipleOf), A = m(g);
					if (y && A) {
						const N = 10 ** Math.abs(A.multiplier - y.multiplier);
						A.multiplier < y.multiplier ? A.value *= N : y.value *= N, _ = A.value % y.value;
					}
				}
				_ !== 0 && n.problems.push({
					location: {
			...
			const w = p(t.minimum, t.exclusiveMinimum);
			oe(w) && g < w && n.problems.push({
				location: {
					offset: f.offset,
					length: f.length
				},
				message: E("Value is below the minimum of {0}.", w)
			});
		...
		function u(f) {
			...
			let d = 0;
			if (g !== void 0) {
				const w = Math.min(g.length, f.items.length);
				for (; d < w; d++) {
					const b = g[d], _ = be(b), y = new le(), A = f.items[d];
					A && (ae(A, _, y, r, i), n.mergePropertyMatch(y)), n.processedProperties.add(String(d));
				}
			}
			if (m !== void 0 && d < f.items.length) if (typeof m == "boolean") for (m === !1 && n.problems.push({
				...
				const w = new le();
				ae(f.items[d], m, w, r, i), n.mergePropertyMatch(w), n.processedProperties.add(String(d));
			}
			const p = be(t.contains);
			if (p) {
				let w = 0;
				for (let b = 0; b < f.items.length; b++) {
					const _ = f.items[b], y = new le();
					ae(_, p, y, $t.instance, i), y.hasProblems() || (w++, i.schemaDraft >= ke.v2020_12 && n.processedProperties.add(String(b)));
				}
				w === 0 && !oe(t.minContains) && n.problems.push({
					location: {
						offset: f.offset,
						length: f.length
					},
					message: t.errorMessage || E("Array does not contain required item.")
				}), oe(t.minContains) && w < t.minContains && n.problems.push({
					location: {
						offset: f.offset,
						length: f.length
					},
					message: t.errorMessage || E("Array has too few items that match the contains contraint. Expected {0} or more.", t.minContains)
				}), oe(t.maxContains) && w > t.maxContains && n.problems.push({
					location: {
						offset: f.offset,
						length: f.length
					},
			...
			if (v !== void 0) for (let w = 0; w < f.items.length; w++) {
				if (!n.processedProperties.has(String(w))) if (v === !1) n.problems.push({
					location: {
						offset: f.offset,
						length: f.length
					},
					...
					const b = new le();
					ae(f.items[w], t.unevaluatedItems, b, r, i), n.mergePropertyMatch(b);
				}
			...
			if (oe(t.minItems) && f.items.length < t.minItems && n.problems.push({
				...
				let b = function() {
					for (let _ = 0; _ < w.length - 1; _++) {
						const y = w[_];
						for (let A = _ + 1; A < w.length; A++) if (yt(y, w[A])) return !0;
					}
					return !1;
				};
				const w = tt(f);
		...
		function h(f) {
			...
			for (const b of f.properties) {
				...
				g[_] = b.valueNode, m.add(_);
			}
			if (Array.isArray(t.required)) {
				for (const b of t.required) if (!g[b]) {
					const _ = f.parent && f.parent.type === "property" && f.parent.keyNode, y = _ ? {
						offset: _.offset,
						length: _.length
					} : {
						offset: f.offset,
			...
			if (t.properties) for (const b of Object.keys(t.properties)) {
				d(b);
				const _ = t.properties[b], y = g[b];
				if (y) if (Ee(_)) if (_) n.propertiesMatches++, n.propertiesValueMatches++;
				else {
					const A = y.parent;
					n.problems.push({
						location: {
					...
					const A = new le();
					ae(y, _, A, r, i), n.mergePropertyMatch(A);
				}
			}
					...
					for (const A of m) if (_.test(A)) {
						...
						if (N) {
							...
							if (Ee(T)) if (T) n.propertiesMatches++, n.propertiesValueMatches++;
								...
								const I = new le();
								ae(N, T, I, r, i), n.mergePropertyMatch(I);
							}
						}
					}
					y.forEach(d);
			...
			if (p !== void 0) for (const b of m) {
				...
				if (_) {
					if (p === !1) {
						...
						const y = new le();
						ae(_, p, y, r, i), n.mergePropertyMatch(y);
					}
				}
			}
			...
			if (v !== void 0) {
				const b = [];
				for (const _ of m) if (!n.processedProperties.has(_)) {
					b.push(_);
					const y = g[_];
					if (y) {
						if (v === !1) {
			...
			if (oe(t.maxProperties) && f.properties.length > t.maxProperties && n.problems.push({
				...
				const _ = g[b], y = t.dependentRequired[b];
				_ && Array.isArray(y) && w(b, y);
			}
			if (t.dependentSchemas) for (const b in t.dependentSchemas) {
				const _ = g[b], y = t.dependentSchemas[b];
				_ && We(y) && w(b, y);
			}
			if (t.dependencies) for (const b in t.dependencies) g[b] && w(b, t.dependencies[b]);
			const L = be(t.propertyNames);
			if (L) for (const b of f.properties) {
				const _ = b.keyNode;
				_ && ae(_, L, n, $t.instance, i);
			}
			function w(b, _) {
				if (Array.isArray(_)) for (const y of _) g[y] ? n.propertiesValueMatches++ : n.problems.push({
					location: {
						offset: f.offset,
						length: f.length
					},
	...
	function Oc(e, t) {
		...
		function o(y, A, N, T, I = de.Error) {
			if (n.length === 0 || N !== r) {
				const D = q.create(e.positionAt(N), e.positionAt(T));
				n.push(Oe.create(D, y, I, A, e.languageId)), r = N;
			}
		}
		function u(y, A, N = void 0, T = [], I = []) {
			let D = s.getTokenOffset(), M = s.getTokenOffset() + s.getTokenLength();
			if (D === M && D > 0) {
				for (D--; D > 0 && /\s/.test(i.charAt(D));) D--;
				M = D + 1;
			}
			if (o(y, A, D, M), N && f(N, !1), T.length + I.length > 0) {
				let S = s.getToken();
				for (; S !== 17;) {
					if (T.indexOf(S) !== -1) {
						l();
						break;
					} else if (I.indexOf(S) !== -1) break;
					S = l();
				}
			}
			return N;
		...
		function g(y) {
			...
			for (; s.getToken() !== 4 && s.getToken() !== 17;) {
				if (s.getToken() === 5) {
					N || u(E("Value expected"), H.ValueExpected);
					const I = s.getTokenOffset();
					if (l(), s.getToken() === 4) {
						N && o(E("Trailing comma"), H.TrailingComma, I, I + 1);
						continue;
					}
				} else N && u(E("Expected comma"), H.CommaExpected);
				const T = b(A);
				T ? A.items.push(T) : u(E("Value expected"), H.ValueExpected, void 0, [], [4, 5]), N = !0;
			}
			return s.getToken() !== 4 ? u(E("Expected comma or closing bracket"), H.CommaOrCloseBacketExpected, A) : f(A, !0);
		}
		const m = new Dr(void 0, 0, 0);
		function d(y, A) {
			const N = new Cc(y, s.getTokenOffset(), m);
			let T = v(N);
			if (!T) if (s.getToken() === 16) {
				u(E("Property keys must be doublequoted"), H.PropertyKeysMustBeDoublequoted);
				const D = new Dr(N, s.getTokenOffset(), s.getTokenLength());
				D.value = s.getTokenValue(), T = D, l();
			} else return;
			if (N.keyNode = T, T.value !== "//") {
				const D = A[T.value];
				D ? (o(E("Duplicate object key"), H.DuplicateKey, N.keyNode.offset, N.keyNode.offset + N.keyNode.length, de.Warning), We(D) && o(E("Duplicate object key"), H.DuplicateKey, D.keyNode.offset, D.keyNode.offset + D.keyNode.length, de.Warning), A[T.value] = !0) : A[T.value] = N;
			}
			if (s.getToken() === 6) N.colonOffset = s.getTokenOffset(), l();
			else if (u(E("Colon expected"), H.ColonExpected), s.getToken() === 10 && e.positionAt(T.offset + T.length).line < e.positionAt(s.getTokenOffset()).line) return N.length = T.length, N;
			const I = b(N);
			return I ? (N.valueNode = I, N.length = I.offset + I.length - N.offset, N) : u(E("Value expected"), H.ValueExpected, N, [], [2, 5]);
		}
		function p(y) {
			if (s.getToken() !== 1) return;
			const A = new Ic(y, s.getTokenOffset()), N = Object.create(null);
			l();
			let T = !1;
		...
		function b(y) {
			return g(y) || p(y) || v(y) || L(y) || w(y);
		}
		let _;
		return l() !== 17 && (_ = b(_), _ ? s.getToken() !== 17 && u(E("End of file expected."), H.Undefined) : u(E("Expected a JSON object, array or literal."), H.Undefined)), new Ra(_, n, a);
	}
	function $r(e, t, n) {
	...
	var $c = class {
		...
		doComplete(e, t, n) {
			...
			return this.schemaService.getSchemaForResource(e.uri, n).then((f) => {
				...
				if (a && a.type === "string") {
					const L = a.parent;
					L && L.type === "property" && L.keyNode === a && (m = !L.valueNode, p = L, d = i.substr(a.offset + 1, a.length - 2), L && (a = L.parent));
				}
				if (a && a.type === "object") {
					...
					this.contributions.forEach((b) => {
						const _ = b.collectPropertyCompletions(e.uri, w, l, m, L === "", h);
						_ && g.push(_);
				...
				return f ? this.getValueCompletions(f, n, a, s, e, h, v) : this.getSchemaLessValueCompletions(n, a, s, e, h), this.contributions.length > 0 && this.getContributedValueCompletions(n, a, s, e, h, g), this.promiseConstructor.all(g).then(() => {
					if (h.getNumberOfProposals() === 0) {
						...
						const w = this.evaluateSeparatorAfter(e, L);
						this.addFillerValueCompletions(v, w, h);
					}
					return r;
				});
			});
				...
				if (u && i) {
					...
					h.every((v) => {
						if (v.node === i && !v.inverted && v.schema && (f = f || v.schema.title, g = g || v.schema.markdownDescription || Br(v.schema.description), v.schema.enum)) {
							const L = v.schema.enum.indexOf(tt(i));
							v.schema.markdownEnumDescriptions ? m = v.schema.markdownEnumDescriptions[L] : v.schema.enumDescriptions && (m = Br(v.schema.enumDescriptions[L])), m && (d = v.schema.enum[L], typeof d != "string" && (d = JSON.stringify(d)));
						}
						return !0;
					});
					let p = "";
...
$3`).replace(/[\\`*_{}[\]()#+\-.!]/g, "\\$&");
		...
		doValidation(e, t, n, r) {
			...
			const i = [], s = {}, a = (o) => {
				...
				if (o) {
					const m = (d, p) => {
						if (t.root && g) {
							const v = t.root, L = v.type === "object" ? v.properties[0] : void 0;
							if (L && L.keyNode.value === "$schema") {
								const w = L.valueNode || L, b = q.create(e.positionAt(w.offset), e.positionAt(w.offset + w.length));
								a(Oe.create(b, d, g, p));
							} else {
								const w = q.create(e.positionAt(v.offset), e.positionAt(v.offset + 1));
								a(Oe.create(w, d, g, p));
							}
						}
					};
		...
		findDocumentSymbols2(e, t, n = { resultLimit: Number.MAX_VALUE }) {
			...
			const h = (f, g) => {
				f.type === "array" ? f.items.forEach((m, d) => {
					...
					if (d) if (i > 0) {
						i--;
						const p = He(e, m), v = He(e, m.keyNode), L = [], w = {
							name: this.getKeyLabel(m),
							kind: this.getSymbolKind(d.type),
							range: p,
							selectionRange: v,
	...
	(() => {
		var e = { 470: (i) => {
			...
			var l = {
				...
				relative: function(o, u) {
					...
					for (var d = u.length - m, p = g < d ? g : d, v = -1, L = 0; L <= p; ++L) {
						if (L === p) {
							if (d > p) {
								if (u.charCodeAt(m + L) === 47) return u.slice(m + L + 1);
								if (L === 0) return u.slice(m + L);
							} else g > p && (o.charCodeAt(h + L) === 47 ? v = L : L === 0 && (v = 0));
							break;
						}
						var w = o.charCodeAt(h + L);
						if (w !== u.charCodeAt(m + L)) break;
						w === 47 && (v = L);
					}
					var b = "";
					for (L = h + v + 1; L <= f; ++L) L !== f && o.charCodeAt(L) !== 47 || (b.length === 0 ? b += ".." : b += "/..");
				...
				parse: function(o) {
					...
					g ? (u.root = "/", h = 1) : h = 0;
					for (var m = -1, d = 0, p = -1, v = !0, L = o.length - 1, w = 0; L >= h; --L) if ((f = o.charCodeAt(L)) !== 47) p === -1 && (v = !1, p = L + 1), f === 46 ? m === -1 ? m = L : w !== 1 && (w = 1) : m !== -1 && (w = -1);
					else if (!v) {
						d = L + 1;
						break;
					}
					return m === -1 || p === -1 || w === 0 || w === 1 && m === p - 1 && m === d + 1 ? p !== -1 && (u.base = u.name = d === 0 && g ? o.slice(1, p) : o.slice(d, p)) : (d === 0 && g ? (u.name = o.slice(1, m), u.base = o.slice(1, p)) : (u.name = o.slice(d, m), u.base = o.slice(d, p)), u.ext = o.slice(m, p)), d > 0 ? u.dir = o.slice(0, d - 1) : g && (u.dir = "/"), u;
				},
				sep: "/",
				delimiter: ":",
				win32: null,
		...
		(() => {
			...
			const s = /^\w[\w\d+.-]*$/, a = /^\//, l = /^\/\//;
			function o(M, S) {
				if (!M.scheme && S) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${M.authority}", path: "${M.path}", query: "${M.query}", fragment: "${M.fragment}"}`);
			...
			class g {
				static isUri(S) {
					return S instanceof g || !!S && typeof S.authority == "string" && typeof S.fragment == "string" && typeof S.path == "string" && typeof S.query == "string" && typeof S.scheme == "string" && typeof S.fsPath == "string" && typeof S.with == "function" && typeof S.toString == "function";
				}
				scheme;
				authority;
				path;
				query;
				fragment;
				constructor(S, R, P, C, F, V = !1) {
					typeof S == "object" ? (this.scheme = S.scheme || u, this.authority = S.authority || u, this.path = S.path || u, this.query = S.query || u, this.fragment = S.fragment || u) : (this.scheme = (function(j, G) {
						return j || G ? j : "file";
					})(S, V), this.authority = R || u, this.path = (function(j, G) {
						switch (j) {
							case "https":
							case "http":
				...
				with(S) {
					if (!S) return this;
					let { scheme: R, authority: P, path: C, query: F, fragment: V } = S;
				...
				static file(S) {
					let R = u;
					if (i && (S = S.replace(/\\/g, h)), S[0] === h && S[1] === h) {
						const P = S.indexOf(h, 2);
						P === -1 ? (R = S.substring(2), S = h) : (R = S.substring(2, P), S = S.substring(P) || h);
					}
					return new d("file", R, S, u, u);
				}
				static from(S) {
					const R = new d(S.scheme, S.authority, S.path, S.query, S.fragment);
					return o(R, !0), R;
				}
				toString(S = !1) {
					return b(this, S);
				...
				static revive(S) {
					if (S) {
						...
						{
							const R = new d(S);
							return R._formatted = S.external, R._fsPath = S._sep === m ? S.fsPath : null, R;
						}
					}
					return S;
				}
			...
			class d extends g {
				...
				toString(S = !1) {
					return S ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)), this._formatted);
				}
				toJSON() {
					const S = { $mid: 1 };
			...
			function v(M, S, R) {
				...
				for (let F = 0; F < M.length; F++) {
					...
					if (V >= 97 && V <= 122 || V >= 65 && V <= 90 || V >= 48 && V <= 57 || V === 45 || V === 46 || V === 95 || V === 126 || S && V === 47 || R && V === 91 || R && V === 93 || R && V === 58) C !== -1 && (P += encodeURIComponent(M.substring(C, F)), C = -1), P !== void 0 && (P += M.charAt(F));
					else {
			...
			function L(M) {
				...
				for (let R = 0; R < M.length; R++) {
					...
					P === 35 || P === 63 ? (S === void 0 && (S = M.substr(0, R)), S += p[P]) : S !== void 0 && (S += M[R]);
				}
				return S !== void 0 ? S : M;
			}
			function w(M, S) {
			...
			function b(M, S) {
				...
				return j && (P += "?", P += R(j, !1, !1)), G && (P += "#", P += S ? G : v(G, !1, !1)), P;
			}
			function _(M) {
				try {
					return decodeURIComponent(M);
				} catch {
					return M.length > 3 ? M.substr(0, 3) + _(M.substr(3)) : M;
				}
			}
			const y = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
			function A(M) {
				return M.match(y) ? M.replace(y, ((S) => _(S))) : M;
			}
			var N = n(470);
			const T = N.posix || N, I = "/";
			var D;
			(function(M) {
				M.joinPath = function(S, ...R) {
					return S.with({ path: T.join(S.path, ...R) });
				}, M.resolvePath = function(S, ...R) {
					let P = S.path, C = !1;
					P[0] !== I && (P = I + P, C = !0);
					let F = T.resolve(P, ...R);
					return C && F[0] === I && !S.authority && (F = F.substring(1)), S.with({ path: F });
				}, M.dirname = function(S) {
					if (S.path.length === 0 || S.path === I) return S;
					let R = T.dirname(S.path);
					return R.length === 1 && R.charCodeAt(0) === 46 && (R = ""), S.with({ path: R });
				}, M.basename = function(S) {
					return T.basename(S.path);
				}, M.extname = function(S) {
	...
	var Kc = class {
		...
		resolveSchemaContent(e, t) {
			...
			const a = this.contextService, l = (d, p) => {
				...
				let v = d;
				return p[0] === "/" && (p = p.substring(1)), p.split("/").some((L) => (L = L.replace(/~1/g, "/").replace(/~0/g, "~"), v = v[L], !v)), v;
			}, o = (d, p, v) => (p.anchors || (p.anchors = m(d)), p.anchors.get(v)), u = (d, p) => {
				for (const v in p) p.hasOwnProperty(v) && v !== "id" && v !== "$id" && (d[v] = p[v]);
			}, h = (d, p, v, L) => {
				let w;
				L === void 0 || L.length === 0 ? w = p : L.charAt(0) === "/" ? w = l(p, L) : w = o(p, v, L), w ? u(d, w) : n.push(E("$ref '{0}' in '{1}' can not be resolved.", L || "", v.uri));
			}, f = (d, p, v, L) => {
				a && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(p) && (p = a.resolveRelativePath(p, L.uri)), p = ze(p);
				const w = this.getOrAddSchemaHandle(p);
				return w.getUnresolvedSchema().then((b) => {
					if (L.dependencies.add(p), b.errors.length) {
						const _ = v ? p + "#" + v : p;
						n.push(E("Problems loading reference '{0}': {1}", _, b.errors[0]));
					}
					return h(d, b.schema, w, v), g(d, b.schema, w);
				});
			}, g = (d, p, v) => {
				const L = [];
				return this.traverseNodes(d, (w) => {
					...
					for (; w.$ref;) {
						const _ = w.$ref, y = _.split("#", 2);
						if (delete w.$ref, y[0].length > 0) {
							L.push(f(w, y[0], y[1], v));
							return;
						} else if (!b.has(_)) {
							const A = y[1];
							h(w, p, v, A), b.add(_);
					...
					w.$recursiveRef && s.add("$recursiveRef"), w.$dynamicRef && s.add("$dynamicRef");
				}), this.promise.all(L);
			}, m = (d) => {
				const p = /* @__PURE__ */ new Map();
				return this.traverseNodes(d, (v) => {
					const L = v.$id || v.id, w = A1(L) && L.charAt(0) === "#" ? L.substring(1) : v.$anchor;
					w && (p.has(w) ? n.push(E("Duplicate anchor declaration: '{0}'", w)) : p.set(w, v)), v.$recursiveAnchor && s.add("$recursiveAnchor"), v.$dynamicAnchor && s.add("$dynamicAnchor");
				}), p;
			};
				...
				case 12: {
					...
					if (d) {
						...
						if (d[1]) {
							...
							if (v >= 0) {
								const L = i[v];
								i.length = v, p > L.startLine && s !== L.startLine && (L.endLine = p, o(L), s = L.startLine);
							}
						}
					}
					break;
...
`,
	...
	function l0(e) {
		...
		let n = new Sn(), r = n, i = n, s = n, a, l = 0, o = 0, u, h, f = -1, g = -1, m = 0, d = 0, p = [], v = !1, L = !1;
		for (; (a = t.scan()) !== 17;) {
			if (v === !0 && a !== 14 && a !== 15 && a !== 12 && a !== 13 && i.endLineNumber === void 0) {
				let w = t.getTokenStartLine();
				h === 2 || h === 4 ? s.endLineNumber = w - 1 : i.endLineNumber = w - 1, m = w, v = !1;
			}
			if (L === !0 && a !== 14 && a !== 15 && a !== 12 && a !== 13 && (m = t.getTokenStartLine(), L = !1), t.getTokenStartLine() !== l) {
				for (let w = l; w < t.getTokenStartLine(); w++) {
					const b = e.getText(q.create(Y.create(w, 0), Y.create(w + 1, 0))).length;
					o = o + b;
				}
			...
			switch (a) {
				case 10:
					if (u === void 0 || u === 1 || u === 5 && p[p.length - 1] === ie.Object) {
						const w = new Sn(t.getTokenValue(), m);
						s = i, i = r.addChildProperty(w);
					}
					break;
				case 3:
					if (n.beginningLineNumber === void 0 && (n.beginningLineNumber = t.getTokenStartLine()), p[p.length - 1] === ie.Object) r = i;
						...
						const w = new Sn(t.getTokenValue(), m);
						w.noKeyName = !0, s = i, i = r.addChildProperty(w), r = i;
					}
				...
				case 1:
					if (n.beginningLineNumber === void 0) n.beginningLineNumber = t.getTokenStartLine();
						...
						const w = new Sn(t.getTokenValue(), m);
						w.noKeyName = !0, s = i, i = r.addChildProperty(w);
					}
				...
				case 5:
					...
					break;
				case 13:
					u === 5 && f === t.getTokenStartLine() && (p[p.length - 1] === ie.Array && (h === 2 || h === 4) || p[p.length - 1] === ie.Object) && (p[p.length - 1] === ie.Array && (h === 2 || h === 4) || p[p.length - 1] === ie.Object) && (i.endLineNumber = void 0, v = !0), (u === 1 || u === 3) && f === t.getTokenStartLine() && (L = !0);
					break;
			}
...
//# sourceMappingURL=json.worker-qcFW0tBA.js.map