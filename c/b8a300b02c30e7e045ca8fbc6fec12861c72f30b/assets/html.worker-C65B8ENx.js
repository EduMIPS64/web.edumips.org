...
` + e.stack) : e;
	...
	var Ji = class extends Error {
		constructor() {
			super(nl), this.name = this.message;
		}
	...
	}, se = class Wo extends Error {
		constructor(t) {
			super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, Wo.prototype);
		}
	};
	function il(e, t = "Unreachable") {
		throw new Error(t);
	}
	function rl(e, t = "unexpected state") {
	...
	(function(e) {
		...
		e.from = a;
		function* o(p) {
			for (let v = p.length - 1; v >= 0; v--) yield p[v];
		}
		e.reverse = o;
		function l(p) {
		...
		function u(p, v) {
			let C = 0;
			for (const z of p) if (v(z, C++)) return !0;
			return !1;
		}
		e.some = u;
		function d(p, v) {
			let C = 0;
			for (const z of p) if (!v(z, C++)) return !1;
			return !0;
		}
		e.every = d;
		function m(p, v) {
			for (const C of p) if (v(C)) return C;
		}
		e.find = m;
		function* f(p, v) {
			for (const C of p) v(C) && (yield C);
		}
		e.filter = f;
		function* b(p, v) {
			let C = 0;
			for (const z of p) yield v(z, C++);
		}
		e.map = b;
		function* g(p, v) {
			let C = 0;
		...
		e.flatMap = g;
		function* y(...p) {
			for (const v of p) al(v) ? yield* v : yield v;
		}
		e.concat = y;
		function T(p, v, C) {
			let z = C;
			for (const S of p) z = v(z, S);
			return z;
		}
		e.reduce = T;
		function k(p) {
		...
		e.length = k;
		function* A(p, v, C = p.length) {
			for (v < -p.length && (v = 0), v < 0 && (v += p.length), C < 0 ? C += p.length : C > p.length && (C = p.length); v < C; v++) yield p[v];
		}
		e.slice = A;
		function H(p, v = Number.POSITIVE_INFINITY) {
			const C = [];
			if (v === 0) return [C, p];
			const z = p[Symbol.iterator]();
			for (let S = 0; S < v; S++) {
				const N = z.next();
				if (N.done) return [C, e.empty()];
				C.push(N.value);
			}
		...
		async function q(p) {
			const v = [];
			for await (const C of p) v.push(C);
			return v;
		}
		e.asyncToArray = q;
		async function w(p) {
			let v = [];
			for await (const C of p) v = v.concat(C);
			return v;
		}
	...
	var An = class qo {
		...
		add(t) {
			...
			return this._isDisposed ? qo.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
		}
		delete(t) {
			if (t) {
	...
	const ul = Zi() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
	function Ki(e, t) {
		let n;
		...
		}), ul && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
	}
	function F(e, t, ...n) {
		return Ki(typeof e == "number" ? dl(e, t) : t, n);
	}
	function dl(e, t) {
		const n = hl()?.[e];
		if (typeof n != "string") {
	...
	const fl = typeof ue?.versions?.electron == "string" && ue?.type === "renderer";
	if (typeof ue == "object") {
		...
		er = !0;
	} else typeof navigator == "object" && !fl ? (Re = navigator.userAgent, Wt = Re.indexOf("Windows") >= 0, qt = Re.indexOf("Macintosh") >= 0, (Re.indexOf("Macintosh") >= 0 || Re.indexOf("iPad") >= 0 || Re.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, Ot = Re.indexOf("Linux") >= 0, Re?.indexOf("Mobi"), Rn = !0, Zi(), navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
	const wt = Wt, gl = qt, bl = er, wl = Rn, vl = Rn && typeof Ee.importScripts == "function" ? Ee.origin : void 0, Le = Re, _l = typeof Ee.postMessage == "function" && !Ee.importScripts;
	(() => {
		if (_l) {
			const e = [];
	...
	const Tl = !!(Le && Le.indexOf("Chrome") >= 0);
	Le && Le.indexOf("Firefox");
	!Tl && Le && Le.indexOf("Safari");
	Le && Le.indexOf("Edg/");
	...
	if (typeof Mn < "u" && typeof Mn.process < "u") {
		...
		get platform() {
			return wt ? "win32" : gl ? "darwin" : "linux";
		},
		get arch() {},
		get env() {
			return {};
	...
	const Ft = Je.cwd, tr = Je.env, kl = Je.platform, Sl = globalThis.performance.now.bind(globalThis.performance);
	var nr = class Oo {
		static create(t) {
			return new Oo(t);
		}
	...
	(function(e) {
		e.None = () => bt.None;
		function t(E, _, R) {
			return m(E, () => {}, 0, void 0, _ ?? !0, void 0, R);
		}
		e.defer = t;
		function n(E) {
			return (_, R = null, M) => {
				let I = !1, P;
				return P = E((D) => {
					if (!I) return P ? P.dispose() : I = !0, _.call(R, D);
				}, null, M), I && P.dispose(), P;
			};
		}
		e.once = n;
		function r(E, _) {
			return e.once(e.filter(E, _));
		}
		e.onceIf = r;
		function i(E, _, R) {
			return u((M, I = null, P) => E((D) => M.call(I, _(D)), null, P), R);
		}
		e.map = i;
		function s(E, _, R) {
			return u((M, I = null, P) => E((D) => {
				_(D), M.call(I, D);
			}, null, P), R);
		}
		e.forEach = s;
		function a(E, _, R) {
			return u((M, I = null, P) => E((D) => _(D) && M.call(I, D), null, P), R);
		}
		e.filter = a;
		function o(E) {
			return E;
		...
		e.signal = o;
		function l(...E) {
			return (_, R = null, M) => d(ol(...E.map((I) => I((P) => _.call(R, P)))), M);
		}
		e.any = l;
		function c(E, _, R, M) {
			let I = R;
			return i(E, (P) => (I = _(I, P), I), M);
		}
		e.reduce = c;
		function u(E, _) {
			let R;
			...
			return _?.add(M), M.event;
		}
		function d(E, _) {
			return _ instanceof Array ? _.push(E) : _ && _.add(E), E;
		}
		function m(E, _, R = 100, M = !1, I = !1, P, D) {
			let W, B, Q, Z = 0, te;
			const ut = new _e({
				leakWarningThreshold: P,
				onWillAddFirstListener() {
					W = E((Ed) => {
						Z++, B = _(B, Ed), M && !Q && (ut.fire(B), B = void 0), te = () => {
							const Nd = B;
							B = void 0, Q = void 0, (!M || Z > 1) && ut.fire(Nd), Z = 0;
						}, typeof R == "number" ? (Q && clearTimeout(Q), Q = setTimeout(te, R)) : Q === void 0 && (Q = null, queueMicrotask(te));
					});
				},
		...
		e.debounce = m;
		function f(E, _ = 0, R, M) {
			return e.debounce(E, (I, P) => I ? (I.push(P), I) : [P], _, void 0, R ?? !0, void 0, M);
		}
		e.accumulate = f;
		function b(E, _, R = 100, M = !0, I = !0, P, D) {
			let W, B, Q, Z = 0;
			const te = new _e({
				leakWarningThreshold: P,
				onWillAddFirstListener() {
					W = E((ut) => {
						Z++, B = _(B, ut), Q === void 0 && (M && (te.fire(B), B = void 0, Z = 0), typeof R == "number" ? Q = setTimeout(() => {
							I && Z > 0 && te.fire(B), B = void 0, Q = void 0, Z = 0;
						}, R) : (Q = 0, queueMicrotask(() => {
							I && Z > 0 && te.fire(B), B = void 0, Q = void 0, Z = 0;
						})));
					});
				},
		...
		e.latch = g;
		function y(E, _, R) {
			return [e.filter(E, _, R), e.filter(E, (M) => !_(M), R)];
		}
		e.split = y;
		function T(E, _, R = !1, M = [], I) {
			let P = M.slice(), D;
			rr() && (D = {
				stack: sr.create(),
				timerId: setTimeout(() => {
					P && P.length > 0 && D && !D.warned && (D.warned = !0, console.warn(`[Event.buffer][${_}] potential LEAK detected: ${P.length} events buffered for ${ir / 1e3}s without being consumed. Buffered here:`), D.stack.print());
				}, ir),
				warned: !1
			}, I && I.add(gt(() => clearTimeout(D.timerId))));
			const W = () => {
				D && clearTimeout(D.timerId);
			};
			let B = E((te) => {
				P ? (P.push(te), rr() && D && !D.warned && P.length >= Ll && (D.warned = !0, console.warn(`[Event.buffer][${_}] potential LEAK detected: ${P.length} events buffered without being consumed. Buffered here:`), D.stack.print())) : Z.fire(te);
			});
			I && I.add(B);
			const Q = () => {
				P?.forEach((te) => Z.fire(te)), P = null, W();
			}, Z = new _e({
				onWillAddFirstListener() {
					B || (B = E((te) => Z.fire(te)), I && I.add(B));
				},
		...
		class H {
			...
			filter(_) {
				return this.steps.push((R) => _(R) ? R : A), this;
			}
			reduce(_, R) {
				let M = R;
			...
			latch(_ = (R, M) => R === M) {
				...
				return this.steps.push((I) => {
					const P = R || !_(I, M);
					return R = !1, M = I, P ? I : A;
				}), this;
			}
			evaluate(_) {
				for (const R of this.steps) if (_ = R(_), _ === A) break;
				return _;
			}
		}
		function q(E, _, R = (M) => M) {
			const M = (...W) => D.fire(R(...W)), I = () => E.on(_, M), P = () => E.removeListener(_, M), D = new _e({
				onWillAddFirstListener: I,
				onDidRemoveLastListener: P
			});
			return D.event;
		}
		e.fromNodeEventEmitter = q;
		function w(E, _, R = (M) => M) {
			const M = (...W) => D.fire(R(...W)), I = () => E.addEventListener(_, M), P = () => E.removeEventListener(_, M), D = new _e({
				onWillAddFirstListener: I,
				onDidRemoveLastListener: P
			});
			return D.event;
		...
		function p(E, _) {
			...
			return I.cancel = R, _ && I.finally(() => or(M, _)), I;
		}
		e.toPromise = p;
		function v(E, _) {
			return E((R) => _.fire(R));
		...
		class z {
			constructor(_, R) {
				...
				this.emitter = new _e(M), R && R.add(this.emitter);
			}
			beginUpdate(_) {
				this._counter++;
			}
		...
		function S(E, _) {
			return new z(E, _).emitter.event;
		}
		e.fromObservable = S;
		function N(E) {
			return (_, R, M) => {
				...
				const D = {
					...
					endUpdate() {
						I--, I === 0 && (E.reportChanges(), P && (P = !1, _.call(R)));
					},
				...
				E.addObserver(D), E.reportChanges();
				const W = { dispose() {
					E.removeObserver(D);
				} };
				return zn(W, M), W;
	...
	var Rl = class Fo {
		...
		constructor(t, n, r = (Fo._idPool++).toString(16).padStart(3, "0")) {
		...
		check(t, n) {
			...
			if (this._stacks.set(t.value, i + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
				...
				const u = new ar(a / n > .3 ? "dominated" : "popular", l, s, n, o);
		...
		static create() {
			return new Bo((/* @__PURE__ */ new Error()).stack ?? "");
		}
		constructor(t) {
			this.value = t;
		}
...
`));
		...
		static is(t) {
			return t instanceof Vo || t instanceof Error && typeof t.kind == "string" && typeof t.listenerCount == "number";
		}
	}, El = class extends ar {
	...
	var _e = class {
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new Rl(e?.onListenerError ?? Dt, this._options?.leakWarningThreshold ?? Al, this._options?.leakWarningName) : void 0, this._perfMon = this._options?._profName ? new xl(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
		...
		get event() {
			return this._event ??= (e, t, n) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(a);
					const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new El(o[1] / this._size > .3 ? "dominated" : "popular", `${a}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0], this._size, this._options?.leakWarningName);
					return (this._options?.onListenerError || Dt)(c), bt.None;
				}
				if (this._disposed) return bt.None;
				t && (e = e.bind(t));
				const r = new In(e);
				let i;
				this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = sr.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof In ? (this._deliveryQueue ??= new Ml(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
				const s = gt(() => {
	...
	var Il = class {
		constructor(e, t) {
			this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = Cl) : (this._fn = t, this._computeKey = e.getCacheKey);
		}
		get(e) {
		...
		static {
			this.cache = new Il((t) => {
				...
				function r(u) {
					...
					for (let m = 0; m < u.length; m += 2) d.set(u[m], u[m + 1]);
					return d;
				}
				function i(u, d) {
					const m = new Map(u);
					for (const [f, b] of d) m.set(f, b);
					return m;
				}
				function s(u, d) {
					if (!u) return d;
					const m = /* @__PURE__ */ new Map();
					for (const [f, b] of u) d.has(f) && m.set(f, b);
					return m;
				}
				const a = this.ambiguousCharacterData.value;
				let o = n.filter((u) => !u.startsWith("_") && Object.hasOwn(a, u));
	...
	const On = "default", Bl = "$initialize";
	var Vl = class {
		constructor(e, t, n, r, i) {
		...
		async sendMessage(e, t, n) {
			...
			return new Promise((i, s) => {
				this._pendingReplies[r] = {
					resolve: i,
					reject: s
				}, this._send(new Vl(this._workerId, r, e, t, n));
			});
		}
		listen(e, t, n) {
			let r = null;
			const i = new _e({
				onWillAddFirstListener: () => {
					r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new jl(this._workerId, r, e, t, n));
				},
				onDidRemoveLastListener: () => {
		...
		_handleSubscribeEventMessage(e) {
			const t = e.req, n = this._handler.handleEvent(e.channel, e.eventName, e.arg)((r) => {
				this._send(new $l(this._workerId, t, r));
			});
	...
	var Yl = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new Xl({
				sendMessage: (n, r) => {
					e(n, r);
				},
		...
		_handleMessage(e, t, n) {
			if (e === On && t === Bl) return this.initialize(n[0]);
	...
	function Jl(e) {
		...
		mr = !0;
		const t = new Yl((n) => globalThis.postMessage(n), (n) => e(n));
	...
	const pr = typeof Buffer < "u";
	new Hn(() => /* @__PURE__ */ new Uint8Array(256));
	let Fn;
	var Ql = class jo {
		static wrap(t) {
			return pr && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new jo(t);
		}
		constructor(t) {
			this.buffer = t, this.byteLength = this.buffer.byteLength;
		}
		toString() {
			return pr ? this.buffer.toString() : (Fn || (Fn = new TextDecoder(void 0, { ignoreBOM: !0 })), Fn.decode(this.buffer));
		}
	};
	const fr = "0123456789abcdef";
	function Zl({ buffer: e }) {
		let t = "";
	...
	function vt(e, t = 32) {
		return e instanceof ArrayBuffer ? Zl(Ql.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
	}
	(class $o {
		static {
		...
		_step() {
			const t = $o._bigBlock32, n = this._buffDV;
	...
	function ec(e, t, n) {
		return new vr(new br(e), new br(t)).ComputeDiff(n).changes;
	}
	var Qe = class {
		static Assert(e, t) {
		...
		static _getElements(t) {
			...
			if (dt._isStringArray(n)) {
				...
				for (let i = 0, s = n.length; i < s; i++) r[i] = Kl(n[i], 0);
				return [
					n,
					r,
					!0
		...
		WALKTRACE(t, n, r, i, s, a, o, l, c, u, d, m, f, b, g, y, T, k) {
			let A = null, H = null, q = new wr(), w = n, p = r, v = f[0] - y[0] - i, C = -1073741824, z = this.m_forwardHistory.length - 1;
			do {
				const S = v + t;
				S === w || S < p && c[S - 1] < c[S + 1] ? (d = c[S + 1], b = d - v - i, d < C && q.MarkNextChange(), C = d, q.AddModifiedElement(d + 1, b), v = S + 1 - t) : (d = c[S - 1] + 1, b = d - v - i, d < C && q.MarkNextChange(), C = d - 1, q.AddOriginalElement(d, b + 1), v = S - 1 - t), z >= 0 && (c = this.m_forwardHistory[z], t = c[0], w = 1, p = c.length - 1);
			} while (--z >= -1);
			if (A = q.getReverseChanges(), k[0]) {
				let S = f[0] + 1, N = y[0] + 1;
				if (A !== null && A.length > 0) {
					const E = A[A.length - 1];
					S = Math.max(S, E.getOriginalEnd()), N = Math.max(N, E.getModifiedEnd());
				}
				H = [new De(S, m - S + 1, N, g - N + 1)];
			} else {
				q = new wr(), w = a, p = o, v = f[0] - y[0] - l, C = 1073741824, z = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const S = v + s;
					S === w || S < p && u[S - 1] >= u[S + 1] ? (d = u[S + 1] - 1, b = d - v - l, d > C && q.MarkNextChange(), C = d + 1, q.AddOriginalElement(d + 1, b + 1), v = S + 1 - s) : (d = u[S - 1], b = d - v - l, d > C && q.MarkNextChange(), C = d, q.AddModifiedElement(d + 1, b + 1), v = S - 1 - s), z >= 0 && (u = this.m_reverseHistory[z], s = u[0], w = 1, p = u.length - 1);
				} while (--z >= -1);
				H = q.getChanges();
			}
			return this.ConcatenateChanges(A, H);
		}
		ComputeRecursionPoint(t, n, r, i, s, a, o) {
			let l = 0, c = 0, u = 0, d = 0, m = 0, f = 0;
			t--, r--, s[0] = 0, a[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
			const b = n - t + (i - r), g = b + 1, y = new Int32Array(g), T = new Int32Array(g), k = i - r, A = n - t, H = t - r, q = n - i, w = (A - k) % 2 === 0;
			y[k] = t, T[A] = n, o[0] = !1;
			for (let p = 1; p <= b / 2 + 1; p++) {
				let v = 0, C = 0;
				u = this.ClipDiagonalBound(k - p, p, k, g), d = this.ClipDiagonalBound(k + p, p, k, g);
				for (let S = u; S <= d; S += 2) {
					S === u || S < d && y[S - 1] < y[S + 1] ? l = y[S + 1] : l = y[S - 1] + 1, c = l - (S - k) - H;
					const N = l;
					for (; l < n && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
					if (y[S] = l, l + c > v + C && (v = l, C = c), !w && Math.abs(S - A) <= p - 1 && l >= T[S]) return s[0] = l, a[0] = c, N <= T[S] && p <= 1448 ? this.WALKTRACE(k, u, d, H, A, m, f, q, y, T, l, n, s, c, i, a, w, o) : null;
				}
				const z = (v - t + (C - r) - p) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(v, z)) return o[0] = !0, s[0] = v, a[0] = C, z > 0 && p <= 1448 ? this.WALKTRACE(k, u, d, H, A, m, f, q, y, T, l, n, s, c, i, a, w, o) : (t++, r++, [new De(t, n - t + 1, r, i - r + 1)]);
				m = this.ClipDiagonalBound(A - p, p, A, g), f = this.ClipDiagonalBound(A + p, p, A, g);
				for (let S = m; S <= f; S += 2) {
					S === m || S < f && T[S - 1] >= T[S + 1] ? l = T[S + 1] - 1 : l = T[S - 1], c = l - (S - A) - q;
					const N = l;
					for (; l > t && c > r && this.ElementsAreEqual(l, c);) l--, c--;
					if (T[S] = l, w && Math.abs(S - k) <= p && l <= y[S]) return s[0] = l, a[0] = c, N >= y[S] && p <= 1448 ? this.WALKTRACE(k, u, d, H, A, m, f, q, y, T, l, n, s, c, i, a, w, o) : null;
				}
				if (p <= 1447) {
					let S = new Int32Array(d - u + 2);
					S[0] = k - u + 1, Ze.Copy2(y, u, S, 1, d - u + 1), this.m_forwardHistory.push(S), S = new Int32Array(f - m + 2), S[0] = A - m + 1, Ze.Copy2(T, m, S, 1, f - m + 1), this.m_reverseHistory.push(S);
				}
			}
			return this.WALKTRACE(k, u, d, H, A, m, f, q, y, T, l, n, s, c, i, a, w, o);
		}
		PrettifyChanges(t) {
			...
			for (let n = t.length - 1; n >= 0; n--) {
				...
				for (let d = 1;; d++) {
					const m = r.originalStart - d, f = r.modifiedStart - d;
					if (m < i || f < s || a && !this.OriginalElementsAreEqual(m, m + r.originalLength) || o && !this.ModifiedElementsAreEqual(f, f + r.modifiedLength)) break;
					const b = (m === i && f === s ? 5 : 0) + this._boundaryScore(m, r.originalLength, f, r.modifiedLength);
					b > c && (c = b, l = d);
				}
			...
			if (this._hasStrings) for (let n = 1, r = t.length; n < r; n++) {
				...
				if (a < 5 && c < 20 && m < 20) {
					const f = this._findBetterContiguousSequence(o, c, u, m, a);
					if (f) {
						const [b, g] = f;
	...
	var tc = class Go {
		constructor(t) {
			const n = _r(t);
			this._defaultValue = n, this._asciiMap = Go._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
		}
	...
	function sc() {
		if (_t === null) {
			_t = new tc(0);
			const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`;
			for (let n = 0; n < 36; n++) _t.set(e.charCodeAt(n), 1);
			const t = ".,;:";
			for (let n = 0; n < 4; n++) _t.set(t.charCodeAt(n), 2);
		}
		return _t;
	}
	var ac = class qi {
				...
				for (; c < l;) {
					...
					if (m === 13) {
						...
						switch (k) {
							...
							case 34:
							case 96:
								d === k ? A = 1 : d === 39 || d === 34 || d === 96 ? A = 0 : A = 1;
								break;
							case 42:
								A = d === 42 ? 1 : 0;
								break;
						...
						A === 1 && (i.push(qi._createLink(r, o, s, u, c)), T = !0);
					} else if (m === 12) {
						let A;
						k === 91 ? (b = !0, A = 0) : A = r.get(k), A === 1 ? T = !0 : m = 13;
					} else m = n.nextState(m, k), m === 0 && (T = !0);
					T && (m = 1, f = !1, b = !1, y = !1, u = c + 1, d = k), c++;
				}
	...
	function oc(e) {
		return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : ac.computeLinks(e);
	}
	var lc = class Xo {
		constructor() {
	...
	var jt = class {
		...
		get onCancellationRequested() {
			return this._isCancelled ? yr : (this._emitter || (this._emitter = new _e()), this._emitter.event);
		}
		dispose() {
	...
	const $t = new jn(), $n = new jn(), Gn = new jn(), hc = new Array(230), uc = Object.create(null), dc = Object.create(null), Tr = [];
	...
	(function() {
		...
		for (const i of t) {
			const [s, a, o, l, c, u, d, m, f] = i;
			if (r[a] || (r[a] = !0, uc[o] = a, dc[o.toLowerCase()] = a, s && (Tr[a] = l)), !n[l]) {
				if (n[l] = !0, !c) throw new Error(`String representation missing for key code ${l} around scan code ${o}`);
				$t.define(l, c), $n.define(l, m || c), Gn.define(l, f || m || c);
			}
			u && (hc[u] = l);
		}
	})();
	...
	const pc = 65, fc = 97, gc = 90, bc = 122, Be = 46, oe = 47, de = 92, Ne = 58, wc = 63;
	...
	function Lr(e, t) {
		vc(t, "pathObject");
		const n = t.dir || t.root, r = t.base || `${t.name || ""}${_c(t.ext)}`;
	...
	const ce = {
			...
			for (let i = e.length - 1; i >= -1; i--) {
				...
				if (a === 1) G(u) && (o = 1, c = !0);
					...
					if (d < a && d !== m) {
						...
						if (d < a && d !== m) {
							for (m = d; d < a && !G(s.charCodeAt(d));) d++;
							(d === a || d !== m) && (l = `\\\\${f}\\${s.slice(m, d)}`, o = d);
						}
					}
				} else o = 1;
				else Ce(u) && s.charCodeAt(1) === Ne && (l = s.slice(0, 2), o = 2, a > 2 && G(s.charCodeAt(2)) && (c = !0, o = 3));
		...
		normalize(e) {
			...
			else Ce(s) && e.charCodeAt(1) === Ne && (r = e.slice(0, 2), n = 2, t > 2 && G(e.charCodeAt(2)) && (i = !0, n = 3));
			let a = n < t ? Gt(e.slice(n), !i, "\\", G) : "";
			if (a.length === 0 && !i && (a = "."), a.length > 0 && G(e.charCodeAt(t - 1)) && (a += "\\"), !i && r === void 0 && e.includes(":")) {
				if (a.length >= 2 && Ce(a.charCodeAt(0)) && a.charCodeAt(1) === Ne) return `.\\${a}`;
				let o = e.indexOf(":");
				do
		...
		isAbsolute(e) {
			...
			return G(n) || t > 2 && Ce(n) && e.charCodeAt(1) === Ne && G(e.charCodeAt(2));
		},
		join(...e) {
		...
		relative(e, t) {
			...
			if (n.length !== e.length || r.length !== t.length) {
				...
				let A = 0;
				for (; A < k && b[A].toLowerCase() === g[A].toLowerCase(); A++);
				return A === 0 ? r : A === k ? T > k ? g.slice(A).join("\\") : y > k ? "..\\".repeat(y - 1 - A) + ".." : "" : "..\\".repeat(y - A) + g.slice(A).join("\\");
			}
			let i = 0;
			...
			let f = "";
			for (m = i + d + 1; m <= s; ++m) (m === s || e.charCodeAt(m) === de) && (f += f.length === 0 ? ".." : "\\..");
			return o += d, f.length > 0 ? `${f}${r.slice(o, l)}` : (r.charCodeAt(o) === de && ++o, r.slice(o, l));
		},
		toNamespacedPath(e) {
			...
			if (t.charCodeAt(0) === de) {
				if (t.charCodeAt(1) === de) {
					...
					if (n !== wc && n !== Be) return `\\\\?\\UNC\\${t.slice(2)}`;
				}
			} else if (Ce(t.charCodeAt(0)) && t.charCodeAt(1) === Ne && t.charCodeAt(2) === de) return `\\\\?\\${t}`;
			return t;
		},
		dirname(e) {
			ne(e, "path");
			...
			} else Ce(i) && e.charCodeAt(1) === Ne && (n = t > 2 && G(e.charCodeAt(2)) ? 3 : 2, r = n);
			let s = -1, a = !0;
		...
		basename(e, t) {
			...
			let n = 0, r = -1, i = !0, s;
			if (e.length >= 2 && Ce(e.charCodeAt(0)) && e.charCodeAt(1) === Ne && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
				if (t === e) return "";
		...
		extname(e) {
			...
			e.length >= 2 && e.charCodeAt(1) === Ne && Ce(e.charCodeAt(0)) && (t = r = 2);
		...
		parse(e) {
			...
			} else if (Ce(i) && e.charCodeAt(1) === Ne) {
	...
	Me ? ce.normalize : he.normalize;
	const Tc = Me ? ce.join : he.join;
	Me ? ce.resolve : he.resolve;
	Me ? ce.relative : he.relative;
	Me ? ce.dirname : he.dirname;
	Me ? ce.basename : he.basename;
	Me ? ce.extname : he.extname;
	Me ? ce.sep : he.sep;
	const kc = /^\w[\w\d+.-]*$/, Sc = /^\//, Lc = /^\/\//;
	function xc(e, t) {
		...
		if (e.path) {
			if (e.authority) {
				if (!Sc.test(e.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
			} else if (Lc.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
		}
	}
	function Ac(e, t) {
		return !e && !t ? "file" : e;
	...
	function Rc(e, t) {
		switch (e) {
			case "https":
			case "http":
			case "file": t ? t[0] !== ye && (t = ye + t) : t = ye;
		}
		return t;
	}
	const K = "", ye = "/", Ec = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
	var Ie = class vn {
		...
		constructor(t, n, r, i, s, a = !1) {
			typeof t == "object" ? (this.scheme = t.scheme || K, this.authority = t.authority || K, this.path = t.path || K, this.query = t.query || K, this.fragment = t.fragment || K) : (this.scheme = Ac(t, a), this.authority = n || K, this.path = Rc(this.scheme, r || K), this.query = i || K, this.fragment = s || K, xc(this, a));
		}
		get fsPath() {
			return Yn(this, !1);
		}
		...
		static joinPath(t, ...n) {
			...
			let r;
			return wt && t.scheme === "file" ? r = vn.file(ce.join(Yn(t, !0), ...n)).path : r = he.join(t.path, ...n), t.with({ path: r });
		}
		toString(t = !1) {
			return Jn(this, t);
		}
	...
	function Xt(e) {
		return e.match(Nr) ? e.replace(Nr, (t) => Er(t)) : e;
	}
	var Mc = class ve extends V {
		constructor(t, n, r, i) {
	...
	var zc = class {
		constructor() {
			this._tokenizationSupports = /* @__PURE__ */ new Map(), this._factories = /* @__PURE__ */ new Map(), this._onDidChange = new _e(), this.onDidChange = this._onDidChange.event, this._colorMap = null;
		}
		handleChange(e) {
	...
	(class It {
		...
		set(t, n) {
			return this.map.set(this.toKey(t), new Wc(t, n)), this;
		}
		get(t) {
	...
	function Xc(e, t, n, r, i) {
		return $c(e, t, n, r, i) && Gc(e, t, n, r, i);
	}
	var Yc = class {
		constructor(e, t) {
		...
		next(e) {
			...
			do {
				...
				if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
					if (i === 0) {
						Wl(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
						continue;
					}
					return null;
				}
				if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || Xc(this._wordSeparators, e, t, r, i)) return n;
			} while (n);
			return null;
		}
	};
	...
	function Qc(e = "") {
		let t = "(-?\\d*\\.\\d\\w*)|([^";
		for (const n of Jc) e.indexOf(n) >= 0 || (t += "\\" + n);
	...
	var Kc = class {
		static computeUnicodeHighlights(e, t, n) {
			...
			let o;
			a === "allNonBasicAscii" ? o = /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${eh(Array.from(a))}`, "g");
			const l = new Yc(null, o), c = [];
			let u = !1, d, m = 0, f = 0, b = 0;
			e: for (let g = r, y = i; g <= y; g++) {
				const T = e.getLineContent(g), k = T.length;
				l.reset(0);
				do
					if (d = l.next(T), d) {
						let A = d.index, H = d.index + d[0].length;
						if (A > 0) Bt(T.charCodeAt(A - 1)) && A--;
						if (H + 1 < k) Bt(T.charCodeAt(H - 1)) && H++;
						const q = T.substring(A, H);
						let w = ti(A + 1, Bs, T, 0);
						w && w.endColumn <= A + 1 && (w = null);
						const p = s.shouldHighlightNonBasicASCII(q, w ? w.word : null);
						if (p !== 0) {
							if (p === 3 ? m++ : p === 2 ? f++ : p === 1 ? b++ : il(), c.length >= 1e3) {
								u = !0;
								break e;
							}
							c.push(new V(g, A + 1, g, H + 1));
						}
					}
				while (d);
			}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = Wn.getLocales().filter((a) => !Wn.getInstance(/* @__PURE__ */ new Set([...t.allowedLocales, a])).isAmbiguous(r));
					return {
						kind: 0,
	...
	function eh(e, t) {
		return `[${zl(e.map((n) => String.fromCodePoint(n)).join(""))}]`;
	}
	var $s = class {
		constructor(e) {
		...
		shouldHighlightNonBasicASCII(e, t) {
			...
			if (t) for (const s of t) {
				const a = s.codePointAt(0), o = Ol(s);
...
` || e === "	";
	...
	(class _n {
		...
		filter(t) {
			return new _n((n) => this.iterate((r) => t(r) ? n(r) : !0));
		}
		map(t) {
			return new _n((n) => this.iterate((r) => n(t(r))));
		}
		findLast(t) {
			let n;
	...
	var $ = class fe {
		...
		withMargin(t, n) {
			return n === void 0 && (n = t), new fe(this.start - t, this.endExclusive + n);
		}
	};
	function nt(e, t) {
		const n = it(e, t);
...
` && (this._lineStartOffsetByLineIdx.push(e + 1), e > 0 && this.text.charAt(e - 1) === "\r" ? this._lineEndOffsetByLineIdx.push(e - 1) : this._lineEndOffsetByLineIdx.push(e));
		...
		getPosition(e) {
			const t = it(this.lineStartOffsetByLineIdx, (i) => i <= e);
		...
		constructor(e, t) {
			rl(t >= 1), super(), this._getLineContent = e, this._lineCount = t;
		}
		getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), t;
		...
		static fromStringEdit(t, n) {
			const r = t.replacements.map((i) => Zt.fromStringReplacement(i, n));
			return new Oi(r);
		}
		static fromParallelReplacementsUnsorted(t) {
			const n = t.slice().sort(tt((r) => r.range, V.compareRangesUsingStarts));
			return new Oi(n);
		}
		constructor(t) {
			this.replacements = t, ft(() => xn(t, (n, r) => n.range.getEndPosition().isBeforeOrEqual(r.range.getStartPosition())));
		}
		mapPosition(t) {
			let n = 0, r = 0, i = 0;
...
`, `
`), i = Un(n, r), s = rt.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i), o = V.fromPositions(s, this.range.getEndPosition());
			return new Ye(o, a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = Dn(n, r), s = rt.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i), o = V.fromPositions(this.range.getStartPosition(), s);
			return new Ye(o, a);
		}
		toString() {
	...
	var Ve = class pt {
		static inverse(t, n, r) {
			...
			let s = 1, a = 1;
			for (const l of t) {
				const c = new pt(new Y(s, l.original.startLineNumber), new Y(a, l.modified.startLineNumber));
				c.modified.isEmpty || i.push(c), s = l.original.endLineNumberExclusive, a = l.modified.endLineNumberExclusive;
			}
			const o = new pt(new Y(s, n + 1), new Y(a, r + 1));
		...
		static clip(t, n, r) {
			...
			for (const s of t) {
				...
				a && !a.isEmpty && o && !o.isEmpty && i.push(new pt(a, o));
			}
			return i;
		}
		constructor(t, n) {
	...
	var St = class yn extends Ve {
		static fromRangeMappings(t) {
			const n = Y.join(t.map((i) => Y.fromRangeInclusive(i.originalRange))), r = Y.join(t.map((i) => Y.fromRangeInclusive(i.modifiedRange)));
			return new yn(n, r, t);
		}
		constructor(t, n, r) {
	...
	function ri(e, t, n, r = !1) {
		const i = [];
		for (const s of nh(e.map((a) => dh(a, t, n)), (a, o) => a.original.intersectsOrTouches(o.original) || a.modified.intersectsOrTouches(o.modified))) {
			const a = s[0], o = s[s.length - 1];
			i.push(new St(a.original.join(o.original), a.modified.join(o.modified), s.map((l) => l.innerChanges[0])));
		}
		return ft(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length.lineCount - i[i.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - i[i.length - 1].original.endLineNumberExclusive) ? !1 : xn(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), i;
	}
	function dh(e, t, n) {
		let r = 0, i = 0;
		...
		return new St(new Y(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), new Y(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i), [e]);
	}
	const mh = 3;
	var ph = class {
		computeDiff(e, t, n) {
			...
			return ft(() => xn(i, (a, o) => o.original.startLineNumber - a.original.endLineNumberExclusive === o.modified.startLineNumber - a.modified.endLineNumberExclusive && a.original.endLineNumberExclusive < o.original.startLineNumber && a.modified.endLineNumberExclusive < o.modified.startLineNumber)), new yt(i, [], r.quitEarly);
		}
	};
	function Ks(e, t, n, r) {
		return new vr(e, t, n).ComputeDiff(r);
	}
	var ea = class {
		constructor(e) {
			const t = [], n = [];
		...
		static createFromDiffChange(t, n, r) {
			const i = n.getStartLineNumber(t.originalStart), s = n.getStartColumn(t.originalStart), a = n.getEndLineNumber(t.originalStart + t.originalLength - 1), o = n.getEndColumn(t.originalStart + t.originalLength - 1), l = r.getStartLineNumber(t.modifiedStart), c = r.getStartColumn(t.modifiedStart), u = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1), d = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1);
			return new Jo(i, s, a, o, l, c, u, d);
		}
	};
	function gh(e) {
		...
		for (let r = 1, i = e.length; r < i; r++) {
			...
			Math.min(a, o) < mh ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
		}
		return t;
	}
	var si = class Qo {
		...
		static createFromDiffResult(t, n, r, i, s, a, o) {
			...
			if (n.originalLength === 0 ? (l = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (l = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (u = i.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (u = i.getStartLineNumber(n.modifiedStart), d = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
				const f = r.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), b = i.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
				if (f.getElements().length > 0 && b.getElements().length > 0) {
					let g = Ks(f, b, s, !0).changes;
					o && (g = gh(g)), m = [];
					for (let y = 0, T = g.length; y < T; y++) m.push(en.createFromDiffChange(g[y], f, b));
				}
			}
			return new Qo(l, c, u, d, m);
		}
	}, bh = class {
		constructor(e, t, n) {
		...
		computeDiff() {
			...
			for (let a = -1, o = t.length; a < o; a++) {
				...
				for (; i < c && s < u;) {
					...
					if (d !== m) {
						{
							let f = ai(d, 1), b = ai(m, 1);
							for (; f > 1 && b > 1 && d.charCodeAt(f - 2) === m.charCodeAt(b - 2);) f--, b--;
							(f > 1 || b > 1) && this._pushTrimWhitespaceCharChange(r, i + 1, 1, f, s + 1, 1, b);
						}
						{
							let f = oi(d, 1), b = oi(m, 1);
							const g = d.length + 1, y = m.length + 1;
							for (; f < g && b < y && d.charCodeAt(f - 1) === d.charCodeAt(b - 1);) f++, b++;
							(f < g || b < y) && this._pushTrimWhitespaceCharChange(r, i + 1, f, g, s + 1, b, y);
						}
					}
					i++, s++;
				}
...
`);
		...
		compute(e, t, n = li.instance, r) {
			...
			for (let f = 0; f < e.length; f++) for (let b = 0; b < t.length; b++) {
				...
				const g = f === 0 ? 0 : i.get(f - 1, b), y = b === 0 ? 0 : i.get(f, b - 1);
				let T;
				e.getElement(f) === t.getElement(b) ? (f === 0 || b === 0 ? T = 0 : T = i.get(f - 1, b - 1), f > 0 && b > 0 && s.get(f - 1, b - 1) === 3 && (T += a.get(f - 1, b - 1)), T += r ? r(f, b) : 1) : T = -1;
				const k = Math.max(g, y, T);
				if (k === T) {
					const A = f > 0 && b > 0 ? a.get(f - 1, b - 1) : 0;
					a.set(f, b, A + 1), s.set(f, b, 3);
				} else k === g ? (a.set(f, b, 0), s.set(f, b, 1)) : k === y && (a.set(f, b, 0), s.set(f, b, 2));
				i.set(f, b, k);
			}
			const o = [];
			let l = e.length, c = t.length;
			function u(f, b) {
				(f + 1 !== l || b + 1 !== c) && o.push(new me(new $(f + 1, l), new $(b + 1, c))), l = f, c = b;
			}
		...
		compute(e, t, n = li.instance) {
			...
			e: for (;;) {
				...
				for (c = b; c <= g; c += 2) {
					const y = c === g ? -1 : o.get(c + 1), T = c === b ? -1 : o.get(c - 1) + 1, k = Math.min(Math.max(y, T), r.length), A = k - c;
					if (k > r.length || A > i.length) continue;
					const H = s(k, A);
					o.set(c, H);
					const q = k === y ? l.get(c + 1) : l.get(c - 1);
					if (l.set(c, H !== k ? new ra(q, k, A, H - k) : q), o.get(c) === r.length && o.get(c) - c === i.length) break e;
				}
			}
			let u = l.get(c);
			const d = [];
			let m = r.length, f = i.length;
			for (;;) {
				const b = u ? u.x + u.length : 0, g = u ? u.y + u.length : 0;
				if ((b !== m || g !== f) && d.push(new me(new $(b, m), new $(g, f))), !u) break;
				m = u.x, f = u.y, u = u.prev;
			}
		...
		extendToFullLines(e) {
			return new $(nt(this.firstElementOffsetByLineIdx, (r) => r <= e.start) ?? 0, oh(this.firstElementOffsetByLineIdx, (r) => e.endExclusive <= r) ?? this.elements.length);
		}
	};
	function ot(e) {
	...
	function kh(e, t, n, r, i, s) {
		let { moves: a, excludedChanges: o } = Lh(e, t, n, s);
		if (!s.isValid()) return [];
		const l = xh(e.filter((c) => !o.has(c)), r, i, t, n, s);
		return sh(a, l), a = Ah(a), a = a.filter((c) => {
			const u = c.original.toOffsetRange().slice(t).map((d) => d.trim());
			return u.join(`
`).length >= 15 && Sh(u, (d) => d.length >= 2) >= 2;
		}), a = Rh(e, a), a;
	}
	function Sh(e, t) {
		let n = 0;
	...
	function xh(e, t, n, r, i, s) {
		const a = [], o = new Vc();
		for (const m of e) for (let f = m.original.startLineNumber; f < m.original.endLineNumberExclusive - 2; f++) {
			const b = `${t[f - 1]}:${t[f + 1 - 1]}:${t[f + 2 - 1]}`;
			o.add(b, { range: new Y(f, f + 3) });
		}
		const l = [];
		...
		for (const m of e) {
			...
			for (let b = m.modified.startLineNumber; b < m.modified.endLineNumberExclusive - 2; b++) {
				...
				o.forEach(g, ({ range: k }) => {
					for (const H of f) if (H.originalLineRange.endLineNumberExclusive + 1 === k.endLineNumberExclusive && H.modifiedLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive) {
						H.originalLineRange = new Y(H.originalLineRange.startLineNumber, k.endLineNumberExclusive), H.modifiedLineRange = new Y(H.modifiedLineRange.startLineNumber, y.endLineNumberExclusive), T.push(H);
						return;
					}
					const A = {
						modifiedLineRange: y,
		...
		l.sort(ah(tt((m) => m.modifiedLineRange.length, Tt)));
		const c = new Yt(), u = new Yt();
		for (const m of l) {
			const f = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber, b = c.subtractFrom(m.modifiedLineRange), g = u.subtractFrom(m.originalLineRange).getWithDelta(f), y = b.getIntersection(g);
			for (const T of y.ranges) {
				if (T.length < 3) continue;
				const k = T, A = T.delta(-f);
				a.push(new Ve(A, k)), c.addRange(k), u.addRange(A);
			}
		}
		a.sort(tt((m) => m.original.startLineNumber, Tt));
		const d = new Ys(e);
		for (let m = 0; m < a.length; m++) {
			const f = a[m], b = d.findLastMonotonous((w) => w.original.startLineNumber <= f.original.startLineNumber), g = nt(e, (w) => w.modified.startLineNumber <= f.modified.startLineNumber), y = Math.max(f.original.startLineNumber - b.original.startLineNumber, f.modified.startLineNumber - g.modified.startLineNumber), T = d.findLastMonotonous((w) => w.original.startLineNumber < f.original.endLineNumberExclusive), k = nt(e, (w) => w.modified.startLineNumber < f.modified.endLineNumberExclusive), A = Math.max(T.original.endLineNumberExclusive - f.original.endLineNumberExclusive, k.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
			let H = 0;
			for (; H < y; H++) {
				const w = f.original.startLineNumber - H - 1, p = f.modified.startLineNumber - H - 1;
				if (w > r.length || p > i.length || c.contains(p) || u.contains(w) || !la(r[w - 1], i[p - 1], s)) break;
			}
			H > 0 && (u.addRange(new Y(f.original.startLineNumber - H, f.original.startLineNumber)), c.addRange(new Y(f.modified.startLineNumber - H, f.modified.startLineNumber)));
			let q = 0;
			for (; q < A; q++) {
				const w = f.original.endLineNumberExclusive + q, p = f.modified.endLineNumberExclusive + q;
				if (w > r.length || p > i.length || c.contains(p) || u.contains(w) || !la(r[w - 1], i[p - 1], s)) break;
			}
			q > 0 && (u.addRange(new Y(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + q)), c.addRange(new Y(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + q))), (H > 0 || q > 0) && (a[m] = new Ve(new Y(f.original.startLineNumber - H, f.original.endLineNumberExclusive + q), new Y(f.modified.startLineNumber - H, f.modified.endLineNumberExclusive + q)));
		}
		return a;
	}
	function la(e, t, n) {
	...
	function ca(e, t, n) {
		let r = n;
		return r = ha(e, t, r), r = ha(e, t, r), r = Eh(e, t, r), r;
	}
	function ha(e, t, n) {
		...
		for (let s = 1; s < n.length; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				let c = 1;
				for (; c <= l && !(e.getElement(o.seq1Range.start - c) !== e.getElement(o.seq1Range.endExclusive - c) || t.getElement(o.seq2Range.start - c) !== t.getElement(o.seq2Range.endExclusive - c)); c++);
				if (c--, c === l) {
		...
		for (let s = 0; s < r.length - 1; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				let c = 0;
				for (; c < l && !(!e.isStronglyEqual(o.seq1Range.start + c, o.seq1Range.endExclusive + c) || !t.isStronglyEqual(o.seq2Range.start + c, o.seq2Range.endExclusive + c)); c++);
				if (c === l) {
	...
	function ua(e, t, n, r, i) {
		...
		let l = 0, c = -1;
		for (let u = -a; u <= o; u++) {
			const d = e.seq2Range.start + u, m = e.seq2Range.endExclusive + u, f = e.seq1Range.start + u, b = t.getBoundaryScore(f) + n.getBoundaryScore(d) + n.getBoundaryScore(m);
			b > c && (c = b, l = u);
		}
		return e.delta(l);
	}
	...
	function da(e, t, n, r, i = !1) {
		...
		function l(c, u) {
			...
			if (!d || !m) return;
			let f = new me(d, m);
			const b = f.intersect(u);
			let g = b.seq1Range.length, y = b.seq2Range.length;
			for (; s.length > 0;) {
				const T = s[0];
				if (!(T.seq1Range.intersects(f.seq1Range) || T.seq2Range.intersects(f.seq2Range))) break;
				const H = new me(r(e, T.seq1Range.start), r(t, T.seq2Range.start)), q = H.intersect(T);
				if (g += q.seq1Range.length, y += q.seq2Range.length, f = f.join(H), f.seq1Range.endExclusive >= T.seq1Range.endExclusive) s.shift();
				else break;
			}
			(i && g + y < f.seq1Range.length + f.seq2Range.length || g + y < (f.seq1Range.length + f.seq2Range.length) * 2 / 3) && a.push(f), o = f.getEndExclusives();
		}
		for (; s.length > 0;) {
			const c = s.shift();
		...
		do {
			...
			for (let l = 1; l < r.length; l++) {
				let d = function(m, f) {
					...
					return e.getText(b).replace(/\s/g, "").length <= 4 && (m.seq1Range.length + m.seq2Range.length > 5 || f.seq1Range.length + f.seq2Range.length > 5);
				};
	...
	function Ih(e, t, n) {
		...
		do {
			...
			for (let c = 1; c < r.length; c++) {
				let m = function(f, b) {
					...
					const T = e.countLinesIn(f.seq1Range), k = f.seq1Range.length, A = t.countLinesIn(f.seq2Range), H = f.seq2Range.length, q = e.countLinesIn(b.seq1Range), w = b.seq1Range.length, p = t.countLinesIn(b.seq2Range), v = b.seq2Range.length, C = 130;
					function z(S) {
						return Math.min(S, C);
					}
					return Math.pow(Math.pow(z(T * 40 + k), 1.5) + Math.pow(z(A * 40 + H), 1.5), 1.5) + Math.pow(Math.pow(z(q * 40 + w), 1.5) + Math.pow(z(p * 40 + v), 1.5), 1.5) > (C ** 1.5) ** 1.5 * 1.3;
				};
		...
		return rh(r, (l, c, u) => {
			...
			const g = e.getText(new $(c.seq1Range.endExclusive, f.endExclusive));
	...
	var ma = class {
		...
		getBoundaryScore(e) {
			return 1e3 - ((e === 0 ? 0 : pa(this.lines[e - 1])) + (e === this.lines.length ? 0 : pa(this.lines[e])));
		}
		getText(e) {
...
`);
	...
	var zh = class {
		...
		computeDiff(e, t, n) {
			if (e.length <= 1 && th(e, t, (w, p) => w === p)) return new yt([], [], !1);
			...
			const r = n.maxComputationTimeMs === 0 ? li.instance : new wh(n.maxComputationTimeMs), i = !n.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
			function a(w) {
				let p = s.get(w);
				return p === void 0 && (p = s.size, s.set(w, p)), p;
			}
			const o = e.map((w) => a(w.trim())), l = t.map((w) => a(w.trim())), c = new ma(o, e), u = new ma(l, t), d = c.length + u.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, u, r, (w, p) => e[w] === t[p] ? t[p].length === 0 ? .1 : 1 + Math.log(1 + t[p].length) : .99) : this.myersDiffingAlgorithm.compute(c, u, r);
			let m = d.diffs, f = d.hitTimeout;
			m = ca(c, u, m), m = Ch(c, u, m);
			const b = [], g = (w) => {
				if (i) for (let p = 0; p < w; p++) {
					const v = y + p, C = T + p;
					if (e[v] !== t[C]) {
						const z = this.refineDiff(e, t, new me(new $(v, v + 1), new $(C, C + 1)), r, i, n);
						for (const S of z.mappings) b.push(S);
						z.hitTimeout && (f = !0);
					}
				}
			};
			let y = 0, T = 0;
			for (const w of m) {
				ft(() => w.seq1Range.start - y === w.seq2Range.start - T), g(w.seq1Range.start - y), y = w.seq1Range.endExclusive, T = w.seq2Range.endExclusive;
				const p = this.refineDiff(e, t, w, r, i, n);
				p.hitTimeout && (f = !0);
				for (const v of p.mappings) b.push(v);
			}
			g(e.length - y);
			const H = ri(b, new Jt(e), new Jt(t));
			let q = [];
			return n.computeMoves && (q = this.computeMoves(H, e, t, o, l, r, i, n)), ft(() => {
				function w(v, C) {
					if (v.lineNumber < 1 || v.lineNumber > C.length) return !1;
					const z = C[v.lineNumber - 1];
					return !(v.column < 1 || v.column > z.length + 1);
				}
				function p(v, C) {
					return !(v.startLineNumber < 1 || v.startLineNumber > C.length + 1 || v.endLineNumberExclusive < 1 || v.endLineNumberExclusive > C.length + 1);
				}
				for (const v of H) {
					if (!v.innerChanges) return !1;
					for (const C of v.innerChanges) if (!(w(C.modifiedRange.getStartPosition(), t) && w(C.modifiedRange.getEndPosition(), t) && w(C.originalRange.getStartPosition(), e) && w(C.originalRange.getEndPosition(), e))) return !1;
					if (!p(v.modified, t) || !p(v.original, e)) return !1;
				}
				return !0;
			}), new yt(H, q, f);
		}
		computeMoves(e, t, n, r, i, s, a, o) {
			return kh(e, t, n, r, i, s).map((l) => {
				return new Xs(l, ri(this.refineDiff(t, n, new me(l.original.toOffsetRange(), l.modified.toOffsetRange()), s, a, o).mappings, new Jt(t), new Jt(n), !0));
			});
		}
		refineDiff(e, t, n, r, i, s) {
			const a = Hh(n).toRangeMapping2(e, t), o = new tn(e, a.originalRange, i), l = new tn(t, a.modifiedRange, i), c = o.length + l.length < 500 ? this.dynamicProgrammingDiffing.compute(o, l, r) : this.myersDiffingAlgorithm.compute(o, l, r);
			let u = c.diffs;
			return u = ca(o, l, u), u = da(o, l, u, (d, m) => d.findWordContaining(m)), s.extendToSubwords && (u = da(o, l, u, (d, m) => d.findSubWordContaining(m), !0)), u = Nh(o, l, u), u = Ih(o, l, u), {
	...
	var Uh = class {
		...
		rewrite(e) {
			...
			return typeof i == "string" && (s += `&tkn=${encodeURIComponent(i)}`), Ie.from({
				scheme: wl ? this._preferredWebSchema : Pe.vscodeRemoteResource,
				authority: `${n}:${r}`,
	...
	const Dh = new Uh(), Ph = "vs/../../node_modules", Wh = "vscode-app";
	const Oh = new class ji {
		static {
			this.FALLBACK_AUTHORITY = Wh;
		}
		asBrowserUri(t) {
		...
		uriToBrowserUri(t) {
			return t.scheme === Pe.vscodeRemote ? Dh.rewrite(t) : t.scheme === Pe.file && (bl || vl === `${Pe.vscodeFileResource}://${ji.FALLBACK_AUTHORITY}`) ? t.with({
	...
	function Fh(e, t) {
		...
		const r = `${e}/${t}`, i = `${Ph}/${r}`;
		return Oh.asBrowserUri(i).toString(!0);
	}
	var Bh = class {
		constructor(e) {
			this.replacements = e;
		...
		compose(e) {
			...
			for (const a of n.replacements) {
				...
				if (!l) i.push(a.delta(-s));
					...
					const f = new $(u, a.replaceRange.endExclusive - s), b = a.slice(f, new $(0, a.getNewLength()));
					i.push(b);
				}
			}
			for (;;) {
		...
		removeCommonPrefix(e) {
			const n = Un(this.replaceRange.substring(e), this.newText);
			return n === 0 ? this : this.slice(this.replaceRange.deltaStart(n), new $(n, this.newText.length));
		}
		removeCommonSuffix(e) {
			const n = Dn(this.replaceRange.substring(e), this.newText);
			return n === 0 ? this : this.slice(this.replaceRange.deltaEnd(-n), new $(0, this.newText.length - n));
		}
		toJson() {
			return {
				txt: this.newText,
	...
	let di, mi, pi;
	function ba() {
		return di || (di = import(`${Fh("@vscode/diff", "dist/index.js")}`)), di;
	}
	function Gh(e) {
		return e ? (pi || (pi = ba().then((t) => t.createDiffComputer({ useWasm: !0 }))), pi) : (mi || (mi = ba().then((t) => t.createDiffComputer({ useWasm: !1 }))), mi);
	}
	async function wa(e) {
		return new Xh(await Gh(e));
	}
	var Xh = class {
		constructor(e) {
			this._computer = e;
...
`)), s = this._computer.computeDiff(r.value, i.value, {
			...
			for (const m of s.edits.replacements) {
				const f = m.range.start + c, b = f + m.newText.length, g = a.getRange(new $(m.range.start, m.range.endExclusive)), y = o.getRange(new $(f, b));
				l.push(new xe(g, y)), c += m.newText.length - (m.range.endExclusive - m.range.start);
			}
			const u = ri(l, r, i), d = [];
			if (n.computeMoves) for (const m of s.moves) {
				const f = a.getPosition(m.range.original.start), b = a.getPosition(m.range.original.endExclusive), g = o.getPosition(m.range.modified.start), y = o.getPosition(m.range.modified.endExclusive), T = new Y(f.lineNumber, b.lineNumber), k = new Y(g.lineNumber, y.lineNumber);
	...
	var L = class {
		...
		static fromRGBA(t) {
			...
			let l;
			return a === 0 ? l = 0 : s === n ? l = ((r - i) / a % 6 + 6) % 6 : s === r ? l = (i - n) / a + 2 : l = (n - r) / a + 4, new Ko(Math.round(l * 60), o, s, t.a);
		}
		static toRGBA(t) {
		...
		mix(t, n = .5) {
			const r = Math.min(Math.max(n, 0), 1), i = this.rgba, s = t.rgba, a = i.r + (s.r - i.r) * r, o = i.g + (s.g - i.g) * r, l = i.b + (s.b - i.b) * r, c = i.a + (s.a - i.a) * r;
			return new re(new L(a, o, l, c));
		}
		makeOpaque(t) {
		...
		(function(t) {
			(function(n) {
				...
				function f(g) {
					...
					if (y === 4) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), A = b(g.charCodeAt(3));
						return new e(new L(16 * T + T, 16 * k + k, 16 * A + A));
					}
					if (y === 5) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), A = b(g.charCodeAt(3)), H = b(g.charCodeAt(4));
						return new e(new L(16 * T + T, 16 * k + k, 16 * A + A, (16 * H + H) / 255));
					}
					return null;
				}
				n.parseHex = f;
	...
	function Yh(e, t) {
		...
		if (n) return {
			range: e,
			color: fi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
		};
	}
	function _a(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = va(t[0].values());
		return {
			range: e,
			color: fi(r[0], r[1], r[2], n ? r[3] : 1)
		};
	}
	function ya(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = va(t[0].values()), i = new sn(new $e(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
		return {
			range: e,
			color: fi(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a)
		};
	}
	function xt(e, t) {
	...
	function Jh(e) {
		...
		if (n.length > 0) for (const r of n) {
			...
			if (!a) continue;
			let o;
			s === "rgb" ? o = _a(Lt(e, r), xt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*[\s,]\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*[\s,]\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : s === "rgba" ? o = _a(Lt(e, r), xt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*[\s,]\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*[\s,]\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*(?:[\s,]|[\s]*\/)\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : s === "hsl" ? o = ya(Lt(e, r), xt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100(?:\.0+)?|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100(?:\.0+)?|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : s === "hsla" ? o = ya(Lt(e, r), xt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100(?:\.0+)?|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100(?:\.0+)?|\d{1,2}[.]\d*|\d{1,2})%\s*(?:[\s,]|[\s]*\/)\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : s === "#" && (o = Yh(Lt(e, r), s + a)), o && t.push(o);
		}
		return t;
	}
	function Qh(e) {
		return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Jh(e);
	}
	const Zh = /^-+|-+$/g, Kh = 100;
	function eu(e, t) {
		let n = [];
	...
	function nu(e, t) {
		...
		const i = jc(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${i ? "s" : ""}`);
		if (Hl(s)) return n;
		for (let a = 1; a <= r; a += 95) {
			const o = Math.min(a + Kh - 1, r), l = [];
...
`);
			...
			let u;
			for (; (u = s.exec(c)) !== null;) {
				const d = c.substring(0, u.index), m = (d.match(/\n/g) || []).length, f = a + m, b = u[0].split(`
`), g = b.length, y = f + g - 1, T = d.lastIndexOf(`
`) + 1, k = u.index - T + 1, A = b[b.length - 1], H = {
					range: {
						startLineNumber: f,
						startColumn: k,
						endLineNumber: y,
						endColumn: g === 1 ? k + u[0].length : A.length + 1
					},
					text: (u.groups ?? {}).label ?? "",
					hasSeparatorLine: ((u.groups ?? {}).separator ?? "") !== "",
					shouldBeInComments: !0
				};
				(H.text || H.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < H.range.startLineNumber) && n.push(H), s.lastIndex = u.index + u[0].length;
			}
		}
		return n;
	}
	...
	(class ge {
		constructor(t, n) {
			this._onReturn = n, this._producerConsumer = new su(), this._iterator = {
	...
	var au = class {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new hu(Ie.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		constructor(t = null) {
			this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new cu();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeUnicodeHighlights(t, n, r) {
			...
			return i ? Kc.computeUnicodeHighlights(i, n, r) : {
				ranges: [],
				hasMore: !1,
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			for (let { range: l, text: c, eol: u } of n) {
				...
				const m = ec(d, c, r), f = i.offsetAt(V.lift(l).getStartPosition());
				for (const b of m) {
					const g = i.positionAt(f + b.originalStart), y = i.positionAt(f + b.originalStart + b.originalLength), T = {
		...
		async $navigateValueSet(t, n, r, i, s) {
			...
			return lc.INSTANCE.navigateValueSet(n, l, c, u, r);
		}
		$fmr(t, n) {
	...
	typeof importScripts == "function" && (globalThis.monaco = Pc());
	function du(e) {
		switch (e) {
	...
	var bu = /{([^}]+)}/g;
	function wu(e, t) {
		return Object.keys(t).length === 0 ? e : e.replace(bu, (n, r) => t[r] ?? n);
	}
	var Sa;
	(function(e) {
		function t(n) {
	...
	(function(e) {
		...
		function n(r) {
			var i;
			let s = r;
			return x.defined(s) && J.is(s.range) && x.string(s.message) && (x.number(s.severity) || x.undefined(s.severity)) && (x.integer(s.code) || x.string(s.code) || x.undefined(s.code)) && (x.undefined(s.codeDescription) || x.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (x.string(s.source) || x.undefined(s.source)) && (x.undefined(s.relatedInformation) || x.typedArray(s.relatedInformation, vi.is));
		}
		e.is = n;
	})(cn || (cn = {}));
	var lt;
	...
	(function(e) {
		...
		function i(s) {
			const a = s;
			return le.is(a) && (_i.is(a.annotationId) || ct.is(a.annotationId));
		}
		e.is = i;
	})(Ia || (Ia = {}));
	var yi;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return x.objectLiteral(i) && ae.is(i.position) && (x.string(i.label) || x.typedArray(i.label, Mi.is)) && (i.kind === void 0 || Ni.is(i.kind)) && i.textEdits === void 0 || x.typedArray(i.textEdits, le.is) && (i.tooltip === void 0 || x.string(i.tooltip) || At.is(i.tooltip)) && (i.paddingLeft === void 0 || x.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || x.boolean(i.paddingRight));
		}
		e.is = n;
	})(lo || (lo = {}));
	var co;
	...
	(function(e) {
		...
		function r(s, a) {
			...
			for (let u = l.length - 1; u >= 0; u--) {
				let d = l[u], m = s.offsetAt(d.range.start), f = s.offsetAt(d.range.end);
				if (f <= c) o = o.substring(0, m) + d.newText + o.substring(f, o.length);
...
` && r++;
	...
	var wo = class Gi {
		...
		update(t, n) {
			for (let r of t) if (Gi.isIncremental(r)) {
				const i = _o(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
	...
	(function(e) {
		function t(i, s, a, o) {
			return new wo(i, s, a, o);
		}
		e.create = t;
		function n(i, s, a) {
			if (i instanceof wo) return i.update(s, a), i;
			throw new Error("TextDocument.update: document must be created by TextDocument.create");
		}
		e.update = n;
		function r(i, s) {
			let a = i.getText(), o = Ii(s.map(_u), (u, d) => {
				let m = u.range.start.line - d.range.start.line;
				return m === 0 ? u.range.start.character - d.range.start.character : m;
			}), l = 0;
			const c = [];
	...
	var yu = class {
		...
		skipWhitespace() {
			return this.advanceWhileChar((e) => e === Ru || e === Eu || e === Lu || e === Au || e === xu) > 0;
		}
		advanceWhileChar(e) {
	...
	const To = 33, ht = 45, pn = 60, Ae = 62, Hi = 47, Tu = 61, ku = 34, Su = 39, Lu = 10, xu = 13, Au = 12, Ru = 32, Eu = 9, Nu = {
	...
	function be(e, t = 0, n = j.WithinContent, r = !1) {
		...
		function g(k, A, H) {
			return o = A, a = k, l = H, A;
		}
		function y() {
			const k = i.pos(), A = s, H = T();
			return H !== U.EOS && k === i.pos() && !(r && (H === U.StartTagClose || H === U.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + k + ", state before: " + A + " after: " + s), i.advance(1), g(k, U.Unknown)) : H;
		}
		function T() {
			const k = i.pos();
			...
			switch (s) {
				...
				case j.WithinContent:
					if (i.advanceIfChar(pn)) {
						if (!i.eos() && i.peekChar() === To) {
							if (i.advanceIfChars([
								To,
								ht,
								ht
					...
					return i.advanceUntilChar(pn), g(k, U.Content);
				case j.AfterOpeningEndTag: return f().length > 0 ? (s = j.WithinEndTag, g(k, U.EndTag)) : i.skipWhitespace() ? g(k, U.Whitespace, Te("Tag name must directly follow the open bracket.")) : (s = j.WithinEndTag, i.advanceUntilChar(Ae), k < i.pos() ? g(k, U.Unknown, Te("End tag name expected.")) : T());
				case j.WithinEndTag:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					if (i.advanceIfChar(Ae)) return s = j.WithinContent, g(k, U.EndTagClose);
					if (r && i.peekChar() === pn) return s = j.WithinContent, g(k, U.EndTagClose, Te("Closing bracket missing."));
					A = Te("Closing bracket expected.");
					break;
				case j.AfterOpeningStartTag: return u = f(), m = void 0, d = void 0, u.length > 0 ? (c = !1, s = j.WithinTag, g(k, U.StartTag)) : i.skipWhitespace() ? g(k, U.Whitespace, Te("Tag name must directly follow the open bracket.")) : (s = j.WithinTag, i.advanceUntilChar(Ae), k < i.pos() ? g(k, U.Unknown, Te("Start tag name expected.")) : T());
				case j.WithinTag: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : c && (d = b(), d.length > 0) ? (s = j.AfterAttributeName, c = !1, g(k, U.AttributeName)) : i.advanceIfChars([Hi, Ae]) ? (s = j.WithinContent, g(k, U.StartTagSelfClose)) : i.advanceIfChar(Ae) ? (u === "script" ? m && Nu[m] ? s = j.WithinContent : s = j.WithinScriptContent : u === "style" ? s = j.WithinStyleContent : s = j.WithinContent, g(k, U.StartTagClose)) : r && i.peekChar() === pn ? (s = j.WithinContent, g(k, U.StartTagClose, Te("Closing bracket missing."))) : (i.advance(1), g(k, U.Unknown, Te("Unexpected character in tag.")));
				case j.AfterAttributeName: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : i.advanceIfChar(Tu) ? (s = j.BeforeAttributeValue, g(k, U.DelimiterAssign)) : (s = j.WithinTag, T());
				case j.BeforeAttributeValue:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					let H = i.advanceIfRegExp(/^[^\s"'`=<>]+/);
					if (H.length > 0 && (i.peekChar() === Ae && i.peekChar(-1) === Hi && (i.goBack(1), H = H.substring(0, H.length - 1)), d === "type" && (m = H), H.length > 0)) return s = j.WithinTag, c = !1, g(k, U.AttributeValue);
					const q = i.peekChar();
					return q === Su || q === ku ? (i.advance(1), i.advanceUntilChar(q) && i.advance(1), d === "type" && (m = i.getSource().substring(k + 1, i.pos() - 1)), s = j.WithinTag, c = !1, g(k, U.AttributeValue)) : (s = j.WithinTag, c = !1, T());
				case j.WithinScriptContent:
					let w = 1;
					for (; !i.eos();) {
						const p = i.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
						if (p.length === 0) return i.goToEnd(), g(k, U.Script);
						if (p === "<!--") w === 1 && (w = 2);
						else if (p === "-->") w = 1;
						else if (p[1] !== "/") w === 2 && (w = 3);
						else if (w === 3) w = 2;
			...
			return i.advance(1), s = j.WithinContent, g(k, U.Unknown, A);
		}
		return {
			scan: y,
			getTokenType: () => o,
	...
	var So = class {
		...
		findNodeBefore(e) {
			const t = ko(this.children, (n) => e <= n.start) - 1;
			if (t >= 0) {
		...
		parse(e, t) {
			const n = be(e, void 0, void 0, !0), r = new So(0, e.length, [], void 0);
			let i = r, s = -1, a, o = null, l = n.scan();
			for (; l !== U.EOS;) {
				switch (l) {
					case U.StartTagOpen:
						const c = new So(n.getTokenOffset(), e.length, [], i);
...
`,
	...
	const zu = 97, Hu = 122, Uu = 65, Du = 90, Pu = 48, Wu = 57;
	function Et(e, t) {
		const n = e.charCodeAt(t);
		return zu <= n && n <= Hu || Uu <= n && n <= Du || Pu <= n && n <= Wu;
	}
	function fn(e) {
		return typeof e < "u";
	}
...
`)), r.value !== "") return r;
	...
	var Ou = class {
		...
		async computeCompletions(e, t) {
			...
			for (const r of this.atributeCompletions) {
				const i = Bu(e.getText(r.range));
				if (Vu(i)) if (i === "." || i === "..") n.isIncomplete = !0;
				else {
					const s = ju(r.value, i, r.range), a = await this.providePathSuggestions(r.value, s, e, t);
		...
		async providePathSuggestions(e, t, n, r) {
			...
			if (s) try {
				...
				for (const [l, c] of o) l.charCodeAt(0) !== Fu && a.push($u(l, c === zi.Directory, t));
				return a;
			} catch {}
			return [];
		}
	...
	function ju(e, t, n) {
		...
		if (i === -1) r = Gu(n, 1, -1);
			...
			const s = t.slice(i + 1), a = Nt(n.end, -1 - s.length), o = s.indexOf(" ");
			let l;
			o !== -1 ? l = Nt(a, o) : l = Nt(n.end, -1), r = J.create(a, l);
		}
		return r;
	}
	function $u(e, t, n) {
	...
	function Gu(e, t, n) {
		const r = Nt(e.start, t), i = Nt(e.end, n);
		return J.create(r, i);
	}
	var Xu = class {
		constructor(e, t) {
		...
		async doComplete2(e, t, n, r, i) {
			...
			const s = new Ou(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
		...
		_doComplete(e, t, n, r) {
			const i = {
				isIncomplete: !1,
				items: []
			}, s = this.completionParticipants, a = this.dataManager.getDataProviders().filter((_) => _.isApplicable(e.languageId) && (!r || r[_.getId()] !== !1)), o = this.dataManager.getVoidElements(a), l = this.doesSupportMarkdown(), c = e.getText(), u = e.offsetAt(t), d = n.findNodeBefore(u);
			if (!d) return i;
				...
				return a.forEach((I) => {
					I.provideTags().forEach((P) => {
						i.items.push({
							label: P.name,
							kind: pe.Property,
							documentation: Ge(P, void 0, l),
							textEdit: le.replace(M, P.name),
...
\r`.indexOf(M) >= 0) return c.substring(R, _);
			...
			function k(_, R, M = u) {
				const I = g(_, M), P = Ao(c, M, j.WithinEndTag, U.EndTagClose) ? "" : ">";
				let D = d;
				for (R && (D = D.parent); D;) {
					const W = D.tag;
					if (W && (!D.closed || D.endTagStart && D.endTagStart > u)) {
						const B = {
							label: "/" + W,
							kind: pe.Property,
							filterText: "/" + W,
							textEdit: le.replace(I, "/" + W + P),
							insertTextFormat: ke.PlainText
						}, Q = T(D.start), Z = T(_ - 1);
						if (Q !== null && Z !== null && Q !== Z) {
							const te = Q + "</" + W + P;
							B.textEdit = le.replace(g(_ - 1 - Z.length), te), B.filterText = Z + "</" + W;
						}
				...
				return R || a.forEach((W) => {
					W.provideTags().forEach((B) => {
						i.items.push({
							label: "/" + B.name,
							kind: pe.Property,
							documentation: Ge(B, void 0, l),
							filterText: "/" + B.name + P,
							textEdit: le.replace(I, "/" + B.name + P),
							insertTextFormat: ke.PlainText
						});
					});
				}), i;
			...
			function w(_, R = u) {
				let M = u;
				for (; M < R && c[M] !== "<";) M++;
				const I = c.substring(_, R), P = g(_, M);
				let D = "";
				if (!Ao(c, R, j.AfterAttributeName, U.DelimiterAssign)) {
					const B = r?.attributeDefaultValue ?? "doublequotes";
					B === "empty" ? D = "=$1" : B === "singlequotes" ? D = "='$1'" : D = "=\"$1\"";
				}
				const W = q();
				return W[I] = !1, a.forEach((B) => {
					B.provideAttributes(f).forEach((Q) => {
						if (W[Q.name]) return;
						W[Q.name] = !0;
						let Z = Q.name, te;
						Q.valueSet !== "v" && D.length && (Z = Z + D, (Q.valueSet || Q.name === "style") && (te = {
							...
							label: Q.name,
							kind: Q.valueSet === "handler" ? pe.Function : pe.Value,
							documentation: Ge(Q, void 0, l),
							textEdit: le.replace(P, Z),
							insertTextFormat: ke.Snippet,
							command: te
						});
					});
			...
			function p(_, R) {
				...
				I[M] = `${M}$1="$2"`;
				function P(D) {
					D.attributeNames.forEach((W) => {
						qe(W, M) && !I[W] && !R[W] && (I[W] = W + "=\"$1\"");
					}), D.children.forEach((W) => P(W));
				}
				n && n.roots.forEach((D) => P(D)), Object.keys(I).forEach((D) => i.items.push({
					label: D,
					kind: pe.Value,
					textEdit: le.replace(_, I[D]),
					insertTextFormat: ke.Snippet
				}));
			}
			function v(_, R = u) {
				...
				if (u > _ && u <= R && Yu(c[_])) {
					const D = _ + 1;
					let W = R;
					R > _ && c[R - 1] === c[_] && W--, M = g(Ju(c, u, D), Qu(c, u, W)), P = u >= D && u <= W ? c.substring(D, u) : "", I = !1;
				} else M = g(_, R), P = c.substring(_, u), I = !0;
				if (s.length > 0) {
					const D = f.toLowerCase(), W = b.toLowerCase(), B = g(_, R);
				...
				return a.forEach((D) => {
					D.provideValues(f, b).forEach((W) => {
						const B = I ? "\"" + W.name + "\"" : W.name;
						i.items.push({
							label: W.name,
							filterText: B,
							kind: pe.Unit,
							documentation: Ge(W, void 0, l),
							textEdit: le.replace(M, B),
							insertTextFormat: ke.PlainText
						});
					});
				}), S(), i;
			...
			function C(_) {
				return u === m.getTokenEnd() && (E = m.scan(), E === _ && m.getTokenOffset() === u) ? m.getTokenEnd() : u;
			}
			function z() {
			...
			function S() {
				...
				for (; _ >= 0 && Et(c, _);) _--, R--;
				if (_ >= 0 && c[_] === "&") {
					const M = J.create(ae.create(t.line, R - 1), t);
					for (const I in Rt) if (Iu(I, ";")) {
						const P = "&" + I;
						i.items.push({
							label: P,
							kind: pe.Keyword,
							documentation: Te("Character entity representing '{0}'", Rt[I]),
							textEdit: le.replace(M, P),
							insertTextFormat: ke.PlainText
						});
					}
				}
			...
			let E = m.scan();
			for (; E !== U.EOS && m.getTokenOffset() <= u;) {
				switch (E) {
					case U.StartTagOpen:
						if (m.getTokenEnd() === u) {
							const _ = C(U.StartTag);
							return t.line === 0 && N(u, _), H(u, _);
						}
						break;
					case U.StartTag:
					...
					case U.DelimiterAssign:
						if (m.getTokenEnd() === u) return v(u, C(U.AttributeValue));
						break;
					case U.AttributeValue:
					...
					case U.Whitespace:
						if (u <= m.getTokenEnd()) switch (m.getScannerState()) {
							case j.AfterOpeningStartTag: return H(m.getTokenOffset(), C(U.StartTag));
							case j.WithinTag:
							case j.AfterAttributeName: return w(m.getTokenEnd());
							case j.BeforeAttributeValue: return v(m.getTokenEnd());
							case j.AfterOpeningEndTag: return k(m.getTokenOffset() - 1, !1);
							case j.WithinContent: return z();
						}
						break;
					case U.EndTagOpen:
					...
					case U.EndTag:
						if (u <= m.getTokenEnd()) {
							...
							for (; _ >= 0;) {
								const R = c.charAt(_);
								if (R === "/") return k(_, !1, m.getTokenEnd());
								if (!gn(R)) break;
								_--;
							}
						}
						break;
					case U.StartTagClose:
						if (u <= m.getTokenEnd() && f) return A(m.getTokenEnd(), f);
						break;
					case U.Content:
						if (u <= m.getTokenEnd()) return z();
						break;
					default: if (u <= m.getTokenEnd()) return i;
				}
				E = m.scan();
			}
			return i;
		...
		doesSupportMarkdown() {
			if (!fn(this.supportsMarkdown)) {
				if (!fn(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
	...
	var Zu = class {
		...
		doHover(e, t, n, r) {
			...
			function d(w, p, v) {
				for (const C of c) {
					let z = null;
					if (C.provideAttributes(w).forEach((S) => {
						if (p === S.name && S.description) {
							const N = Ge(S, r, s);
							N ? z = {
								contents: N,
								range: v
			...
			function m(w, p, v, C) {
				for (const z of c) {
					let S = null;
					if (z.provideValues(w, p).forEach((N) => {
						if (v === N.name && N.description) {
							const E = Ge(N, r, s);
							E ? S = {
								contents: E,
								range: C
			...
			function f(w, p) {
				...
				for (const C in Rt) {
					let z = null;
					if (v === "&" + C) {
						let S = Rt[C].charCodeAt(0).toString(16).toUpperCase(), N = "U+";
						if (S.length < 4) {
							const _ = 4 - S.length;
							let R = 0;
							for (; R < _;) N += "0", R += 1;
						...
						N += S;
						const E = Te("Character entity representing '{0}', unicode equivalent '{1}'", Rt[C], N);
						E ? z = {
							contents: E,
							range: p
						} : z = null;
			...
			function b(w, p) {
				const v = be(e.getText(), p);
				let C = v.scan();
				for (; C !== U.EOS && (v.getTokenEnd() < a || v.getTokenEnd() === a && C !== w);) C = v.scan();
				return C === w && a <= v.getTokenEnd() ? {
					start: e.positionAt(v.getTokenOffset()),
					end: e.positionAt(v.getTokenEnd())
				} : null;
			}
			function g() {
				let w = a - 1, p = t.character;
				for (; w >= 0 && Et(l, w);) w--, p--;
				let v = w + 1, C = p;
				for (; Et(l, v);) v++, C++;
				if (w >= 0 && l[w] === "&") {
					let z = null;
					return l[v] === ";" ? z = J.create(ae.create(t.line, p), ae.create(t.line, C + 1)) : z = J.create(ae.create(t.line, p), ae.create(t.line, C)), z;
				}
				return null;
			}
			function y(w) {
			...
			if (A) return f(l, A);
			function H(w, p) {
				const v = be(e.getText(), w);
				let C = v.scan(), z;
				for (; C !== U.EOS && v.getTokenEnd() <= p;) C = v.scan(), C === U.AttributeName && (z = v.getTokenText());
				return z;
			}
			const q = b(U.AttributeValue, o.start);
			if (q) {
				const w = o.tag, p = Ku(e.getText(q)), v = H(o.start, e.offsetAt(q.start));
				if (v) return m(w, v, p, q);
			}
			return null;
		}
		convertContents(e) {
...
You passed in: '` + this.raw_options[o] + "'");
			...
			(function(r, i, s) {
				...
				function T(k, A) {
					this._source_text = k || "", this._options = new a(A), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
						page: !0,
						"font-face": !0,
						keyframes: !0,
						media: !0,
...
`) break;
					...
					for (var A = f.test(this._input.peek()), H = 0; f.test(this._input.peek());) this._ch = this._input.next(), k && this._ch === `
` && (H === 0 || H < this._options.max_preserve_newlines) && (H++, this._output.add_new_line(!0));
					return A;
				}, T.prototype.foundNestedPseudoClass = function() {
					for (var k = 0, A = 1, H = this._input.peek(A); H;) {
						if (H === "{") return !0;
						if (H === "(") k += 1;
						else if (H === ")") {
							if (k === 0) return !1;
					...
					A === "auto" && (A = `
`, k && d.test(k || "") && (A = k.match(d)[0])), k = k.replace(m, `
`);
					var H = k.match(/^[\t ]*/)[0];
					this._output = new o(this._options, H), this._input = new l(k), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
					for (var q = 0, w = !1, p = !1, v = !1, C = !1, z = !1, S = this._ch, N = !1, E, _, R; E = this._input.read(b), _ = E !== "", R = S, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), S = this._ch, this._ch;) if (this._ch === "/" && this._input.peek() === "*") {
						this._output.add_new_line(), this._input.back();
						var M = this._input.read(g), I = u.get_directives(M);
						...
						P.match(/[ :]$/) && (P = this.eatString(": ").replace(/\s+$/, ""), this.print_string(P), this._output.space_before_token = !0), q === 0 && P.indexOf(":") !== -1 && (p = !0, this.indent());
						...
						D.match(/[ :]$/) && (D = this.eatString(": ").replace(/\s+$/, ""), this.print_string(D), this._output.space_before_token = !0), q === 0 && D.indexOf(":") !== -1 ? (p = !0, this.indent()) : D in this.NESTED_AT_RULE ? (this._nestedLevel += 1, D in this.CONDITIONAL_GROUP_RULE && (v = !0)) : q === 0 && !p && (C = !0);
					}
					else if (this._ch === "#" && this._input.peek() === "{") this.preserveSingleSpace(_), this.print_string(this._ch + this.eatString("}"));
					else if (this._ch === "{") p && (p = !1, this.outdent()), C = !1, v ? (v = !1, w = this._indentLevel >= this._nestedLevel) : w = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && w && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (R === "(" ? this._output.space_before_token = !1 : R !== "," && this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line();
					else if (this._ch === "}") this.outdent(), this._output.add_new_line(), R === "{" && this._output.trim(!0), p && (this.outdent(), p = !1), this.print_string(this._ch), w = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0), this._input.peek() === ")" && (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0));
					else if (this._ch === ":") {
						for (var W = 0; W < this.NON_SEMICOLON_NEWLINE_PROPERTY.length; W++) if (this._input.lookBack(this.NON_SEMICOLON_NEWLINE_PROPERTY[W])) {
							N = !0;
							break;
						}
						(w || v) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !C && q === 0 ? (this.print_string(":"), p || (p = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
					} else if (this._ch === "\"" || this._ch === "'") {
						var B = R === "\"" || R === "'";
						this.preserveSingleSpace(B || _), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
					} else if (this._ch === ";") N = !1, q === 0 ? (p && (this.outdent(), p = !1), C = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
					else if (this._ch === "(") if (this._input.lookBack("url")) this.print_string(this._ch), this.eatWhitespace(), q++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === "\"" || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), q && (q--, this.outdent()));
					else {
						var Q = !1;
						this._input.lookBack("with") && (Q = !0), this.preserveSingleSpace(_ || Q), this.print_string(this._ch), p && R === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), z = !0) : (this.eatWhitespace(), q++, this.indent());
					}
					else if (this._ch === ")") q && (q--, this.outdent()), z && this._input.peek() === ";" && this._options.selector_separator_newline && (z = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
					else if (this._ch === ",") this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!p || z) && q === 0 && !C ? this._output.add_new_line() : this._output.space_before_token = !0;
					else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !p && q === 0) this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && f.test(this._ch) && (this._ch = ""));
					else if (this._ch === "]") this.print_string(this._ch);
					else if (this._ch === "[") this.preserveSingleSpace(_), this.print_string(this._ch);
					else if (this._ch === "=") this.eatWhitespace(), this.print_string("="), f.test(this._ch) && (this._ch = "");
					else if (this._ch === "!" && !this._input.lookBack("\\")) this._output.space_before_token = !0, this.print_string(this._ch);
					else {
						var Z = R === "\"" || R === "'";
						this.preserveSingleSpace(Z || _), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && N && this._output.add_new_line();
					}
					return this._output.get_code(A);
...
You passed in: '` + this.raw_options[o] + "'");
			...
			(function(r, i, s) {
				var a = s(8).InputScanner, o = s(3).Token, l = s(10).TokenStream, c = s(11).WhitespacePattern, u = {
					...
					this._input = new a(m), this._options = f || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new c(this._input);
				};
				d.prototype.tokenize = function() {
					this._input.restart(), this.__tokens = new l(), this._reset();
					for (var m, f = new o(u.START, ""), b = null, g = [], y = new l(); f.type !== u.EOF;) {
						for (m = this._get_next_token(f, b); this._is_comment(m);) y.add(m), m = this._get_next_token(f, b);
						y.isEmpty() || (m.comments_before = y, y = new l()), m.parent = b, this._is_opening(m) ? (g.push(b), b = m) : b && this._is_closing(m, b) && (m.opened = b, b.closed = m, b = g.pop(), m.parent = b), m.previous = f, f.next = m, this.__tokens.add(m), f = m;
					}
					return this.__tokens;
				}, d.prototype._is_first_token = function() {
					return this.__tokens.isEmpty();
				}, d.prototype._reset = function() {}, d.prototype._get_next_token = function(m, f) {
					...
					return !1;
				}, d.prototype._is_closing = function(m, f) {
					return !1;
				}, d.prototype._create_token = function(m, f) {
					return new o(m, f, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
			...
			(function(r, i, s) {
				var a = s(20).Options, o = s(2).Output, l = s(21).Tokenizer, c = s(21).TOKEN, u = /\r\n|[\r\n]/, d = /\r\n|[\r\n]/g, m = function(w, p) {
					this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = w.max_preserve_newlines, this.preserve_newlines = w.preserve_newlines, this._output = new o(w, p);
				};
				m.prototype.current_line_has_match = function(w) {
					return this._output.current_line.has_match(w);
				}, m.prototype.set_space_before_token = function(w, p) {
					this._output.space_before_token = w, this._output.non_breaking_space = p;
					...
					var p = 0;
					w.type !== c.TEXT && w.previous.type !== c.TEXT && (p = w.newlines ? 1 : 0), this.preserve_newlines && (p = w.newlines < this.max_preserve_newlines + 1 ? w.newlines : this.max_preserve_newlines + 1);
					for (var v = 0; v < p; v++) this.print_newline(v > 0);
					return p !== 0;
				...
				var f = function(w) {
					for (var p = null, v = w.next; v.type !== c.EOF && w.closed !== v;) {
						if (v.type === c.ATTRIBUTE && v.text === "type") {
							v.next && v.next.type === c.EQUALS && v.next.next && v.next.next.type === c.VALUE && (p = v.next.next.text);
							break;
						}
						v = v.next;
					}
					...
					var v = null, C = null;
					return p.closed ? (w === "script" ? v = "text/javascript" : w === "style" && (v = "text/css"), v = f(p) || v, v.search("text/css") > -1 ? C = "css" : v.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? C = "javascript" : v.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? C = "html" : v.search(/test\/null/) > -1 && (C = "null"), C) : null;
				};
				function g(w, p) {
					return p.indexOf(w) !== -1;
				}
				function y(w, p, v) {
					this.parent = w || null, this.tag = p ? p.tag_name : "", this.indent_level = v || 0, this.parser_token = p || null;
				}
				function T(w) {
				...
				T.prototype.get_parser_token = function() {
					...
					var p = new y(this._current_frame, w, this._printer.indent_level);
					this._current_frame = p;
				}, T.prototype._try_pop_frame = function(w) {
					var p = null;
					return w && (p = w.parser_token, this._printer.indent_level = w.indent_level, this._current_frame = w.parent), p;
				}, T.prototype._get_frame = function(w, p) {
					for (var v = this._current_frame; v && w.indexOf(v.tag) === -1;) {
						if (p && p.indexOf(v.tag) !== -1) {
							v = null;
							break;
						}
						v = v.parent;
					...
					return v;
				}, T.prototype.try_pop = function(w, p) {
					var v = this._get_frame([w], p);
					return this._try_pop_frame(v);
				}, T.prototype.indent_to_tag = function(w) {
					var p = this._get_frame(w);
					p && (this._printer.indent_level = p.indent_level);
				};
				function k(w, p, v, C) {
					this._source_text = w || "", p = p || {}, this._js_beautify = v, this._css_beautify = C, this._tag_stack = null;
					var z = new a(p, "html");
				...
				k.prototype.beautify = function() {
					if (this._options.disabled) return this._source_text;
					var w = this._source_text, p = this._options.eol;
					this._options.eol === "auto" && (p = `
`, w && u.test(w) && (p = w.match(u)[0])), w = w.replace(d, `
`);
					var v = w.match(/^[\t ]*/)[0], C = {
						text: "",
						type: ""
					}, z = new A(), S = new m(this._options, v), N = new l(w, this._options).tokenize();
					this._tag_stack = new T(S);
					for (var E = null, _ = N.next(); _.type !== c.EOF;) _.type === c.TAG_OPEN || _.type === c.COMMENT ? (E = this._handle_tag_open(S, _, z, C, N), z = E) : _.type === c.ATTRIBUTE || _.type === c.EQUALS || _.type === c.VALUE || _.type === c.TEXT && !z.tag_complete ? E = this._handle_inside_tag(S, _, z, C) : _.type === c.TAG_CLOSE ? E = this._handle_tag_close(S, _, z) : _.type === c.TEXT ? E = this._handle_text(S, _, z) : _.type === c.CONTROL_FLOW_OPEN ? E = this._handle_control_flow_open(S, _) : _.type === c.CONTROL_FLOW_CLOSE ? E = this._handle_control_flow_close(S, _) : S.add_raw_token(_), C = E, _ = N.next();
					return S._output.get_code(p);
				}, k.prototype._handle_control_flow_open = function(w, p) {
					var v = {
						text: p.text,
						type: p.type
					};
					return w.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), p.newlines ? w.print_preserved_newlines(p) : w.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), w.print_token(p), w.indent(), v;
				}, k.prototype._handle_control_flow_close = function(w, p) {
					var v = {
						text: p.text,
						type: p.type
					};
					return w.deindent(), p.newlines ? w.print_preserved_newlines(p) : w.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), w.print_token(p), v;
				}, k.prototype._handle_tag_close = function(w, p, v) {
					var C = {
						text: p.text,
						type: p.type
					};
					return w.alignment_size = 0, v.tag_complete = !0, w.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), v.is_unformatted ? w.add_raw_token(p) : (v.tag_start_char === "<" && (w.set_space_before_token(p.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && v.has_wrapped_attrs && w.print_newline(!1)), w.print_token(p)), v.indent_content && !(v.is_unformatted || v.is_content_unformatted) && (w.indent(), v.indent_content = !1), !v.is_inline_element && !(v.is_unformatted || v.is_content_unformatted) && w.set_wrap_point(), C;
				}, k.prototype._handle_inside_tag = function(w, p, v, C) {
					var z = v.has_wrapped_attrs, S = {
						text: p.text,
						type: p.type
					};
					return w.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), v.is_unformatted ? w.add_raw_token(p) : v.tag_start_char === "{" && p.type === c.TEXT ? w.print_preserved_newlines(p) ? (p.newlines = 0, w.add_raw_token(p)) : w.print_token(p) : (p.type === c.ATTRIBUTE ? w.set_space_before_token(!0) : (p.type === c.EQUALS || p.type === c.VALUE && p.previous.type === c.EQUALS) && w.set_space_before_token(!1), p.type === c.ATTRIBUTE && v.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (w.traverse_whitespace(p), z = z || p.newlines !== 0), this._is_wrap_attributes_force && v.attr_count >= this._options.wrap_attributes_min_attrs && (C.type !== c.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) && (w.print_newline(!1), z = !0)), w.print_token(p), z = z || w.previous_token_wrapped(), v.has_wrapped_attrs = z), S;
				}, k.prototype._handle_text = function(w, p, v) {
					var C = {
						text: p.text,
						type: "TK_CONTENT"
					};
					return v.custom_beautifier_name ? this._print_custom_beatifier_text(w, p, v) : v.is_unformatted || v.is_content_unformatted ? w.add_raw_token(p) : (w.traverse_whitespace(p), w.print_token(p)), C;
				}, k.prototype._print_custom_beatifier_text = function(w, p, v) {
					var C = this;
					if (p.text !== "") {
						var z = p.text, S, N = 1, E = "", _ = "";
						v.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? S = this._js_beautify : v.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? S = this._css_beautify : v.custom_beautifier_name === "html" && (S = function(W, B) {
							return new k(W, B, C._js_beautify, C._css_beautify).beautify();
						}), this._options.indent_scripts === "keep" ? N = 0 : this._options.indent_scripts === "separate" && (N = -w.indent_level);
						var R = w.get_full_indent(N);
						if (z = z.replace(/\n[ \t]*$/, ""), v.custom_beautifier_name !== "html" && z[0] === "<" && z.match(/^(<!--|<!\[CDATA\[)/)) {
							var M = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(z);
							if (!M) {
								w.add_raw_token(p);
								return;
							...
							E = R + M[1] + `
`, z = M[4], M[5] && (_ = R + M[5]), z = z.replace(/\n[ \t]*$/, ""), (M[2] || M[3].indexOf(`
`) !== -1) && (M = M[3].match(/[ \t]+$/), M && (p.whitespace_before = M[0]));
						}
						if (z) if (S) {
							var I = function() {
								this.eol = `
`;
							...
							var D = p.whitespace_before;
							D && (z = z.replace(new RegExp(`
(` + D + ")?", "g"), `
`)), z = R + z.replace(/\n/g, `
` + R);
						}
						E && (z ? z = E + z + `
` + _ : z = E + _), w.print_newline(!1), z && (p.text = z, p.whitespace_before = "", p.newlines = 0, w.add_raw_token(p), w.print_newline(!0));
					}
				}, k.prototype._handle_tag_open = function(w, p, v, C, z) {
					var S = this._get_tag_open_token(p);
					if ((v.is_unformatted || v.is_content_unformatted) && !v.is_empty_element && p.type === c.TAG_OPEN && !S.is_start_tag ? (w.add_raw_token(p), S.start_tag_token = this._tag_stack.try_pop(S.tag_name)) : (w.traverse_whitespace(p), this._set_tag_position(w, p, S, v, C), S.is_inline_element || w.set_wrap_point(), w.print_token(p)), S.is_start_tag && this._is_wrap_attributes_force) {
						var N = 0, E;
						do
							E = z.peek(N), E.type === c.ATTRIBUTE && (S.attr_count += 1), N += 1;
						while (E.type !== c.EOF && E.type !== c.TAG_CLOSE);
					}
					return (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (S.alignment_size = p.text.length + 1), !S.tag_complete && !S.is_unformatted && (w.alignment_size = S.alignment_size), S;
				};
				var A = function(w, p) {
					if (this.parent = w || null, this.text = "", this.type = "TK_TAG_OPEN", this.tag_name = "", this.is_inline_element = !1, this.is_unformatted = !1, this.is_content_unformatted = !1, this.is_empty_element = !1, this.is_start_tag = !1, this.is_end_tag = !1, this.indent_content = !1, this.multiline_content = !1, this.custom_beautifier_name = null, this.start_tag_token = null, this.attr_count = 0, this.has_wrapped_attrs = !1, this.alignment_size = 0, this.tag_complete = !1, this.tag_start_char = "", this.tag_check = "", !p) this.tag_complete = !0;
						...
						var v;
						this.tag_start_char = p.text[0], this.text = p.text, this.tag_start_char === "<" ? (v = p.text.match(/^<([^\s>]*)/), this.tag_check = v ? v[1] : "") : (v = p.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/), this.tag_check = v ? v[1] : "", (p.text.startsWith("{{#>") || p.text.startsWith("{{~#>")) && this.tag_check[0] === ">" && (this.tag_check === ">" && p.next !== null ? this.tag_check = p.next.text.split(" ")[0] : this.tag_check = p.text.split(">")[1])), this.tag_check = this.tag_check.toLowerCase(), p.type === c.COMMENT && (this.tag_complete = !0), this.is_start_tag = this.tag_check.charAt(0) !== "/", this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1), this.is_end_tag = !this.is_start_tag || p.closed && p.closed.text === "/>";
						var C = 2;
				...
				k.prototype._get_tag_open_token = function(w) {
					var p = new A(this._tag_stack.get_parser_token(), w);
				...
				}, k.prototype._set_tag_position = function(w, p, v, C, z) {
					if (v.is_empty_element || (v.is_end_tag ? v.start_tag_token = this._tag_stack.try_pop(v.tag_name) : (this._do_optional_end_element(v) && (v.is_inline_element || w.print_newline(!1)), this._tag_stack.record_tag(v), (v.tag_name === "script" || v.tag_name === "style") && !(v.is_unformatted || v.is_content_unformatted) && (v.custom_beautifier_name = b(v.tag_check, p)))), g(v.tag_check, this._options.extra_liners) && (w.print_newline(!1), w._output.just_added_blankline() || w.print_newline(!0)), v.is_empty_element) v.tag_start_char === "{" && v.tag_check === "else" && (this._tag_stack.indent_to_tag([
						"if",
						"unless",
						"each"
					]), v.indent_content = !0, w.current_line_has_match(/{{#if/) || w.print_newline(!1)), v.tag_name === "!--" && z.type === c.TAG_CLOSE && C.is_end_tag && v.text.indexOf(`
`) === -1 || (v.is_inline_element || v.is_unformatted || w.print_newline(!1), this._calcluate_parent_multiline(w, v));
					else if (v.is_end_tag) {
						var S = !1;
						S = v.start_tag_token && v.start_tag_token.multiline_content, S = S || !v.is_inline_element && !(C.is_inline_element || C.is_unformatted) && !(z.type === c.TAG_CLOSE && v.start_tag_token === C) && z.type !== "TK_CONTENT", (v.is_content_unformatted || v.is_unformatted) && (S = !1), S && w.print_newline(!1);
					} else v.indent_content = !v.custom_beautifier_name, v.tag_start_char === "<" && (v.tag_name === "html" ? v.indent_content = this._options.indent_inner_html : v.tag_name === "head" ? v.indent_content = this._options.indent_head_inner_html : v.tag_name === "body" && (v.indent_content = this._options.indent_body_inner_html)), !(v.is_inline_element || v.is_unformatted) && (z.type !== "TK_CONTENT" || v.is_content_unformatted) && w.print_newline(!1), this._calcluate_parent_multiline(w, v);
				}, k.prototype._calcluate_parent_multiline = function(w, p) {
					p.parent && w._output.just_added_newline() && !((p.is_inline_element || p.is_unformatted) && p.parent.is_inline_element) && (p.parent.multiline_content = !0);
				};
				var H = [
					"address",
					"article",
				...
				k.prototype._do_optional_end_element = function(w) {
					...
					if (!(w.is_empty_element || !w.is_start_tag || !w.parent)) {
						if (w.tag_name === "body") p = p || this._tag_stack.try_pop("head");
						else if (w.tag_name === "li") p = p || this._tag_stack.try_pop("li", [
							"ol",
							"ul",
							"menu"
						]);
						else if (w.tag_name === "dd" || w.tag_name === "dt") p = p || this._tag_stack.try_pop("dt", ["dl"]), p = p || this._tag_stack.try_pop("dd", ["dl"]);
						else if (w.parent.tag_name === "p" && H.indexOf(w.tag_name) !== -1) {
							var v = w.parent.parent;
							(!v || q.indexOf(v.tag_name) === -1) && (p = p || this._tag_stack.try_pop("p"));
						} else w.tag_name === "rp" || w.tag_name === "rt" ? (p = p || this._tag_stack.try_pop("rt", ["ruby", "rtc"]), p = p || this._tag_stack.try_pop("rp", ["ruby", "rtc"])) : w.tag_name === "optgroup" ? p = p || this._tag_stack.try_pop("optgroup", ["select"]) : w.tag_name === "option" ? p = p || this._tag_stack.try_pop("option", [
							"select",
							"datalist",
							"optgroup"
						]) : w.tag_name === "colgroup" ? p = p || this._tag_stack.try_pop("caption", ["table"]) : w.tag_name === "thead" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"])) : w.tag_name === "tbody" || w.tag_name === "tfoot" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("thead", ["table"]), p = p || this._tag_stack.try_pop("tbody", ["table"])) : w.tag_name === "tr" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("tr", [
							"table",
							"thead",
							"tbody",
							"tfoot"
						])) : (w.tag_name === "th" || w.tag_name === "td") && (p = p || this._tag_stack.try_pop("td", [
							"table",
							"thead",
							"tbody",
							"tfoot",
							"tr"
						]), p = p || this._tag_stack.try_pop("th", [
							"table",
							"thead",
							"tbody",
							"tfoot",
						...
						return w.parent = this._tag_stack.get_parser_token(), p;
					}
			...
			(function(r, i, s) {
				...
				f.prototype = new a(), f.prototype._is_comment = function(b) {
					return !1;
				}, f.prototype._is_opening = function(b) {
					return b.type === d.TAG_OPEN || b.type === d.CONTROL_FLOW_OPEN;
				}, f.prototype._is_closing = function(b, g) {
				...
				}, f.prototype._get_next_token = function(b, g) {
					var y = null;
					this._readWhitespace();
				...
				}, f.prototype._read_comment_or_cdata = function(b) {
				...
				}, f.prototype._read_processing = function(b) {
					var g = null, y = null, T = null;
					if (b === "<") {
					...
					return g;
				}, f.prototype._read_open = function(b, g) {
					var y = null, T = null;
				...
				}, f.prototype._read_open_handlebars = function(b, g) {
					var y = null, T = null;
				...
				}, f.prototype._read_control_flows = function(b, g) {
					var y = "", T = null;
					...
					if (b === "@") {
						...
						for (var k = y.endsWith("(") ? 1 : 0, A = 0; !(y.endsWith("{") && k === A);) {
					...
					return T;
				}, f.prototype._read_close = function(b, g) {
					var y = null, T = null;
				...
				}, f.prototype._read_attribute = function(b, g, y) {
					var T = null, k = "";
					if (y && y.text[0] === "<") if (b === "=") T = this._create_token(d.EQUALS, this._input.next());
					else if (b === "\"" || b === "'") {
						var A = this._input.next();
						b === "\"" ? A += this.__patterns.double_quote.read() : A += this.__patterns.single_quote.read(), T = this._create_token(d.VALUE, A);
					...
					return T;
				}, f.prototype._is_content_unformatted = function(b) {
				...
				}, f.prototype._read_raw_content = function(b, g, y) {
					var T = "";
				...
				}, f.prototype._read_content_word = function(b, g) {
					var y = "";
				...
				}, r.exports.Tokenizer = f, r.exports.TOKEN = d;
			})
		], t = {};
		function n(r) {
			var i = t[r];
	...
	function id(e, t, n) {
		...
		if (t) {
			...
			for (; m < r.length && Mo(r, m);) m++;
			(m === r.length || No(r, m)) && (d = m), t = J.create(e.positionAt(c), e.positionAt(d));
			const f = r.substring(0, c);
			if ((/* @__PURE__ */ new RegExp(/.*[<][^>]*$/)).test(f)) return r = r.substring(c, d), [{
				range: t,
				newText: r
			}];
...
`,
		...
		let l = nd(rd(r), o);
		if (s > 0) {
			const c = n.insertSpaces ? Lo(" ", a * s) : Lo("	", s);
			l = l.split(`
`).join(`
...
`.indexOf(e.charAt(t)) !== -1;
	...
	(() => {
		var e = { 470: (i) => {
			...
			function a(l, c) {
				for (var u, d = "", m = 0, f = -1, b = 0, g = 0; g <= l.length; ++g) {
					...
					if (u === 47) {
						if (!(f === g - 1 || b === 1)) if (f !== g - 1 && b === 2) {
							if (d.length < 2 || m !== 2 || d.charCodeAt(d.length - 1) !== 46 || d.charCodeAt(d.length - 2) !== 46) {
								if (d.length > 2) {
									var y = d.lastIndexOf("/");
									if (y !== d.length - 1) {
										y === -1 ? (d = "", m = 0) : m = (d = d.slice(0, y)).length - 1 - d.lastIndexOf("/"), f = g, b = 0;
										continue;
									}
						...
						} else d.length > 0 ? d += "/" + l.slice(f + 1, g) : d = l.slice(f + 1, g), m = g - f - 1;
						f = g, b = 0;
					} else u === 46 && b !== -1 ? ++b : b = -1;
				}
				return d;
			...
			var o = {
				...
				relative: function(l, c) {
					...
					for (var d = l.length, m = d - u, f = 1; f < c.length && c.charCodeAt(f) === 47; ++f);
					for (var b = c.length - f, g = m < b ? m : b, y = -1, T = 0; T <= g; ++T) {
						if (T === g) {
							if (b > g) {
						...
						if (k !== c.charCodeAt(f + T)) break;
						k === 47 && (y = T);
					}
					var A = "";
					for (T = u + y + 1; T <= d; ++T) T !== d && l.charCodeAt(T) !== 47 || (A.length === 0 ? A += ".." : A += "/..");
					return A.length > 0 ? A + c.slice(f + y) : (f += y, c.charCodeAt(f) === 47 && ++f, c.slice(f));
				},
				...
				dirname: function(l) {
					if (s(l), l.length === 0) return ".";
					for (var c = l.charCodeAt(0), u = c === 47, d = -1, m = !0, f = l.length - 1; f >= 1; --f) if ((c = l.charCodeAt(f)) === 47) {
						if (!m) {
							d = f;
							break;
						}
				...
				basename: function(l, c) {
					...
					if (c !== void 0 && c.length > 0 && c.length <= l.length) {
						...
						for (u = l.length - 1; u >= 0; --u) {
							...
							} else g === -1 && (f = !1, g = u + 1), b >= 0 && (y === c.charCodeAt(b) ? --b == -1 && (m = u) : (b = -1, m = g));
						}
				...
				extname: function(l) {
					s(l);
					for (var c = -1, u = 0, d = -1, m = !0, f = 0, b = l.length - 1; b >= 0; --b) {
						var g = l.charCodeAt(b);
						if (g !== 47) d === -1 && (m = !1, d = b + 1), g === 46 ? c === -1 ? c = b : f !== 1 && (f = 1) : c !== -1 && (f = -1);
						else if (!m) {
							u = b + 1;
							break;
						}
				...
				parse: function(l) {
					...
					m ? (c.root = "/", u = 1) : u = 0;
					for (var f = -1, b = 0, g = -1, y = !0, T = l.length - 1, k = 0; T >= u; --T) if ((d = l.charCodeAt(T)) !== 47) g === -1 && (y = !1, g = T + 1), d === 46 ? f === -1 ? f = T : k !== 1 && (k = 1) : f !== -1 && (k = -1);
					else if (!y) {
						b = T + 1;
						break;
					}
					return f === -1 || g === -1 || k === 0 || k === 1 && f === g - 1 && f === b + 1 ? g !== -1 && (c.base = c.name = b === 0 && m ? l.slice(1, g) : l.slice(b, g)) : (b === 0 && m ? (c.name = l.slice(1, f), c.base = l.slice(1, g)) : (c.name = l.slice(b, f), c.base = l.slice(b, g)), c.ext = l.slice(f, g)), b > 0 ? c.dir = l.slice(0, b - 1) : m && (c.dir = "/"), c;
				},
				sep: "/",
				delimiter: ":",
				win32: null,
		...
		(() => {
			...
			const s = /^\w[\w\d+.-]*$/, a = /^\//, o = /^\/\//;
			function l(S, N) {
				if (!S.scheme && N) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${S.authority}", path: "${S.path}", query: "${S.query}", fragment: "${S.fragment}"}`);
			...
			class m {
				...
				query;
				fragment;
				constructor(N, E, _, R, M, I = !1) {
					typeof N == "object" ? (this.scheme = N.scheme || c, this.authority = N.authority || c, this.path = N.path || c, this.query = N.query || c, this.fragment = N.fragment || c) : (this.scheme = (function(P, D) {
						return P || D ? P : "file";
					})(N, I), this.authority = E || c, this.path = (function(P, D) {
						switch (P) {
							case "https":
							case "http":
				...
				with(N) {
					if (!N) return this;
					let { scheme: E, authority: _, path: R, query: M, fragment: I } = N;
					return E === void 0 ? E = this.scheme : E === null && (E = c), _ === void 0 ? _ = this.authority : _ === null && (_ = c), R === void 0 ? R = this.path : R === null && (R = c), M === void 0 ? M = this.query : M === null && (M = c), I === void 0 ? I = this.fragment : I === null && (I = c), E === this.scheme && _ === this.authority && R === this.path && M === this.query && I === this.fragment ? this : new b(E, _, R, M, I);
				}
				static parse(N, E = !1) {
					const _ = d.exec(N);
					return _ ? new b(_[2] || c, w(_[4] || c), w(_[5] || c), w(_[7] || c), w(_[9] || c), E) : new b(c, c, c, c, c);
				}
				static file(N) {
					let E = c;
					if (i && (N = N.replace(/\\/g, u)), N[0] === u && N[1] === u) {
						const _ = N.indexOf(u, 2);
						_ === -1 ? (E = N.substring(2), N = u) : (E = N.substring(2, _), N = N.substring(_) || u);
					}
					return new b("file", E, N, c, c);
				}
				static from(N) {
					const E = new b(N.scheme, N.authority, N.path, N.query, N.fragment);
					return l(E, !0), E;
				}
				toString(N = !1) {
					return A(this, N);
				...
				static revive(N) {
					if (N) {
						...
						{
							const E = new b(N);
							return E._formatted = N.external, E._fsPath = N._sep === f ? N.fsPath : null, E;
						}
					}
					return N;
				}
			...
			class b extends m {
				...
				toString(N = !1) {
					return N ? A(this, !0) : (this._formatted || (this._formatted = A(this, !1)), this._formatted);
				}
				toJSON() {
					const N = { $mid: 1 };
					return this._fsPath && (N.fsPath = this._fsPath, N._sep = f), this._formatted && (N.external = this._formatted), this.path && (N.path = this.path), this.scheme && (N.scheme = this.scheme), this.authority && (N.authority = this.authority), this.query && (N.query = this.query), this.fragment && (N.fragment = this.fragment), N;
				}
			}
			const g = {
				58: "%3A",
			...
			function y(S, N, E) {
				...
				for (let M = 0; M < S.length; M++) {
					...
					if (I >= 97 && I <= 122 || I >= 65 && I <= 90 || I >= 48 && I <= 57 || I === 45 || I === 46 || I === 95 || I === 126 || N && I === 47 || E && I === 91 || E && I === 93 || E && I === 58) R !== -1 && (_ += encodeURIComponent(S.substring(R, M)), R = -1), _ !== void 0 && (_ += S.charAt(M));
					else {
						_ === void 0 && (_ = S.substr(0, M));
						const P = g[I];
						P !== void 0 ? (R !== -1 && (_ += encodeURIComponent(S.substring(R, M)), R = -1), _ += P) : R === -1 && (R = M);
					}
				}
				return R !== -1 && (_ += encodeURIComponent(S.substring(R))), _ !== void 0 ? _ : S;
			}
			function T(S) {
				let N;
				for (let E = 0; E < S.length; E++) {
					const _ = S.charCodeAt(E);
					_ === 35 || _ === 63 ? (N === void 0 && (N = S.substr(0, E)), N += g[_]) : N !== void 0 && (N += S[E]);
				}
				return N !== void 0 ? N : S;
			}
			function k(S, N) {
			...
			function A(S, N) {
				const E = N ? T : y;
				let _ = "", { scheme: R, authority: M, path: I, query: P, fragment: D } = S;
				if (R && (_ += R, _ += ":"), (M || R === "file") && (_ += u, _ += u), M) {
					let W = M.indexOf("@");
					if (W !== -1) {
						const B = M.substr(0, W);
						M = M.substr(W + 1), W = B.lastIndexOf(":"), W === -1 ? _ += E(B, !1, !1) : (_ += E(B.substr(0, W), !1, !1), _ += ":", _ += E(B.substr(W + 1), !1, !0)), _ += "@";
					}
					M = M.toLowerCase(), W = M.lastIndexOf(":"), W === -1 ? _ += E(M, !1, !0) : (_ += E(M.substr(0, W), !1, !0), _ += M.substr(W));
				}
				if (I) {
					if (I.length >= 3 && I.charCodeAt(0) === 47 && I.charCodeAt(2) === 58) {
						const W = I.charCodeAt(1);
						W >= 65 && W <= 90 && (I = `/${String.fromCharCode(W + 32)}:${I.substr(3)}`);
					} else if (I.length >= 2 && I.charCodeAt(1) === 58) {
						const W = I.charCodeAt(0);
						W >= 65 && W <= 90 && (I = `${String.fromCharCode(W + 32)}:${I.substr(2)}`);
					}
					_ += E(I, !0, !1);
				}
				return P && (_ += "?", _ += E(P, !1, !1)), D && (_ += "#", _ += N ? D : y(D, !1, !1)), _;
			}
			function H(S) {
				try {
					return decodeURIComponent(S);
				} catch {
					return S.length > 3 ? S.substr(0, 3) + H(S.substr(3)) : S;
				}
			}
			const q = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
			function w(S) {
				return S.match(q) ? S.replace(q, ((N) => H(N))) : S;
			}
			var p = n(470);
			const v = p.posix || p, C = "/";
			var z;
			(function(S) {
				S.joinPath = function(N, ...E) {
					return N.with({ path: v.join(N.path, ...E) });
				}, S.resolvePath = function(N, ...E) {
					let _ = N.path, R = !1;
					_[0] !== C && (_ = C + _, R = !0);
					let M = v.resolve(_, ...E);
					return R && M[0] === C && !N.authority && (M = M.substring(1)), N.with({ path: M });
				}, S.dirname = function(N) {
					if (N.path.length === 0 || N.path === C) return N;
					let E = v.dirname(N.path);
					return E.length === 1 && E.charCodeAt(0) === 46 && (E = ""), N.with({ path: E });
				}, S.basename = function(N) {
					return v.basename(N.path);
				}, S.extname = function(N) {
					return v.extname(N.path);
				};
			})(z || (z = {}));
		})(), Co = r;
	})();
	const { URI: od, Utils: e1 } = Co;
	function Di(e) {
		const t = e[0];
	...
	function hd(e, t, n, r, i, s) {
		const a = Di(n);
		if (!ld(a, e.languageId)) return;
		a.length < n.length && (r++, i--);
		const o = cd(e.uri, a, t, s);
		if (!o) return;
		const l = dd(o, e);
		return {
	...
	function dd(e, t) {
		try {
			let n = od.parse(e);
			return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(!0)), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === ud) ? n.with({ fragment: null }).toString(!0) : e;
		} catch {
			return;
		}
	}
		...
		findDocumentLinks(e, t) {
			...
			for (; i !== U.EOS;) {
				switch (i) {
					...
					case U.AttributeName:
						...
						break;
					case U.AttributeValue: if (a && s && this.dataManager.isPathAttribute(a, s)) {
						const u = r.getTokenText();
						if (!o) {
							const d = hd(e, t, u, r.getTokenOffset(), r.getTokenEnd(), l);
							d && n.push(d);
						}
			...
			for (const u of n) {
				...
				if (u.target && qe(u.target, d)) {
					...
					if (m !== void 0) {
						const f = e.positionAt(m);
						u.target = `${d}${f.line + 1},${f.character + 1}`;
					} else u.target = e.uri;
				}
			}
			return n;
	...
	function pd(e, t, n) {
		...
		if (!i.tag) return [];
		const s = [], a = Ho(U.StartTag, e, i.start), o = typeof i.endTagStart == "number" && Ho(U.EndTag, e, i.endTagStart);
		return (a && zo(a, t) || o && zo(o, t)) && (a && s.push({
			kind: un.Read,
			range: a
		}), o && s.push({
			kind: un.Read,
	...
	function zo(e, t) {
		return Io(e.start, t) && Io(t, e.end);
	}
	function Ho(e, t, n) {
	...
	function Do(e, t, n) {
		const r = gd(t), i = J.create(e.positionAt(t.start), e.positionAt(t.end)), s = Ei.create(r, void 0, Ai.Field, i, i);
		n.push(s), t.children.forEach((a) => {
			s.children ?? (s.children = []), Do(e, a, s.children);
		});
	}
	function gd(e) {
		let t = e.tag;
	...
	function bd(e, t, n, r) {
		...
		if (!s.tag || !wd(s, i, s.tag)) return null;
		const a = [], o = {
				...
				switch (i) {
					...
					case U.StartTagSelfClose: {
						...
						if (d >= 0) {
							const m = a[d];
							a.length = d;
							const f = e.positionAt(r.getTokenOffset()).line, b = m.startLine, g = f - 1;
							g > b && l !== b && c({
								startLine: b,
								endLine: g
							});
					...
					case U.Comment: {
						...
						if (m) if (m[1]) a.push({
							...
							const f = e.positionAt(r.getTokenOffset() + r.getTokenLength()).line;
							d < f && c({
								startLine: d,
								endLine: f,
								kind: ln.Comment
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
	...
	var kd = class {
		...
		setDataProviders(e, t) {
			this.dataProviders = [], e && this.dataProviders.push(new xo("html5", Td)), this.dataProviders.push(...t);
		}
		getDataProviders() {
			return this.dataProviders;
		}
		isVoidElement(e, t) {
			return !!e && Mu(t, e.toLowerCase(), (n, r) => n.localeCompare(r)) >= 0;
		}
		getVoidElements(e) {
	...
	function xd(e = Ld) {
		const t = new kd(e), n = new Zu(e, t), r = new Xu(e, t), i = new Cu(t), s = new yd(i), a = new _d(t), o = new md(t);
		return {
			...
			findDocumentSymbols: fd,
			findDocumentSymbols2: Uo,
			...
			findOnTypeRenameRanges: Po,
			findLinkedEditingRanges: Po
		};
	}
	function Ad(e, t) {
		return new xo(e, t);
	...
	var Rd = class {
		constructor(e, t) {
			...
			if (n?.dataProviders) for (const s in n.dataProviders) i.push(Ad(s, n.dataProviders[s]));
			this._languageService = xd({
...
//# sourceMappingURL=html.worker-C65B8ENx.js.map