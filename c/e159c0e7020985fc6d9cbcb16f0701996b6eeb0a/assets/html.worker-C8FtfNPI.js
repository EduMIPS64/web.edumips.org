...
` + e.stack) : e;
	...
	var Ri = class extends Error {
		constructor() {
			super(To), this.name = this.message;
		}
	...
	(function(e) {
		...
		function u(f, _) {
			let N = 0;
			for (const I of f) if (_(I, N++)) return !0;
			return !1;
		}
		e.some = u;
		function d(f, _) {
			let N = 0;
			for (const I of f) if (!_(I, N++)) return !1;
			return !0;
		}
		e.every = d;
		function m(f, _) {
			for (const N of f) if (_(N)) return N;
		}
		e.find = m;
		function* p(f, _) {
			for (const N of f) _(N) && (yield N);
		}
		e.filter = p;
		function* b(f, _) {
			let N = 0;
			for (const I of f) yield _(I, N++);
		}
		e.map = b;
		function* g(f, _) {
			let N = 0;
		...
		e.flatMap = g;
		function* v(...f) {
			for (const _ of f) Ao(_) ? yield* _ : yield _;
		}
		e.concat = v;
		function T(f, _, N) {
			let I = N;
			for (const L of f) I = _(I, L);
			return I;
		}
		e.reduce = T;
		function k(f) {
		...
		e.length = k;
		function* E(f, _, N = f.length) {
			for (_ < -f.length && (_ = 0), _ < 0 && (_ += f.length), N < 0 ? N += f.length : N > f.length && (N = f.length); _ < N; _++) yield f[_];
		}
		e.slice = E;
		function H(f, _ = Number.POSITIVE_INFINITY) {
			const N = [];
			if (_ === 0) return [N, f];
			const I = f[Symbol.iterator]();
			for (let L = 0; L < _; L++) {
				const S = I.next();
				if (S.done) return [N, e.empty()];
				N.push(S.value);
			}
		...
		async function D(f) {
			const _ = [];
			for await (const N of f) _.push(N);
			return _;
		}
		e.asyncToArray = D;
		async function w(f) {
			let _ = [];
			for await (const N of f) _ = _.concat(N);
			return _;
		}
	...
	const No = globalThis.performance.now.bind(globalThis.performance);
	var Ni = class oo {
		static create(t) {
			return new oo(t);
		}
		constructor(t) {
			this._now = t === !1 ? Date.now : No, this._startTime = this._now(), this._stopTime = -1;
		}
		stop() {
	...
	(function(e) {
		...
		function n(S) {
			return (A, y = null, R) => {
				let C = !1, z;
				return z = S((q) => {
					if (!C) return z ? z.dispose() : C = !0, A.call(y, q);
				}, null, R), C && z.dispose(), z;
			};
		}
		e.once = n;
		function r(S, A) {
		...
		e.onceIf = r;
		function i(S, A, y) {
			return u((R, C = null, z) => S((q) => R.call(C, A(q)), null, z), y);
		}
		e.map = i;
		function s(S, A, y) {
			return u((R, C = null, z) => S((q) => {
				A(q), R.call(C, q);
			}, null, z), y);
		}
		e.forEach = s;
		function a(S, A, y) {
			return u((R, C = null, z) => S((q) => A(q) && R.call(C, q), null, z), y);
		}
		e.filter = a;
		function o(S) {
			return S;
		...
		e.signal = o;
		function l(...S) {
			return (A, y = null, R) => d(Ro(...S.map((C) => C((z) => A.call(y, z)))), R);
		}
		e.any = l;
		function c(S, A, y, R) {
			let C = y;
			return i(S, (z) => (C = A(C, z), C), R);
		}
		e.reduce = c;
		function u(S, A) {
			let y;
		...
		function m(S, A, y = 100, R = !1, C = !1, z, q) {
			let P, W, G, Z = 0, ae;
			const Ce = new ke({
				leakWarningThreshold: z,
				onWillAddFirstListener() {
					P = S((qu) => {
						Z++, W = A(W, qu), R && !G && (Ce.fire(W), W = void 0), ae = () => {
							const Ou = W;
							W = void 0, G = void 0, (!R || Z > 1) && Ce.fire(Ou), Z = 0;
		...
		e.debounce = m;
		function p(S, A = 0, y) {
			return e.debounce(S, (R, C) => R ? (R.push(C), R) : [C], A, void 0, !0, void 0, y);
		}
		e.accumulate = p;
		function b(S, A = (R, C) => R === C, y) {
			let R = !0, C;
			return a(S, (z) => {
				const q = R || !A(z, C);
				return R = !1, C = z, q;
		...
		function v(S, A = !1, y = [], R) {
			...
			R && R.add(z);
			const q = () => {
				C?.forEach((W) => P.fire(W)), C = null;
			}, P = new ke({
				onWillAddFirstListener() {
					z || (z = S((W) => P.fire(W)), R && R.add(z));
				},
		...
		class E {
			...
			reduce(A, y) {
				let R = y;
				return this.steps.push((C) => (R = A(R, C), R)), this;
			}
			latch(A = (y, R) => y === R) {
				let y = !0, R;
				return this.steps.push((C) => {
					const z = y || !A(C, R);
					return y = !1, R = C, z ? C : k;
				}), this;
			}
			evaluate(A) {
		...
		function H(S, A, y = (R) => R) {
			const R = (...P) => q.fire(y(...P)), C = () => S.on(A, R), z = () => S.removeListener(A, R), q = new ke({
				onWillAddFirstListener: C,
				onDidRemoveLastListener: z
			});
			return q.event;
		}
		e.fromNodeEventEmitter = H;
		function D(S, A, y = (R) => R) {
			const R = (...P) => q.fire(y(...P)), C = () => S.addEventListener(A, R), z = () => S.removeEventListener(A, R), q = new ke({
				onWillAddFirstListener: C,
				onDidRemoveLastListener: z
			});
			return q.event;
		...
		function w(S, A) {
			let y;
			const R = new Promise((C, z) => {
				const q = n(S)(C, null, A);
				y = () => q.dispose();
			});
			return R.cancel = y, R;
		}
		...
		function I(S, A) {
			return new N(S, A).emitter.event;
		}
		e.fromObservable = I;
		function L(S) {
			return (A, y, R) => {
				...
				const q = {
					...
					endUpdate() {
						C--, C === 0 && (S.reportChanges(), z && (z = !1, A.call(y)));
					},
...
`));
	...
	var ke = class {
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new zo(e?.onListenerError ?? At, this._options?.leakWarningThreshold ?? Io) : void 0, this._perfMon = this._options?._profName ? new Co(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
		...
		get event() {
			return this._event ??= (e, t, n) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(a);
					const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], l = new Do(`${a}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0]);
				...
				const r = new wn(e);
				let i;
				this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = Ho.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof wn ? (this._deliveryQueue ??= new Po(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
				const s = Et(() => {
	...
	const Oo = Ci() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
	function Ii(e, t) {
		let n;
		...
		}), Oo && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
	}
	function F(e, t, ...n) {
		return Ii(typeof e == "number" ? Fo(e, t) : t, n);
	}
	function Fo(e, t) {
		const n = qo()?.[e];
		if (typeof n != "string") {
	...
	const $o = typeof ce?.versions?.electron == "string" && ce?.type === "renderer";
	if (typeof ce == "object") {
	...
	} else typeof navigator == "object" && !$o ? (xe = navigator.userAgent, Nt = xe.indexOf("Windows") >= 0, Ct = xe.indexOf("Macintosh") >= 0, (xe.indexOf("Macintosh") >= 0 || xe.indexOf("iPad") >= 0 || xe.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, It = xe.indexOf("Linux") >= 0, xe?.indexOf("Mobi"), zi = !0, Ci(), navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
	const ut = Nt, Go = Ct;
	zi && typeof Ae.importScripts == "function" && Ae.origin;
	const Se = xe, Xo = typeof Ae.postMessage == "function" && !Ae.importScripts;
	(() => {
		if (Xo) {
			const e = [];
	...
	const Jo = !!(Se && Se.indexOf("Chrome") >= 0);
	Se && Se.indexOf("Firefox");
	!Jo && Se && Se.indexOf("Safari");
	Se && Se.indexOf("Edg/");
	...
	var kn = class St {
		...
		static {
			this.cache = new Zo({ getCacheKey: JSON.stringify }, (t) => {
				function n(c) {
	...
	const Ln = "default", hl = "$initialize";
	var ul = class {
		...
		async sendMessage(e, t, n) {
			...
			return new Promise((i, s) => {
				this._pendingReplies[r] = {
					resolve: i,
					reject: s
				}, this._send(new ul(this._workerId, r, e, t, n));
			});
		}
		listen(e, t, n) {
			let r = null;
			const i = new ke({
				...
				onDidRemoveLastListener: () => {
					this._pendingEmitters.delete(r), this._send(new fl(this._workerId, r)), r = null;
				}
			});
			return i.event;
		}
		...
		_handleSubscribeEventMessage(e) {
			const t = e.req, n = this._handler.handleEvent(e.channel, e.eventName, e.arg)((r) => {
				this._send(new ml(this._workerId, t, r));
			});
	...
	var gl = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new pl({
				sendMessage: (n, r) => {
					e(n, r);
				},
		...
		_handleMessage(e, t, n) {
			if (e === Ln && t === hl) return this.initialize(n[0]);
	...
	function bl(e) {
		...
		qi = !0;
		const t = new gl((n) => globalThis.postMessage(n), (n) => e(n));
	...
	new yn(() => /* @__PURE__ */ new Uint8Array(256));
	let xn;
	var wl = class ho {
		static wrap(t) {
			return Oi && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new ho(t);
		}
		constructor(t) {
	...
	function dt(e, t = 32) {
		return e instanceof ArrayBuffer ? _l(wl.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
	}
	(class uo {
		static {
		...
		_step() {
			const t = uo._bigBlock32, n = this._buffDV;
	...
	var Ge = class {
		...
		WALKTRACE(t, n, r, i, s, a, o, l, c, u, d, m, p, b, g, v, T, k) {
			let E = null, H = null, D = new ji(), w = n, f = r, _ = p[0] - v[0] - i, N = -1073741824, I = this.m_forwardHistory.length - 1;
			do {
				const L = _ + t;
				L === w || L < f && c[L - 1] < c[L + 1] ? (d = c[L + 1], b = d - _ - i, d < N && D.MarkNextChange(), N = d, D.AddModifiedElement(d + 1, b), _ = L + 1 - t) : (d = c[L - 1] + 1, b = d - _ - i, d < N && D.MarkNextChange(), N = d - 1, D.AddOriginalElement(d, b + 1), _ = L - 1 - t), I >= 0 && (c = this.m_forwardHistory[I], t = c[0], w = 1, f = c.length - 1);
			} while (--I >= -1);
			if (E = D.getReverseChanges(), k[0]) {
				...
				H = [new He(L, m - L + 1, S, g - S + 1)];
			} else {
				D = new ji(), w = a, f = o, _ = p[0] - v[0] - l, N = 1073741824, I = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const L = _ + s;
					L === w || L < f && u[L - 1] >= u[L + 1] ? (d = u[L + 1] - 1, b = d - _ - l, d > N && D.MarkNextChange(), N = d + 1, D.AddOriginalElement(d + 1, b + 1), _ = L + 1 - s) : (d = u[L - 1], b = d - _ - l, d > N && D.MarkNextChange(), N = d, D.AddModifiedElement(d + 1, b + 1), _ = L - 1 - s), I >= 0 && (u = this.m_reverseHistory[I], s = u[0], w = 1, f = u.length - 1);
				} while (--I >= -1);
				H = D.getChanges();
			}
		...
		ComputeRecursionPoint(t, n, r, i, s, a, o) {
			...
			const b = n - t + (i - r), g = b + 1, v = new Int32Array(g), T = new Int32Array(g), k = i - r, E = n - t, H = t - r, D = n - i, w = (E - k) % 2 === 0;
			v[k] = t, T[E] = n, o[0] = !1;
			for (let f = 1; f <= b / 2 + 1; f++) {
				let _ = 0, N = 0;
				u = this.ClipDiagonalBound(k - f, f, k, g), d = this.ClipDiagonalBound(k + f, f, k, g);
				for (let L = u; L <= d; L += 2) {
					L === u || L < d && v[L - 1] < v[L + 1] ? l = v[L + 1] : l = v[L - 1] + 1, c = l - (L - k) - H;
					const S = l;
					for (; l < n && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
					if (v[L] = l, l + c > _ + N && (_ = l, N = c), !w && Math.abs(L - E) <= f - 1 && l >= T[L]) return s[0] = l, a[0] = c, S <= T[L] && f <= 1448 ? this.WALKTRACE(k, u, d, H, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				const I = (_ - t + (N - r) - f) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(_, I)) return o[0] = !0, s[0] = _, a[0] = N, I > 0 && f <= 1448 ? this.WALKTRACE(k, u, d, H, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : (t++, r++, [new He(t, n - t + 1, r, i - r + 1)]);
				...
				for (let L = m; L <= p; L += 2) {
					...
					if (T[L] = l, w && Math.abs(L - k) <= f && l <= v[L]) return s[0] = l, a[0] = c, S >= v[L] && f <= 1448 ? this.WALKTRACE(k, u, d, H, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				if (f <= 1447) {
			...
			return this.WALKTRACE(k, u, d, H, E, m, p, D, v, T, l, n, s, c, i, a, w, o);
		}
		PrettifyChanges(t) {
	...
	var Tl = class mo {
		constructor(t) {
			const n = Gi(t);
			this._defaultValue = n, this._asciiMap = mo._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
		}
	...
	function Rl(e) {
		return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : Al.computeLinks(e);
	}
	var Ml = class fo {
		constructor() {
	...
	const Dt = new Mn(), En = new Mn(), Nn = new Mn(), Nl = new Array(230), Cl = Object.create(null), Il = Object.create(null), Yi = [];
	...
	(function() {
		...
		for (const i of t) {
			...
			if (r[a] || (r[a] = !0, Cl[o] = a, Il[o.toLowerCase()] = a, s && (Yi[a] = l)), !n[l]) {
	...
	if (typeof Cn < "u" && typeof Cn.process < "u") {
		...
		get platform() {
			return ut ? "win32" : Go ? "darwin" : "linux";
		},
		get arch() {},
		get env() {
			return {};
	...
	const Wt = Je.cwd, Hl = Je.env, Ul = Je.platform, Dl = 65, Wl = 97, Pl = 90, ql = 122, Oe = 46, re = 47, he = 92, Re = 58, Ol = 63;
	...
	function Zi(e, t) {
		Fl(t, "pathObject");
		const n = t.dir || t.root, r = t.base || `${t.name || ""}${Bl(t.ext)}`;
	...
	const le = {
		resolve(...e) {
			...
			for (let i = e.length - 1; i >= -1; i--) {
				...
				} else t.length === 0 ? s = Wt() : (s = Hl[`=${t}`] || Wt(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === he) && (s = `${t}\\`));
				const a = s.length;
				let o = 0, l = "", c = !1;
		...
		toNamespacedPath(e) {
			...
			if (t.charCodeAt(0) === he) {
				if (t.charCodeAt(1) === he) {
					...
					if (n !== Ol && n !== Oe) return `\\\\?\\UNC\\${t.slice(2)}`;
				}
	...
	function Xl(e, t) {
		...
		if (e.scheme && !jl.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
		if (e.path) {
			if (e.authority) {
			...
			} else if (Gl.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
		}
	}
	function Yl(e, t) {
		return !e && !t ? "file" : e;
	...
	function Jl(e, t) {
		switch (e) {
			case "https":
			case "http":
			case "file": t ? t[0] !== _e && (t = _e + t) : t = _e;
		}
		return t;
	}
	const Q = "", _e = "/", Ql = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
	var zn = class cn {
		...
		constructor(t, n, r, i, s, a = !1) {
			typeof t == "object" ? (this.scheme = t.scheme || Q, this.authority = t.authority || Q, this.path = t.path || Q, this.query = t.query || Q, this.fragment = t.fragment || Q) : (this.scheme = Yl(t, a), this.authority = n || Q, this.path = Jl(this.scheme, r || Q), this.query = i || Q, this.fragment = s || Q, Xl(this, a));
		}
		get fsPath() {
			return Hn(this, !1);
		}
	...
	(class Lt {
		...
		set(t, n) {
			return this.map.set(this.toKey(t), new oc(t, n)), this;
		}
		get(t) {
	...
	function gc(e, t, n, r, i) {
		return fc(e, t, n, r, i) && pc(e, t, n, r, i);
	}
	var bc = class {
		constructor(e, t) {
		...
		next(e) {
			...
			do {
				...
				if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || gc(this._wordSeparators, e, t, r, i)) return n;
			} while (n);
			return null;
		}
	};
	...
	function _c(e = "") {
		let t = "(-?\\d*\\.\\d\\w*)|([^";
		for (const n of wc) e.indexOf(n) >= 0 || (t += "\\" + n);
	...
	var yc = class {
		static computeUnicodeHighlights(e, t, n) {
			...
			let o;
			a === "allNonBasicAscii" ? o = /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${Tc(Array.from(a))}`, "g");
			const l = new bc(null, o), c = [];
			...
			e: for (let g = r, v = i; g <= v; g++) {
				...
				do
					if (d = l.next(T), d) {
						let E = d.index, H = d.index + d[0].length;
						if (E > 0) zt(T.charCodeAt(E - 1)) && E--;
						if (H + 1 < k) zt(T.charCodeAt(H - 1)) && H++;
						const D = T.substring(E, H);
						let w = On(E + 1, gs, T, 0);
						w && w.endColumn <= E + 1 && (w = null);
						const f = s.shouldHighlightNonBasicASCII(D, w ? w.word : null);
						if (f !== 0) {
							if (f === 3 ? m++ : f === 2 ? p++ : f === 1 ? b++ : So(), c.length >= 1e3) {
								u = !0;
								break e;
							}
							c.push(new V(g, E + 1, g, H + 1));
						}
					}
				while (d);
			}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = kn.getLocales().filter((a) => !kn.getInstance(/* @__PURE__ */ new Set([...t.allowedLocales, a])).isAmbiguous(r));
					return {
						kind: 0,
	...
	function Tc(e, t) {
		return `[${Ko(e.map((n) => String.fromCodePoint(n)).join(""))}]`;
	}
	var _s = class {
		constructor(e) {
		...
		shouldHighlightNonBasicASCII(e, t) {
			...
			if (t) for (const s of t) {
				const a = s.codePointAt(0), o = ll(s);
...
` && (this.lineStartOffsetByLineIdx.push(t + 1), t > 0 && e.charAt(t - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(t - 1) : this.lineEndOffsetByLineIdx.push(t));
		...
		getPosition(e) {
			const t = Ke(this.lineStartOffsetByLineIdx, (i) => i <= e);
		...
		getTransformer() {
			return this._transformer || (this._transformer = new Cc(this.getValue())), this._transformer;
		}
		getLineAt(e) {
...
`, `
`), i = rl(n, r), s = Vn.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i), o = V.fromPositions(s, this.range.getEndPosition());
			return new $e(o, a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = sl(n, r), s = Vn.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i), o = V.fromPositions(this.range.getStartPosition(), s);
			return new $e(o, a);
		}
		toString() {
	...
	var gt = class un extends et {
		static fromRangeMappings(t) {
			const n = X.join(t.map((i) => X.fromRangeInclusive(i.originalRange))), r = X.join(t.map((i) => X.fromRangeInclusive(i.modifiedRange)));
			return new un(n, r, t);
		}
		constructor(t, n, r) {
		...
		toTextEdit(t) {
			...
			return new Hc(this.originalRange, n);
		}
	};
	function ks(e, t, n, r = !1) {
		const i = [];
		for (const s of Lc(e.map((a) => Uc(a, t, n)), (a, o) => a.original.intersectsOrTouches(o.original) || a.modified.intersectsOrTouches(o.modified))) {
	...
	function Uc(e, t, n) {
		...
		return new gt(new X(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), new X(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i), [e]);
	}
	const Dc = 3;
	var Wc = class {
		computeDiff(e, t, n) {
	...
	function qc(e) {
		...
		for (let r = 1, i = e.length; r < i; r++) {
			...
			Math.min(a, o) < Dc ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
		}
		return t;
	}
	var jn = class bo {
...
`);
		...
		compute(e, t, n = Xn.instance) {
			...
			e: for (;;) {
				...
				for (c = b; c <= g; c += 2) {
					...
					if (l.set(c, H !== k ? new Ms(D, k, E, H - k) : D), o.get(c) === r.length && o.get(c) - c === i.length) break e;
				}
			}
			let u = l.get(c);
			const d = [];
		...
		extendToFullLines(e) {
			return new J(Ze(this.firstElementOffsetByLineIdx, (r) => r <= e.start) ?? 0, Ec(this.firstElementOffsetByLineIdx, (r) => e.endExclusive <= r) ?? this.elements.length);
		}
	};
	function it(e) {
	...
	function Gc(e, t, n, r, i, s) {
		let { moves: a, excludedChanges: o } = Yc(e, t, n, s);
		if (!s.isValid()) return [];
		const l = Jc(e.filter((c) => !o.has(c)), r, i, t, n, s);
		return Rc(a, l), a = Qc(a), a = a.filter((c) => {
			const u = c.original.toOffsetRange().slice(t).map((d) => d.trim());
			return u.join(`
`).length >= 15 && Xc(u, (d) => d.length >= 2) >= 2;
		}), a = Zc(e, a), a;
	}
	function Xc(e, t) {
		let n = 0;
	...
	function Jc(e, t, n, r, i, s) {
		...
		for (const m of e) {
			...
			for (let b = m.modified.startLineNumber; b < m.modified.endLineNumberExclusive - 2; b++) {
				...
				o.forEach(g, ({ range: k }) => {
					for (const H of p) if (H.originalLineRange.endLineNumberExclusive + 1 === k.endLineNumberExclusive && H.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
						H.originalLineRange = new X(H.originalLineRange.startLineNumber, k.endLineNumberExclusive), H.modifiedLineRange = new X(H.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), T.push(H);
						return;
					}
					const E = {
						modifiedLineRange: v,
		...
		l.sort(Mc(ft((m) => m.modifiedLineRange.length, pt)));
		...
		for (let m = 0; m < a.length; m++) {
			...
			let H;
			for (H = 0; H < v; H++) {
				const w = p.original.startLineNumber - H - 1, f = p.modified.startLineNumber - H - 1;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			H > 0 && (u.addRange(new X(p.original.startLineNumber - H, p.original.startLineNumber)), c.addRange(new X(p.modified.startLineNumber - H, p.modified.startLineNumber)));
			let D;
			for (D = 0; D < E; D++) {
				const w = p.original.endLineNumberExclusive + D, f = p.modified.endLineNumberExclusive + D;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			D > 0 && (u.addRange(new X(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + D)), c.addRange(new X(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + D))), (H > 0 || D > 0) && (a[m] = new et(new X(p.original.startLineNumber - H, p.original.endLineNumberExclusive + D), new X(p.modified.startLineNumber - H, p.modified.endLineNumberExclusive + D)));
		}
		return a;
	}
	function Is(e, t, n) {
	...
	function zs(e, t, n) {
		let r = n;
		return r = Hs(e, t, r), r = Hs(e, t, r), r = Kc(e, t, r), r;
	}
	function Hs(e, t, n) {
	...
	function Ds(e, t, n, r, i = !1) {
		...
		function l(c, u) {
			...
			for (; s.length > 0;) {
				...
				const H = new de(r(e, T.seq1Range.start), r(t, T.seq2Range.start)), D = H.intersect(T);
				if (g += D.seq1Range.length, v += D.seq2Range.length, p = p.join(H), p.seq1Range.endExclusive >= T.seq1Range.endExclusive) s.shift();
				else break;
			}
		...
		do {
			...
			for (let c = 1; c < r.length; c++) {
				let m = function(p, b) {
					...
					const T = e.countLinesIn(p.seq1Range), k = p.seq1Range.length, E = t.countLinesIn(p.seq2Range), H = p.seq2Range.length, D = e.countLinesIn(b.seq1Range), w = b.seq1Range.length, f = t.countLinesIn(b.seq2Range), _ = b.seq2Range.length, N = 130;
					function I(L) {
						return Math.min(L, N);
					}
					return Math.pow(Math.pow(I(T * 40 + k), 1.5) + Math.pow(I(E * 40 + H), 1.5), 1.5) + Math.pow(Math.pow(I(D * 40 + w), 1.5) + Math.pow(I(f * 40 + _), 1.5), 1.5) > (N ** 1.5) ** 1.5 * 1.3;
				};
...
`);
	...
	var rh = class {
		constructor() {
			this.dynamicProgrammingDiffing = new Bc(), this.myersDiffingAlgorithm = new Rs();
		}
		computeDiff(e, t, n) {
			if (e.length <= 1 && Sc(e, t, (w, f) => w === f)) return new Ot([], [], !1);
			...
			const r = n.maxComputationTimeMs === 0 ? Xn.instance : new Fc(n.maxComputationTimeMs), i = !n.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
			function a(w) {
				let f = s.get(w);
				return f === void 0 && (f = s.size, s.set(w, f)), f;
			}
			const o = e.map((w) => a(w.trim())), l = t.map((w) => a(w.trim())), c = new Ws(o, e), u = new Ws(l, t), d = c.length + u.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, u, r, (w, f) => e[w] === t[f] ? t[f].length === 0 ? .1 : 1 + Math.log(1 + t[f].length) : .99) : this.myersDiffingAlgorithm.compute(c, u, r);
			let m = d.diffs, p = d.hitTimeout;
			m = zs(c, u, m), m = nh(c, u, m);
			const b = [], g = (w) => {
				if (i) for (let f = 0; f < w; f++) {
					const _ = v + f, N = T + f;
					if (e[_] !== t[N]) {
						const I = this.refineDiff(e, t, new de(new J(_, _ + 1), new J(N, N + 1)), r, i, n);
						for (const L of I.mappings) b.push(L);
						I.hitTimeout && (p = !0);
					}
				}
			};
			let v = 0, T = 0;
			for (const w of m) {
				Rt(() => w.seq1Range.start - v === w.seq2Range.start - T), g(w.seq1Range.start - v), v = w.seq1Range.endExclusive, T = w.seq2Range.endExclusive;
				const f = this.refineDiff(e, t, w, r, i, n);
				f.hitTimeout && (p = !0);
				for (const _ of f.mappings) b.push(_);
			}
			g(e.length - v);
			const H = ks(b, new Vt(e), new Vt(t));
			let D = [];
			return n.computeMoves && (D = this.computeMoves(H, e, t, o, l, r, i, n)), Rt(() => {
				function w(_, N) {
					if (_.lineNumber < 1 || _.lineNumber > N.length) return !1;
					const I = N[_.lineNumber - 1];
					return !(_.column < 1 || _.column > I.length + 1);
				}
				function f(_, N) {
					return !(_.startLineNumber < 1 || _.startLineNumber > N.length + 1 || _.endLineNumberExclusive < 1 || _.endLineNumberExclusive > N.length + 1);
				}
				for (const _ of H) {
					if (!_.innerChanges) return !1;
					for (const N of _.innerChanges) if (!(w(N.modifiedRange.getStartPosition(), t) && w(N.modifiedRange.getEndPosition(), t) && w(N.originalRange.getStartPosition(), e) && w(N.originalRange.getEndPosition(), e))) return !1;
					if (!f(_.modified, t) || !f(_.original, e)) return !1;
				}
				return !0;
			}), new Ot(H, D, p);
		}
		computeMoves(e, t, n, r, i, s, a, o) {
			return Gc(e, t, n, r, i, s).map((l) => {
				return new kc(l, ks(this.refineDiff(t, n, new de(l.original.toOffsetRange(), l.modified.toOffsetRange()), s, a, o).mappings, new Vt(t), new Vt(n), !0));
			});
		}
		refineDiff(e, t, n, r, i, s) {
			const a = sh(n).toRangeMapping2(e, t), o = new $t(e, a.originalRange, i), l = new $t(t, a.modifiedRange, i), c = o.length + l.length < 500 ? this.dynamicProgrammingDiffing.compute(o, l, r) : this.myersDiffingAlgorithm.compute(o, l, r);
			let u = c.diffs;
			return u = zs(o, l, u), u = Ds(o, l, u, (d, m) => d.findWordContaining(m)), s.extendToSubwords && (u = Ds(o, l, u, (d, m) => d.findSubWordContaining(m), !0)), u = eh(o, l, u), u = ih(o, l, u), {
	...
	var x = class {
		...
		static fromRGBA(t) {
			...
			let l;
			return a === 0 ? l = 0 : s === n ? l = ((r - i) / a % 6 + 6) % 6 : s === r ? l = (i - n) / a + 2 : l = (n - r) / a + 4, new _o(Math.round(l * 60), o, s, t.a);
		}
		static toRGBA(t) {
		...
		(function(t) {
			(function(n) {
				...
				function p(g) {
					...
					if (v === 5) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), E = b(g.charCodeAt(3)), H = b(g.charCodeAt(4));
						return new e(new x(16 * T + T, 16 * k + k, 16 * E + E, (16 * H + H) / 255));
					}
					return null;
				}
				n.parseHex = p;
	...
	function oh(e) {
		...
		if (n.length > 0) for (const r of n) {
			...
			if (!a) continue;
			let o;
			s === "rgb" ? o = Fs(bt(e, r), wt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : s === "rgba" ? o = Fs(bt(e, r), wt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : s === "hsl" ? o = Bs(bt(e, r), wt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : s === "hsla" ? o = Bs(bt(e, r), wt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : s === "#" && (o = ah(bt(e, r), s + a)), o && t.push(o);
		}
		return t;
	}
	function lh(e) {
		return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : oh(e);
	}
	const ch = /^-+|-+$/g, hh = 100;
	function uh(e, t) {
		let n = [];
	...
	function mh(e, t) {
		...
		const i = mc(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${i ? "s" : ""}`);
		if (el(s)) return n;
		for (let a = 1; a <= r; a += 95) {
			const o = Math.min(a + hh - 1, r), l = [];
...
`) + 1, k = u.index - T + 1, E = b[b.length - 1], H = {
					range: {
						startLineNumber: p,
						startColumn: k,
						endLineNumber: v,
	...
	(class we {
		constructor(t, n) {
			this._onReturn = n, this._producerConsumer = new bh(), this._iterator = {
	...
	var wh = class {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new Th(zn.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		constructor(t = null) {
			this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new yh();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeUnicodeHighlights(t, n, r) {
			...
			return i ? yc.computeUnicodeHighlights(i, n, r) : {
				ranges: [],
				hasMore: !1,
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			for (let { range: l, text: c, eol: u } of n) {
				...
				const m = yl(d, c, r), p = i.offsetAt(V.lift(l).getStartPosition());
				for (const b of m) {
		...
		async $navigateValueSet(t, n, r, i, s) {
			...
			return Ml.INSTANCE.navigateValueSet(n, l, c, u, r);
		}
		$fmr(t, n) {
	...
	typeof importScripts == "function" && (globalThis.monaco = ac());
	var Sh = class xi {
		static {
	...
	var Rh = /{([^}]+)}/g;
	function Mh(e, t) {
		return Object.keys(t).length === 0 ? e : e.replace(Rh, (n, r) => t[r] ?? n);
	}
	var js;
	(function(e) {
		function t(n) {
...
` && r++;
	...
	var Wa = class Ai {
		...
		update(t, n) {
			for (let r of t) if (Ai.isIncremental(r)) {
				const i = qa(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
	...
	(function(e) {
		...
		e.update = n;
		function r(i, s) {
			let a = i.getText(), o = pi(s.map(Nh), (u, d) => {
				let m = u.range.start.line - d.range.start.line;
				return m === 0 ? u.range.start.character - d.range.start.character : m;
			}), l = 0;
			const c = [];
	...
	var Ch = class {
		...
		skipWhitespace() {
			return this.advanceWhileChar((e) => e === Ph || e === qh || e === Uh || e === Wh || e === Dh) > 0;
		}
		advanceWhileChar(e) {
	...
	const Fa = 33, at = 45, rn = 60, Le = 62, bi = 47, Ih = 61, zh = 34, Hh = 39, Uh = 10, Dh = 13, Wh = 12, Ph = 32, qh = 9, Oh = {
	...
	function fe(e, t = 0, n = B.WithinContent, r = !1) {
		...
		function g(k, E, H) {
			return o = E, a = k, l = H, E;
		}
		function v() {
			const k = i.pos(), E = s, H = T();
			return H !== U.EOS && k === i.pos() && !(r && (H === U.StartTagClose || H === U.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + k + ", state before: " + E + " after: " + s), i.advance(1), g(k, U.Unknown)) : H;
		}
		function T() {
			const k = i.pos();
			...
			switch (s) {
				...
				case B.WithinTag: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : c && (d = b(), d.length > 0) ? (s = B.AfterAttributeName, c = !1, g(k, U.AttributeName)) : i.advanceIfChars([bi, Le]) ? (s = B.WithinContent, g(k, U.StartTagSelfClose)) : i.advanceIfChar(Le) ? (u === "script" ? m && Oh[m] ? s = B.WithinContent : s = B.WithinScriptContent : u === "style" ? s = B.WithinStyleContent : s = B.WithinContent, g(k, U.StartTagClose)) : r && i.peekChar() === rn ? (s = B.WithinContent, g(k, U.StartTagClose, ve("Closing bracket missing."))) : (i.advance(1), g(k, U.Unknown, ve("Unexpected character in tag.")));
				case B.AfterAttributeName: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : i.advanceIfChar(Ih) ? (s = B.BeforeAttributeValue, g(k, U.DelimiterAssign)) : (s = B.WithinTag, T());
				case B.BeforeAttributeValue:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					let H = i.advanceIfRegExp(/^[^\s"'`=<>]+/);
					if (H.length > 0 && (i.peekChar() === Le && i.peekChar(-1) === bi && (i.goBack(1), H = H.substring(0, H.length - 1)), d === "type" && (m = H), H.length > 0)) return s = B.WithinTag, c = !1, g(k, U.AttributeValue);
					const D = i.peekChar();
					return D === Hh || D === zh ? (i.advance(1), i.advanceUntilChar(D) && i.advance(1), d === "type" && (m = i.getSource().substring(k + 1, i.pos() - 1)), s = B.WithinTag, c = !1, g(k, U.AttributeValue)) : (s = B.WithinTag, c = !1, T());
	...
	var Va = class {
		...
		parse(e, t) {
			const n = fe(e, void 0, void 0, !0), r = new Va(0, e.length, [], void 0);
...
`,
	...
	const jh = 97, $h = 122, Gh = 65, Xh = 90, Yh = 48, Jh = 57;
	function yt(e, t) {
		const n = e.charCodeAt(t);
		return jh <= n && n <= $h || Gh <= n && n <= Xh || Yh <= n && n <= Jh;
	}
	function sn(e) {
		return typeof e < "u";
	}
...
`)), r.value !== "") return r;
	...
	var Zh = class {
		...
		async computeCompletions(e, t) {
			...
			for (const r of this.atributeCompletions) {
				const i = eu(e.getText(r.range));
				if (tu(i)) if (i === "." || i === "..") n.isIncomplete = !0;
				else {
					const s = nu(r.value, i, r.range), a = await this.providePathSuggestions(r.value, s, e, t);
		...
		async providePathSuggestions(e, t, n, r) {
			...
			if (s) try {
				...
				for (const [l, c] of o) l.charCodeAt(0) !== Kh && a.push(iu(l, c === gi.Directory, t));
				return a;
			} catch {}
			return [];
		}
	...
	var su = class {
		...
		async doComplete2(e, t, n, r, i) {
			...
			const s = new Zh(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
		...
		_doComplete(e, t, n, r) {
			...
			function v(y, R) {
				const C = g(y, R);
				return a.forEach((z) => {
					z.provideTags().forEach((q) => {
						i.items.push({
							label: q.name,
							kind: me.Property,
							documentation: Ve(q, void 0, l),
							textEdit: se.replace(C, q.name),
			...
			function T(y) {
				let R = y;
				for (; R > 0;) {
					const C = c.charAt(R - 1);
					if (`
\r`.indexOf(C) >= 0) return c.substring(R, y);
					if (!an(C)) return null;
					R--;
				}
			...
			function k(y, R, C = u) {
				const z = g(y, C), q = Ga(c, C, B.WithinEndTag, U.EndTagClose) ? "" : ">";
				let P = d;
				for (R && (P = P.parent); P;) {
					const W = P.tag;
				...
				return R || a.forEach((W) => {
					W.provideTags().forEach((G) => {
						i.items.push({
							...
							filterText: "/" + G.name + q,
							textEdit: se.replace(z, "/" + G.name + q),
							insertTextFormat: ye.PlainText
						});
					});
				}), i;
			...
			const E = (y, R) => {
				...
				if (!this.dataManager.isVoidElement(R, o)) {
					const C = e.positionAt(y);
					i.items.push({
						label: "</" + R + ">",
						kind: me.Property,
						filterText: "</" + R + ">",
						textEdit: se.insert(C, "$0</" + R + ">"),
			...
			function w(y, R = u) {
				let C = u;
				for (; C < R && c[C] !== "<";) C++;
				const z = c.substring(y, R), q = g(y, C);
				let P = "";
				if (!Ga(c, R, B.AfterAttributeName, U.DelimiterAssign)) {
					const G = r?.attributeDefaultValue ?? "doublequotes";
					G === "empty" ? P = "=$1" : G === "singlequotes" ? P = "='$1'" : P = "=\"$1\"";
				}
				const W = D();
				return W[z] = !1, a.forEach((G) => {
			...
			function f(y, R) {
				...
				function q(P) {
					P.attributeNames.forEach((W) => {
						We(W, C) && !z[W] && !R[W] && (z[W] = W + "=\"$1\"");
					}), P.children.forEach((W) => q(W));
				}
				n && n.roots.forEach((P) => q(P)), Object.keys(z).forEach((P) => i.items.push({
					label: P,
					kind: me.Value,
					textEdit: se.replace(y, z[P]),
					insertTextFormat: ye.Snippet
				}));
			}
			function _(y, R = u) {
				...
				if (u > y && u <= R && au(c[y])) {
					const P = y + 1;
					let W = R;
					R > y && c[R - 1] === c[y] && W--, C = g(ou(c, u, P), lu(c, u, W)), q = u >= P && u <= W ? c.substring(P, u) : "", z = !1;
				} else C = g(y, R), q = c.substring(y, u), z = !0;
				if (s.length > 0) {
				...
				return a.forEach((P) => {
					P.provideValues(p, b).forEach((W) => {
						const G = z ? "\"" + W.name + "\"" : W.name;
						i.items.push({
							label: W.name,
							filterText: G,
							kind: me.Unit,
							documentation: Ve(W, void 0, l),
							textEdit: se.replace(C, G),
							insertTextFormat: ye.PlainText
						});
					});
				}), L(), i;
			...
			function L() {
				...
				for (; y >= 0 && yt(c, y);) y--, R--;
				if (y >= 0 && c[y] === "&") {
					const C = $.create(ie.create(t.line, R - 1), t);
					for (const z in vt) if (Vh(z, ";")) {
						const q = "&" + z;
						i.items.push({
							label: q,
							kind: me.Keyword,
							documentation: ve("Character entity representing '{0}'", vt[z]),
							textEdit: se.replace(C, q),
							insertTextFormat: ye.PlainText
						});
					}
				}
			...
			function S(y, R) {
				...
				i.items.push({
					...
					textEdit: se.replace(C, "!DOCTYPE html>"),
					insertTextFormat: ye.PlainText
				});
			}
			let A = m.scan();
			for (; A !== U.EOS && m.getTokenOffset() <= u;) {
				switch (A) {
					case U.StartTagOpen:
						if (m.getTokenEnd() === u) {
							const y = N(U.StartTag);
							return t.line === 0 && S(u, y), H(u, y);
						}
						break;
					case U.StartTag:
					...
					case U.DelimiterAssign:
						if (m.getTokenEnd() === u) return _(u, N(U.AttributeValue));
						break;
					case U.AttributeValue:
					...
					case U.Whitespace:
						if (u <= m.getTokenEnd()) switch (m.getScannerState()) {
							case B.AfterOpeningStartTag: return H(m.getTokenOffset(), N(U.StartTag));
							case B.WithinTag:
							...
							case B.WithinContent: return I();
						}
						break;
					case U.EndTagOpen:
						if (u <= m.getTokenEnd()) return k(m.getTokenOffset() + 1, !1, N(U.EndTag));
						break;
					case U.EndTag:
						if (u <= m.getTokenEnd()) {
		...
		doHover(e, t, n, r) {
			...
			function u(w, f, _) {
				for (const N of c) {
					...
					}), I) return I.contents = i(I.contents), I;
				}
				return null;
			}
			function d(w, f, _) {
				for (const N of c) {
					let I = null;
					if (N.provideAttributes(w).forEach((L) => {
			...
			function m(w, f, _, N) {
				for (const I of c) {
					let L = null;
					if (I.provideValues(w, f).forEach((S) => {
			...
			function p(w, f) {
				...
				for (const N in vt) {
					let I = null;
					if (_ === "&" + N) {
						let L = vt[N].charCodeAt(0).toString(16).toUpperCase(), S = "U+";
						if (L.length < 4) {
							const y = 4 - L.length;
							let R = 0;
							for (; R < y;) S += "0", R += 1;
						...
						S += L;
						const A = ve("Character entity representing '{0}', unicode equivalent '{1}'", vt[N], S);
						A ? I = {
							contents: A,
							range: f
						} : I = null;
					}
					if (I) return I.contents = i(I.contents), I;
				}
				return null;
			}
			function b(w, f) {
				...
				let N = _.scan();
				for (; N !== U.EOS && (_.getTokenEnd() < a || _.getTokenEnd() === a && N !== w);) N = _.scan();
				return N === w && a <= _.getTokenEnd() ? {
			...
			function g() {
				...
				if (w >= 0 && l[w] === "&") {
					let I = null;
					return l[_] === ";" ? I = $.create(ie.create(t.line, f), ie.create(t.line, N + 1)) : I = $.create(ie.create(t.line, f), ie.create(t.line, N)), I;
				}
				return null;
			}
			function v(w) {
			...
			function H(w, f) {
				...
				let N = _.scan(), I;
				for (; N !== U.EOS && _.getTokenEnd() <= f;) N = _.scan(), N === U.AttributeName && (I = _.getTokenText());
				return I;
			}
			const D = b(U.AttributeValue, o.start);
			if (D) {
				const w = o.tag, f = hu(e.getText(D)), _ = H(o.start, e.offsetAt(D.start));
...
`) break;
					...
					for (var E = p.test(this._input.peek()), H = 0; p.test(this._input.peek());) this._ch = this._input.next(), k && this._ch === `
` && (H === 0 || H < this._options.max_preserve_newlines) && (H++, this._output.add_new_line(!0));
					return E;
				}, T.prototype.foundNestedPseudoClass = function() {
					for (var k = 0, E = 1, H = this._input.peek(E); H;) {
						if (H === "{") return !0;
						if (H === "(") k += 1;
						else if (H === ")") {
							if (k === 0) return !1;
...
`);
					...
					for (var D = 0, w = !1, f = !1, _ = !1, N = !1, I = !1, L = this._ch, S = !1, A, y, R; A = this._input.read(b), y = A !== "", R = L, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), L = this._ch, this._ch;) if (this._ch === "/" && this._input.peek() === "*") {
						this._output.add_new_line(), this._input.back();
						var C = this._input.read(g), z = u.get_directives(C);
						z && z.ignore === "start" && (C += u.readIgnored(this._input)), this.print_string(C), this.eatWhitespace(!0), this._output.add_new_line();
						...
						(w || _) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !N && D === 0 ? (this.print_string(":"), f || (f = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
					} else if (this._ch === "\"" || this._ch === "'") {
						var G = R === "\"" || R === "'";
						this.preserveSingleSpace(G || y), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
					} else if (this._ch === ";") S = !1, D === 0 ? (f && (this.outdent(), f = !1), N = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
						...
						var Z = !1;
						this._input.lookBack("with") && (Z = !0), this.preserveSingleSpace(y || Z), this.print_string(this._ch), f && R === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), I = !0) : (this.eatWhitespace(), D++, this.indent());
					}
					else if (this._ch === ")") D && (D--, this.outdent()), I && this._input.peek() === ";" && this._options.selector_separator_newline && (I = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
					else if (this._ch === ",") this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!f || I) && D === 0 && !N ? this._output.add_new_line() : this._output.space_before_token = !0;
...
You passed in: '` + this.raw_options[o] + "'");
			...
			(function(r, i, s) {
				...
				var p = function(w) {
					...
					var _ = null, N = null;
					return f.closed ? (w === "script" ? _ = "text/javascript" : w === "style" && (_ = "text/css"), _ = p(f) || _, _.search("text/css") > -1 ? N = "css" : _.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? N = "javascript" : _.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? N = "html" : _.search(/test\/null/) > -1 && (N = "null"), N) : null;
				};
				function g(w, f) {
				...
				function k(w, f, _, N) {
					this._source_text = w || "", f = f || {}, this._js_beautify = _, this._css_beautify = N, this._tag_stack = null;
					var I = new a(f, "html");
...
`);
					var _ = w.match(/^[\t ]*/)[0], N = {
						text: "",
						type: ""
					}, I = new E(), L = new m(this._options, _), S = new l(w, this._options).tokenize();
					this._tag_stack = new T(L);
					for (var A = null, y = S.next(); y.type !== c.EOF;) y.type === c.TAG_OPEN || y.type === c.COMMENT ? (A = this._handle_tag_open(L, y, I, N, S), I = A) : y.type === c.ATTRIBUTE || y.type === c.EQUALS || y.type === c.VALUE || y.type === c.TEXT && !I.tag_complete ? A = this._handle_inside_tag(L, y, I, N) : y.type === c.TAG_CLOSE ? A = this._handle_tag_close(L, y, I) : y.type === c.TEXT ? A = this._handle_text(L, y, I) : y.type === c.CONTROL_FLOW_OPEN ? A = this._handle_control_flow_open(L, y) : y.type === c.CONTROL_FLOW_CLOSE ? A = this._handle_control_flow_close(L, y) : L.add_raw_token(y), N = A, y = S.next();
...
`;
							...
							z.prototype = this._options.raw_options;
							var q = new z();
							I = L(R + I, q);
						} else {
...
` + R);
						...
						A && (I ? I = A + I + `
` + y : I = A + y), w.print_newline(!1), I && (f.text = I, f.whitespace_before = "", f.newlines = 0, w.add_raw_token(f), w.print_newline(!0));
					}
				}, k.prototype._handle_tag_open = function(w, f, _, N, I) {
					var L = this._get_tag_open_token(f);
					if ((_.is_unformatted || _.is_content_unformatted) && !_.is_empty_element && f.type === c.TAG_OPEN && !L.is_start_tag ? (w.add_raw_token(f), L.start_tag_token = this._tag_stack.try_pop(L.tag_name)) : (w.traverse_whitespace(f), this._set_tag_position(w, f, L, _, N), L.is_inline_element || w.set_wrap_point(), w.print_token(f)), L.is_start_tag && this._is_wrap_attributes_force) {
						var S = 0, A;
						do
							A = I.peek(S), A.type === c.ATTRIBUTE && (L.attr_count += 1), S += 1;
				...
				k.prototype._get_tag_open_token = function(w) {
				...
				}, k.prototype._set_tag_position = function(w, f, _, N, I) {
					if (_.is_empty_element || (_.is_end_tag ? _.start_tag_token = this._tag_stack.try_pop(_.tag_name) : (this._do_optional_end_element(_) && (_.is_inline_element || w.print_newline(!1)), this._tag_stack.record_tag(_), (_.tag_name === "script" || _.tag_name === "style") && !(_.is_unformatted || _.is_content_unformatted) && (_.custom_beautifier_name = b(_.tag_check, f)))), g(_.tag_check, this._options.extra_liners) && (w.print_newline(!1), w._output.just_added_blankline() || w.print_newline(!0)), _.is_empty_element) _.tag_start_char === "{" && _.tag_check === "else" && (this._tag_stack.indent_to_tag([
						...
						"unless",
						"each"
					]), _.indent_content = !0, w.current_line_has_match(/{{#if/) || w.print_newline(!1)), _.tag_name === "!--" && I.type === c.TAG_CLOSE && N.is_end_tag && _.text.indexOf(`
`) === -1 || (_.is_inline_element || _.is_unformatted || w.print_newline(!1), this._calcluate_parent_multiline(w, _));
					else if (_.is_end_tag) {
						var L = !1;
						L = _.start_tag_token && _.start_tag_token.multiline_content, L = L || !_.is_inline_element && !(N.is_inline_element || N.is_unformatted) && !(I.type === c.TAG_CLOSE && _.start_tag_token === N) && I.type !== "TK_CONTENT", (_.is_content_unformatted || _.is_unformatted) && (L = !1), L && w.print_newline(!1);
					} else _.indent_content = !_.custom_beautifier_name, _.tag_start_char === "<" && (_.tag_name === "html" ? _.indent_content = this._options.indent_inner_html : _.tag_name === "head" ? _.indent_content = this._options.indent_head_inner_html : _.tag_name === "body" && (_.indent_content = this._options.indent_body_inner_html)), !(_.is_inline_element || _.is_unformatted) && (I.type !== "TK_CONTENT" || _.is_content_unformatted) && w.print_newline(!1), this._calcluate_parent_multiline(w, _);
	...
	function fu(e, t, n) {
		...
		if (t) {
			...
			for (; u > 0 && Qa(r, u - 1);) u--;
			u === 0 || Ja(r, u - 1) ? c = u : u < c && (c = u + 1);
			let d = e.offsetAt(t.end), m = d;
			for (; m < r.length && Qa(r, m);) m++;
			(m === r.length || Ja(r, m)) && (d = m), t = $.create(e.positionAt(c), e.positionAt(d));
...
`,
		...
		let l = mu(pu(r), o);
		if (s > 0) {
			const c = n.insertSpaces ? ja(" ", a * s) : ja("	", s);
			l = l.split(`
`).join(`
...
`.indexOf(e.charAt(t)) !== -1;
		...
		(() => {
			...
			class m {
				...
				constructor(S, A, y, R, C, z = !1) {
					typeof S == "object" ? (this.scheme = S.scheme || c, this.authority = S.authority || c, this.path = S.path || c, this.query = S.query || c, this.fragment = S.fragment || c) : (this.scheme = (function(q, P) {
						return q || P ? q : "file";
					})(S, z), this.authority = A || c, this.path = (function(q, P) {
						switch (q) {
							case "https":
							case "http":
						...
						return P;
					})(this.scheme, y || c), this.query = R || c, this.fragment = C || c, l(this, z));
				}
				get fsPath() {
					return k(this);
				}
				with(S) {
					if (!S) return this;
					let { scheme: A, authority: y, path: R, query: C, fragment: z } = S;
					return A === void 0 ? A = this.scheme : A === null && (A = c), y === void 0 ? y = this.authority : y === null && (y = c), R === void 0 ? R = this.path : R === null && (R = c), C === void 0 ? C = this.query : C === null && (C = c), z === void 0 ? z = this.fragment : z === null && (z = c), A === this.scheme && y === this.authority && R === this.path && C === this.query && z === this.fragment ? this : new b(A, y, R, C, z);
				}
				static parse(S, A = !1) {
					const y = d.exec(S);
			...
			function v(L, S, A) {
				...
				for (let C = 0; C < L.length; C++) {
					const z = L.charCodeAt(C);
					if (z >= 97 && z <= 122 || z >= 65 && z <= 90 || z >= 48 && z <= 57 || z === 45 || z === 46 || z === 95 || z === 126 || S && z === 47 || A && z === 91 || A && z === 93 || A && z === 58) R !== -1 && (y += encodeURIComponent(L.substring(R, C)), R = -1), y !== void 0 && (y += L.charAt(C));
					else {
						y === void 0 && (y = L.substr(0, C));
						const q = g[z];
						q !== void 0 ? (R !== -1 && (y += encodeURIComponent(L.substring(R, C)), R = -1), y += q) : R === -1 && (R = C);
					}
				}
			...
			function E(L, S) {
				const A = S ? T : v;
				let y = "", { scheme: R, authority: C, path: z, query: q, fragment: P } = L;
				if (R && (y += R, y += ":"), (C || R === "file") && (y += u, y += u), C) {
					let W = C.indexOf("@");
					if (W !== -1) {
						const G = C.substr(0, W);
						C = C.substr(W + 1), W = G.lastIndexOf(":"), W === -1 ? y += A(G, !1, !1) : (y += A(G.substr(0, W), !1, !1), y += ":", y += A(G.substr(W + 1), !1, !0)), y += "@";
					}
					C = C.toLowerCase(), W = C.lastIndexOf(":"), W === -1 ? y += A(C, !1, !0) : (y += A(C.substr(0, W), !1, !0), y += C.substr(W));
				}
				if (z) {
					if (z.length >= 3 && z.charCodeAt(0) === 47 && z.charCodeAt(2) === 58) {
						const W = z.charCodeAt(1);
						W >= 65 && W <= 90 && (z = `/${String.fromCharCode(W + 32)}:${z.substr(3)}`);
					} else if (z.length >= 2 && z.charCodeAt(1) === 58) {
						const W = z.charCodeAt(0);
						W >= 65 && W <= 90 && (z = `${String.fromCharCode(W + 32)}:${z.substr(2)}`);
					}
					y += A(z, !0, !1);
				}
			...
			function H(L) {
				try {
					...
					return L.length > 3 ? L.substr(0, 3) + H(L.substr(3)) : L;
				}
			}
			const D = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
			function w(L) {
				return L.match(D) ? L.replace(D, ((S) => H(S))) : L;
			}
			var f = n(470);
			const _ = f.posix || f, N = "/";
			var I;
			(function(L) {
				L.joinPath = function(S, ...A) {
					...
					y[0] !== N && (y = N + y, R = !0);
					let C = _.resolve(y, ...A);
					return R && C[0] === N && !S.authority && (C = C.substring(1)), S.with({ path: C });
				}, L.dirname = function(S) {
					if (S.path.length === 0 || S.path === N) return S;
	...
	function yu(e, t, n, r, i, s) {
		const a = _i(n);
		if (!_u(a, e.languageId)) return;
		a.length < n.length && (r++, i--);
		const o = vu(e.uri, a, t, s);
		if (!o) return;
		const l = ku(o, e);
		return {
	...
	function ku(e, t) {
		try {
			let n = wu.parse(e);
			return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(!0)), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Tu) ? n.with({ fragment: null }).toString(!0) : e;
		} catch {
			return;
		}
	}
			...
			for (; i !== U.EOS;) {
				switch (i) {
					...
					case U.AttributeValue: if (a && s && this.dataManager.isPathAttribute(a, s)) {
						...
						if (!o) {
							const d = yu(e, t, u, r.getTokenOffset(), r.getTokenEnd(), l);
							d && n.push(d);
						}
	...
	function Lu(e, t, n) {
		...
		if (!i.tag) return [];
		const s = [], a = to(U.StartTag, e, i.start), o = typeof i.endTagStart == "number" && to(U.EndTag, e, i.endTagStart);
		return (a && eo(a, t) || o && eo(o, t)) && (a && s.push({
			kind: en.Read,
			range: a
		}), o && s.push({
			kind: en.Read,
	...
	function io(e, t, n) {
		const r = Au(t), i = $.create(e.positionAt(t.start), e.positionAt(t.end)), s = ui.create(r, void 0, ci.Field, i, i);
		n.push(s), t.children.forEach((a) => {
			s.children ?? (s.children = []), io(e, a, s.children);
		});
	}
	function Au(e) {
		let t = e.tag;
	...
	function Ru(e, t, n, r) {
		...
		if (!s.tag || !Mu(s, i, s.tag)) return null;
		const a = [], o = {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
	...
	var zu = class {
		...
		setDataProviders(e, t) {
			this.dataProviders = [], e && this.dataProviders.push(new $a("html5", Iu)), this.dataProviders.push(...t);
		}
		getDataProviders() {
			return this.dataProviders;
		}
		isVoidElement(e, t) {
			return !!e && Fh(t, e.toLowerCase(), (n, r) => n.localeCompare(r)) >= 0;
		}
		getVoidElements(e) {
	...
	function Du(e = Uu) {
		const t = new zu(e), n = new cu(e, t), r = new su(e, t), i = new Bh(t), s = new Cu(i), a = new Nu(t), o = new Su(t);
		return {
			...
			format: fu,
			findDocumentHighlights: Lu,
			findDocumentLinks: o.findDocumentLinks.bind(o),
			findDocumentSymbols: xu,
	...
	var Pu = class {
		constructor(e, t) {
			...
			if (n?.dataProviders) for (const s in n.dataProviders) i.push(Wu(s, n.dataProviders[s]));
			this._languageService = Du({
...
//# sourceMappingURL=html.worker-C8FtfNPI.js.map