	...
	const fe = {
		...
		relative(e, t) {
			...
			if (n.length !== e.length || r.length !== t.length) {
				...
				let b = 0;
				for (; b < _ && d[b].toLowerCase() === p[b].toLowerCase(); b++);
	...
	function F1(e, t, n) {
		...
		for (let s = 1; s < n.length; s++) {
			...
			if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
				...
				let c = 1;
				for (; c <= o && !(e.getElement(l.seq1Range.start - c) !== e.getElement(l.seq1Range.endExclusive - c) || t.getElement(l.seq2Range.start - c) !== t.getElement(l.seq2Range.endExclusive - c)); c++);
				if (c--, c === o) {
		...
		for (let s = 0; s < r.length - 1; s++) {
			...
			if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
				...
				let c = 0;
				for (; c < o && !(!e.isStronglyEqual(l.seq1Range.start + c, l.seq1Range.endExclusive + c) || !t.isStronglyEqual(l.seq2Range.start + c, l.seq2Range.endExclusive + c)); c++);
				if (c === o) {
...
//# sourceMappingURL=json.worker-Do707aLM.js.map