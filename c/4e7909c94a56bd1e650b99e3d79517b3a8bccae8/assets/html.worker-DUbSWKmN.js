...
` + e.stack) : e;
	...
	(function(e) {
		...
		function u(f, _) {
			let I = 0;
			for (const z of f) if (_(z, I++)) return !0;
			return !1;
		}
		e.some = u;
		function d(f, _) {
			let I = 0;
			for (const z of f) if (!_(z, I++)) return !1;
			return !0;
		}
		e.every = d;
		function m(f, _) {
		...
		e.slice = E;
		function C(f, _ = Number.POSITIVE_INFINITY) {
			const I = [];
			if (_ === 0) return [I, f];
	...
	(function(e) {
		...
		function z(S, A) {
			return new I(S, A).emitter.event;
		}
		e.fromObservable = z;
		function L(S) {
			return (A, y, R) => {
...
`));
	...
	var Ge = class {
		...
		WALKTRACE(t, n, r, i, s, a, o, l, c, u, d, m, p, b, g, v, T, k) {
			let E = null, C = null, D = new ji(), w = n, f = r, _ = p[0] - v[0] - i, I = -1073741824, z = this.m_forwardHistory.length - 1;
			do {
				const L = _ + t;
				L === w || L < f && c[L - 1] < c[L + 1] ? (d = c[L + 1], b = d - _ - i, d < I && D.MarkNextChange(), I = d, D.AddModifiedElement(d + 1, b), _ = L + 1 - t) : (d = c[L - 1] + 1, b = d - _ - i, d < I && D.MarkNextChange(), I = d - 1, D.AddOriginalElement(d, b + 1), _ = L - 1 - t), z >= 0 && (c = this.m_forwardHistory[z], t = c[0], w = 1, f = c.length - 1);
			} while (--z >= -1);
			if (E = D.getReverseChanges(), k[0]) {
				...
				C = [new He(L, m - L + 1, S, g - S + 1)];
			} else {
				D = new ji(), w = a, f = o, _ = p[0] - v[0] - l, I = 1073741824, z = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const L = _ + s;
					L === w || L < f && u[L - 1] >= u[L + 1] ? (d = u[L + 1] - 1, b = d - _ - l, d > I && D.MarkNextChange(), I = d + 1, D.AddOriginalElement(d + 1, b + 1), _ = L + 1 - s) : (d = u[L - 1], b = d - _ - l, d > I && D.MarkNextChange(), I = d, D.AddModifiedElement(d + 1, b + 1), _ = L - 1 - s), z >= 0 && (u = this.m_reverseHistory[z], s = u[0], w = 1, f = u.length - 1);
				} while (--z >= -1);
				C = D.getChanges();
			}
		...
		ComputeRecursionPoint(t, n, r, i, s, a, o) {
			...
			const b = n - t + (i - r), g = b + 1, v = new Int32Array(g), T = new Int32Array(g), k = i - r, E = n - t, C = t - r, D = n - i, w = (E - k) % 2 === 0;
			v[k] = t, T[E] = n, o[0] = !1;
			for (let f = 1; f <= b / 2 + 1; f++) {
				let _ = 0, I = 0;
				u = this.ClipDiagonalBound(k - f, f, k, g), d = this.ClipDiagonalBound(k + f, f, k, g);
				for (let L = u; L <= d; L += 2) {
					L === u || L < d && v[L - 1] < v[L + 1] ? l = v[L + 1] : l = v[L - 1] + 1, c = l - (L - k) - C;
					const S = l;
					for (; l < n && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
					if (v[L] = l, l + c > _ + I && (_ = l, I = c), !w && Math.abs(L - E) <= f - 1 && l >= T[L]) return s[0] = l, a[0] = c, S <= T[L] && f <= 1448 ? this.WALKTRACE(k, u, d, C, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				const z = (_ - t + (I - r) - f) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(_, z)) return o[0] = !0, s[0] = _, a[0] = I, z > 0 && f <= 1448 ? this.WALKTRACE(k, u, d, C, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : (t++, r++, [new He(t, n - t + 1, r, i - r + 1)]);
				...
				for (let L = m; L <= p; L += 2) {
					...
					if (T[L] = l, w && Math.abs(L - k) <= f && l <= v[L]) return s[0] = l, a[0] = c, S >= v[L] && f <= 1448 ? this.WALKTRACE(k, u, d, C, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				if (f <= 1447) {
			...
			return this.WALKTRACE(k, u, d, C, E, m, p, D, v, T, l, n, s, c, i, a, w, o);
		}
		PrettifyChanges(t) {
	...
	var Tc = class {
		static computeUnicodeHighlights(e, t, n) {
			...
			e: for (let g = r, v = i; g <= v; g++) {
				...
				do
					if (d = l.next(T), d) {
						let E = d.index, C = d.index + d[0].length;
						E > 0 && zt(T.charCodeAt(E - 1)) && E--, C + 1 < k && zt(T.charCodeAt(C - 1)) && C++;
						const D = T.substring(E, C);
						let w = On(E + 1, gs, T, 0);
...
`, `
`), i = sl(n, r), s = Vn.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i), o = V.fromPositions(s, this.range.getEndPosition());
			return new $e(o, a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = al(n, r), s = Vn.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i), o = V.fromPositions(this.range.getStartPosition(), s);
			return new $e(o, a);
		}
		toString() {
		...
		compute(e, t, n = Xn.instance) {
			...
			e: for (;;) {
				...
				for (c = b; c <= g; c += 2) {
					...
					if (l.set(c, C !== k ? new Ms(D, k, E, C - k) : D), o.get(c) === r.length && o.get(c) - c === i.length) break e;
				}
			}
			let u = l.get(c);
			const d = [];
	...
	function Qc(e, t, n, r, i, s) {
		...
		for (const m of e) {
			...
			for (let b = m.modified.startLineNumber; b < m.modified.endLineNumberExclusive - 2; b++) {
				...
				o.forEach(g, ({ range: k }) => {
					for (const C of p) if (C.originalLineRange.endLineNumberExclusive + 1 === k.endLineNumberExclusive && C.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
						C.originalLineRange = new X(C.originalLineRange.startLineNumber, k.endLineNumberExclusive), C.modifiedLineRange = new X(C.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), T.push(C);
						return;
					}
					const E = {
						modifiedLineRange: v,
		...
		for (let m = 0; m < a.length; m++) {
			...
			let C;
			for (C = 0; C < v; C++) {
				const w = p.original.startLineNumber - C - 1, f = p.modified.startLineNumber - C - 1;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			C > 0 && (u.addRange(new X(p.original.startLineNumber - C, p.original.startLineNumber)), c.addRange(new X(p.modified.startLineNumber - C, p.modified.startLineNumber)));
			let D;
			for (D = 0; D < E; D++) {
				const w = p.original.endLineNumberExclusive + D, f = p.modified.endLineNumberExclusive + D;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			D > 0 && (u.addRange(new X(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + D)), c.addRange(new X(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + D))), (C > 0 || D > 0) && (a[m] = new et(new X(p.original.startLineNumber - C, p.original.endLineNumberExclusive + D), new X(p.modified.startLineNumber - C, p.modified.endLineNumberExclusive + D)));
		}
		return a;
	}
	function Is(e, t, n) {
		...
		do {
			...
			for (let c = 1; c < r.length; c++) {
				let m = function(p, b) {
					...
					const T = e.countLinesIn(p.seq1Range), k = p.seq1Range.length, E = t.countLinesIn(p.seq2Range), C = p.seq2Range.length, D = e.countLinesIn(b.seq1Range), w = b.seq1Range.length, f = t.countLinesIn(b.seq2Range), _ = b.seq2Range.length, I = 130;
					function z(L) {
						return Math.min(L, I);
					}
					return Math.pow(Math.pow(z(T * 40 + k), 1.5) + Math.pow(z(E * 40 + C), 1.5), 1.5) + Math.pow(Math.pow(z(D * 40 + w), 1.5) + Math.pow(z(f * 40 + _), 1.5), 1.5) > (I ** 1.5) ** 1.5 * 1.3;
				};
...
`);
	...
	var sh = class {
		...
		computeDiff(e, t, n) {
			if (e.length <= 1 && Lc(e, t, (C, D) => C === D)) return new Ot([], [], !1);
			...
			function a(C) {
				let D = s.get(C);
				return D === void 0 && (D = s.size, s.set(C, D)), D;
			}
			const o = e.map((C) => a(C.trim())), l = t.map((C) => a(C.trim())), c = new Ws(o, e), u = new Ws(l, t), d = c.length + u.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, u, r, (C, D) => e[C] === t[D] ? t[D].length === 0 ? .1 : 1 + Math.log(1 + t[D].length) : .99) : this.myersDiffingAlgorithm.compute(c, u, r);
			let m = d.diffs, p = d.hitTimeout;
			m = zs(c, u, m), m = ih(c, u, m);
			const b = [], g = (C) => {
				if (i) for (let D = 0; D < C; D++) {
					const w = v + D, f = T + D;
					if (e[w] !== t[f]) {
			...
			let v = 0, T = 0;
			for (const C of m) {
				Rt(() => C.seq1Range.start - v === C.seq2Range.start - T), g(C.seq1Range.start - v), v = C.seq1Range.endExclusive, T = C.seq2Range.endExclusive;
				const D = this.refineDiff(e, t, C, r, i, n);
				D.hitTimeout && (p = !0);
			...
			return n.computeMoves && (E = this.computeMoves(k, e, t, o, l, r, i, n)), Rt(() => {
				...
				for (const w of k) {
					...
					for (const f of w.innerChanges) if (!(C(f.modifiedRange.getStartPosition(), t) && C(f.modifiedRange.getEndPosition(), t) && C(f.originalRange.getStartPosition(), e) && C(f.originalRange.getEndPosition(), e))) return !1;
		...
		(function(t) {
			(function(n) {
				...
				function p(g) {
					...
					if (v === 5) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), E = b(g.charCodeAt(3)), C = b(g.charCodeAt(4));
						return new e(new x(16 * T + T, 16 * k + k, 16 * E + E, (16 * C + C) / 255));
					}
					return null;
				}
				n.parseHex = p;
...
`) + 1, k = u.index - T + 1, E = b[b.length - 1], C = {
					range: {
						startLineNumber: p,
						startColumn: k,
						endLineNumber: v,
				...
				(C.text || C.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < C.range.startLineNumber) && n.push(C), s.lastIndex = u.index + u[0].length;
			}
		}
		return n;
	}
...
` && r++;
	...
	function fe(e, t = 0, n = B.WithinContent, r = !1) {
		...
		function g(k, E, C) {
			return o = E, a = k, l = C, E;
		}
		function v() {
			const k = i.pos(), E = s, C = T();
			return C !== U.EOS && k === i.pos() && !(r && (C === U.StartTagClose || C === U.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + k + ", state before: " + E + " after: " + s), i.advance(1), g(k, U.Unknown)) : C;
		}
		function T() {
			const k = i.pos();
			...
			switch (s) {
				...
				case B.BeforeAttributeValue:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					let C = i.advanceIfRegExp(/^[^\s"'`=<>]+/);
					if (C.length > 0 && (i.peekChar() === Le && i.peekChar(-1) === bi && (i.goBack(1), C = C.substring(0, C.length - 1)), d === "type" && (m = C), C.length > 0)) return s = B.WithinTag, c = !1, g(k, U.AttributeValue);
					const D = i.peekChar();
...
\r`.indexOf(N) >= 0) return c.substring(R, y);
			...
			for (; A !== U.EOS && m.getTokenOffset() <= u;) {
				switch (A) {
					case U.StartTagOpen:
						if (m.getTokenEnd() === u) {
							const y = I(U.StartTag);
							return t.line === 0 && S(u, y), C(u, y);
						}
						break;
					case U.StartTag:
					...
					case U.Whitespace:
						if (u <= m.getTokenEnd()) switch (m.getScannerState()) {
							case B.AfterOpeningStartTag: return C(m.getTokenOffset(), I(U.StartTag));
							case B.WithinTag:
	...
	var hu = class {
		...
		doHover(e, t, n, r) {
			...
			function d(w, f, _) {
				for (const I of c) {
					let z = null;
					if (I.provideAttributes(w).forEach((L) => {
			...
			function p(w, f) {
				...
				for (const I in vt) {
					let z = null;
					if (_ === "&" + I) {
						let L = vt[I].charCodeAt(0).toString(16).toUpperCase(), S = "U+";
						if (L.length < 4) {
							const y = 4 - L.length;
							let R = 0;
							for (; R < y;) S += "0", R += 1;
						...
						S += L;
						const A = ve("Character entity representing '{0}', unicode equivalent '{1}'", vt[I], S);
						A ? z = {
							contents: A,
							range: f
						} : z = null;
			...
			function g() {
				...
				if (w >= 0 && l[w] === "&") {
					let z = null;
					return l[_] === ";" ? z = $.create(ie.create(t.line, f), ie.create(t.line, I + 1)) : z = $.create(ie.create(t.line, f), ie.create(t.line, I)), z;
				}
				return null;
			}
			function v(w) {
			...
			function C(w, f) {
				...
				let I = _.scan(), z;
				for (; I !== U.EOS && _.getTokenEnd() <= f;) I = _.scan(), I === U.AttributeName && (z = _.getTokenText());
				return z;
			}
			const D = b(U.AttributeValue, o.start);
			if (D) {
				const w = o.tag, f = uu(e.getText(D)), _ = C(o.start, e.offsetAt(D.start));
...
`) break;
					...
					for (var E = p.test(this._input.peek()), C = 0; p.test(this._input.peek());) this._ch = this._input.next(), k && this._ch === `
` && (C === 0 || C < this._options.max_preserve_newlines) && (C++, this._output.add_new_line(!0));
					return E;
				}, T.prototype.foundNestedPseudoClass = function() {
					for (var k = 0, E = 1, C = this._input.peek(E); C;) {
						if (C === "{") return !0;
						if (C === "(") k += 1;
						else if (C === ")") {
							if (k === 0) return !1;
...
`);
					var C = k.match(/^[\t ]*/)[0];
					this._output = new o(this._options, C), this._input = new l(k), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
					for (var D = 0, w = !1, f = !1, _ = !1, I = !1, z = !1, L = this._ch, S = !1, A, y, R; A = this._input.read(b), y = A !== "", R = L, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), L = this._ch, this._ch;) if (this._ch === "/" && this._input.peek() === "*") {
						...
						P.match(/[ :]$/) && (P = this.eatString(": ").replace(/\s+$/, ""), this.print_string(P), this._output.space_before_token = !0), D === 0 && P.indexOf(":") !== -1 ? (f = !0, this.indent()) : P in this.NESTED_AT_RULE ? (this._nestedLevel += 1, P in this.CONDITIONAL_GROUP_RULE && (_ = !0)) : D === 0 && !f && (I = !0);
					}
						...
						(w || _) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !I && D === 0 ? (this.print_string(":"), f || (f = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
					} else if (this._ch === "\"" || this._ch === "'") {
						var G = R === "\"" || R === "'";
						this.preserveSingleSpace(G || y), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
					} else if (this._ch === ";") S = !1, D === 0 ? (f && (this.outdent(), f = !1), I = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
					...
					else if (this._ch === ",") this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!f || z) && D === 0 && !I ? this._output.add_new_line() : this._output.space_before_token = !0;
...
You passed in: '` + this.raw_options[o] + "'");
			...
			(function(r, i, s) {
				...
				function k(w, f, _, I) {
					this._source_text = w || "", f = f || {}, this._js_beautify = _, this._css_beautify = I, this._tag_stack = null;
					var z = new a(f, "html");
...
`);
					...
					for (var A = null, y = S.next(); y.type !== c.EOF;) y.type === c.TAG_OPEN || y.type === c.COMMENT ? (A = this._handle_tag_open(L, y, z, I, S), z = A) : y.type === c.ATTRIBUTE || y.type === c.EQUALS || y.type === c.VALUE || y.type === c.TEXT && !z.tag_complete ? A = this._handle_inside_tag(L, y, z, I) : y.type === c.TAG_CLOSE ? A = this._handle_tag_close(L, y, z) : y.type === c.TEXT ? A = this._handle_text(L, y, z) : y.type === c.CONTROL_FLOW_OPEN ? A = this._handle_control_flow_open(L, y) : y.type === c.CONTROL_FLOW_CLOSE ? A = this._handle_control_flow_close(L, y) : L.add_raw_token(y), I = A, y = S.next();
					...
					if (f.text !== "") {
						...
						_.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? L = this._js_beautify : _.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? L = this._css_beautify : _.custom_beautifier_name === "html" && (L = function(W, G) {
							return new k(W, G, I._js_beautify, I._css_beautify).beautify();
...
` + y : z = A + y), w.print_newline(!1), z && (f.text = z, f.whitespace_before = "", f.newlines = 0, w.add_raw_token(f), w.print_newline(!0));
				...
				k.prototype._get_tag_open_token = function(w) {
				...
				}, k.prototype._set_tag_position = function(w, f, _, I, z) {
					if (_.is_empty_element || (_.is_end_tag ? _.start_tag_token = this._tag_stack.try_pop(_.tag_name) : (this._do_optional_end_element(_) && (_.is_inline_element || w.print_newline(!1)), this._tag_stack.record_tag(_), (_.tag_name === "script" || _.tag_name === "style") && !(_.is_unformatted || _.is_content_unformatted) && (_.custom_beautifier_name = b(_.tag_check, f)))), g(_.tag_check, this._options.extra_liners) && (w.print_newline(!1), w._output.just_added_blankline() || w.print_newline(!0)), _.is_empty_element) _.tag_start_char === "{" && _.tag_check === "else" && (this._tag_stack.indent_to_tag([
						...
						"unless",
						"each"
					]), _.indent_content = !0, w.current_line_has_match(/{{#if/) || w.print_newline(!1)), _.tag_name === "!--" && z.type === c.TAG_CLOSE && I.is_end_tag && _.text.indexOf(`
`) === -1 || (_.is_inline_element || _.is_unformatted || w.print_newline(!1), this._calcluate_parent_multiline(w, _));
					else if (_.is_end_tag) {
						var L = !1;
						L = _.start_tag_token && _.start_tag_token.multiline_content, L = L || !_.is_inline_element && !(I.is_inline_element || I.is_unformatted) && !(z.type === c.TAG_CLOSE && _.start_tag_token === I) && z.type !== "TK_CONTENT", (_.is_content_unformatted || _.is_unformatted) && (L = !1), L && w.print_newline(!1);
				...
				k.prototype._do_optional_end_element = function(w) {
					...
					if (!(w.is_empty_element || !w.is_start_tag || !w.parent)) {
						...
						else if (w.parent.tag_name === "p" && C.indexOf(w.tag_name) !== -1) {
...
`.indexOf(e.charAt(t)) !== -1;
	...
	(() => {
		...
		(() => {
			...
			function w(L) {
				return L.match(D) ? L.replace(D, ((S) => C(S))) : L;
			}
			var f = n(470);
			const _ = f.posix || f, I = "/";
			var z;
			(function(L) {
				L.joinPath = function(S, ...A) {
					...
					y[0] !== I && (y = I + y, R = !0);
					let N = _.resolve(y, ...A);
					return R && N[0] === I && !S.authority && (N = N.substring(1)), S.with({ path: N });
...
//# sourceMappingURL=html.worker-DUbSWKmN.js.map